...
export function setBindBindLocalEnvSelectionsByWorkspace2Peers(
  next: BindBindLocalEnvSelectionsByWorkspace2Peers,
): void {
  peers = next;
}
...
export function bindBindLocalEnvSelectionsByWorkspace2() {
  if (peers == null) {
    throw new Error(
      "bindBindLocalEnvSelectionsByWorkspace2 peers are not configured",
    );
  }
