 ...
 */
export function resolveArtifactFileIcon(filePath: string | null | undefined, mimeType?: string | false | null): ArtifactFileKindIcon {
...
export function resolveArtifactEntryIcon(filePath: string | null | undefined, entryKind?: "directory" | "file" | string | null, mimeType?: string | false | null): ArtifactFileKindIcon {
