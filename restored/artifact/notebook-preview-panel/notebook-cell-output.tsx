...
// Split part — notebook cell output renderers and sandboxed HTML document.
...
import { IntlProvider } from "./companion-stubs";
import { zinc } from "./notebook-preview-utils";
...
export function NotebookPreviewPanelHelper20(quillow: any) {
  let { output } = quillow,
    root = useIntl();
  switch (output.type) {
    case "image": {
