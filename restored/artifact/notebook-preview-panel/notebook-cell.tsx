...
// Split part — notebook cell list and cell body renderers.
...
import { AppInitialJa } from "./companion-stubs";
import { NotebookPreviewPanelHelper20 } from "./notebook-cell-output";
import { amber } from "./notebook-preview-utils";

export function NotebookPreviewPanelHelper15(brook: any) {
  let { document } = brook;
