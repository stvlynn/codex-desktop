...
// Welcome V2 home suggestion prompts keyed by onboarding role (apps/connectors appIds).

import { defineMessage } from "react-intl";

import type { WelcomeV2RoleId } from "./welcome-v2-role-ids";
import type { WelcomeV2RolePrompt } from "./welcome-v2-role-prompt";

/**
 * Role → home-prompt tiles shown during Welcome V2 onboarding.
 * Each tile may name connector/app ids (`github`, `linear`, `gmail`, …).
 */
export const WELCOME_V2_ROLE_PROMPT_CATALOG: Record<
  WelcomeV2RoleId,
  readonly WelcomeV2RolePrompt[]
> = {
  engineering: [
    {
