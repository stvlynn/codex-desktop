...
export function setProfileUsageQueryStaleTimeMsPeers(
  next: ProfileUsageQueryStaleTimeMsPeers,
): void {
  peers = next;
}
...
export function ProfileUsageQueryStaleTimeMs() {
  ...
  return peers.e(() => {
    ((a$l = peers.c()),
      ...
      peers.VQl(),
      (o$l = `3503973010`),
      (s$l = `profile_usage_query_stale_time_ms`),
      (c$l = [`profile`, `usage`, `disabled`]),
      (l$l = class extends Error {
        uploadError;
        constructor(e) {
