...
function upgradePlanDialogUpgradePlanDialog(marble) {
  let {
    ...
    [quartz, river] = lemon.useState(
      currentPlan === ChatGptPlanId.PRO
        ? ChatGptPlanId.PRO
        : ChatGptPlanId.PROLITE,
    ),
    slate =
      currentPlan === ChatGptPlanId.GO ||
      currentPlan === ChatGptPlanId.PLUS ||
      currentPlan === ChatGptPlanId.PROLITE ||
      currentPlan === ChatGptPlanId.PRO,
    timber = (
      <RealtimeVoiceHostId
        {...{
        ...
        children: (
          <MemoizedFormattedMessage
            {...{
              ...
              description:
                "Screen reader description for the plan upgrade dialog",
            }}
          />
        ),
      }}
                  ...
                  tier: (
                    <MemoizedFormattedMessage
                      {...{
                        ...
                        defaultMessage: "5x",
                        description:
                          "Tier suffix for the Pro 5x personal plan card",
                      }}
                    />
                  ),
                }}
                  ...
                  tier: (
                    <MemoizedFormattedMessage
                      {...{
                        ...
                        defaultMessage: "20x",
                        description:
                          "Tier suffix for the Pro 20x personal plan card",
                      }}
                    />
                  ),
                }}
  ...
  let kelp = (
    <div aria-hidden={zinc} className={basalt}>
      {cedar}
      {ivory}
      {jasper}
    </div>
  ...
  let ultra = (iris) => {
    onOpenUrl(
      CHATGPT_COM_CODEX_PURCHASE_CODEX_TEAM_URL,
      ChatGptPlanId.SELF_SERVE_BUSINESS_USAGE_BASED,
      iris,
    );
  };
  let vapor = (
    <MemoizedFormattedMessage
      {...{
        ...
        description:
          "Screen reader label for the Business Codex plan details link",
      }}
    />
  );
  let wheat = (
      ...
      label: (
        <MemoizedFormattedMessage
          {...{
            ...
            defaultMessage: "Enhanced Codex usage",
            description:
              "Usage feature on the ChatGPT and Codex Business plan card",
          }}
        />
      ),
    },
      ...
      label: (
        <MemoizedFormattedMessage
          {...{
            ...
            defaultMessage: "GPT-5.5 Thinking",
            description:
              "Model feature on the ChatGPT and Codex Business plan card",
          }}
        />
      ),
    },
      ...
      label: (
        <MemoizedFormattedMessage
          {...{
            ...
            defaultMessage: "Connect to Google Workspace",
            description:
              "Workspace feature on the ChatGPT and Codex Business plan card",
          }}
        />
      ),
    },
      ...
      label: (
        <MemoizedFormattedMessage
          {...{
            ...
            defaultMessage: "Enhanced security and admin controls",
            description:
              "Security feature on the ChatGPT and Codex Business plan card",
          }}
        />
      ),
    },
  ...
  let drift = (jewel) => {
    onOpenUrl(
      CHATGPT_COM_CODEX_PURCHASE_TEAM_URL,
      ChatGptPlanId.SELF_SERVE_BUSINESS,
      jewel,
    );
  };
  let be = (
    <MemoizedFormattedMessage
      {...{
        ...
        description:
          "Screen reader label for the Business ChatGPT and Codex plan details link",
      }}
    />
  );
  let eagle = (
  ...
  let frost = (
    <div aria-hidden={lotus} className={nova}>
      {wheat}
      {eagle}
    </div>
  );
  ...
  let honey = (
    <DeferredUiB
      {...{
        className:
          "max-h-[calc(100vh-2rem)] gap-3 overflow-y-auto px-5 py-4 [--pricing-plan-highlight:#635ef4]",
