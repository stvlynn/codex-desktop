...
function jade(river) {
  let {
    ...
    xenon = isDiscountedAutoReloadExperience ? (
      <MemoizedFormattedMessage
        {...{
          id: "settings.usage.creditReload.minimumBalance.discounted.v2",
          defaultMessage: "Minimum balance",
          description:
            "Label shown above the balance threshold in the discounted auto-reload modal",
        }}
      />
    ) : (
      <MemoizedFormattedMessage
  ...
  let yellow = isDiscountedAutoReloadExperience ? (
    <OptionalTooltip
      {...{
        open: violet,
        onOpenChange: willow,
        tooltipContent: (
          <MemoizedFormattedMessage
            {...{
              ...
              description:
                "Tooltip explaining when discounted auto-reload starts based on the minimum balance",
            }}
          />
        ),
        children: (
          <button
            ...
            aria-label={intl.formatMessage({
              ...
              description:
                "Accessible label for the discounted auto-reload minimum balance tooltip trigger",
            })}
  ...
  let zinc = (
    <div className="flex items-center gap-1 text-sm text-token-text-primary">
      {xenon}
      {yellow}
    </div>
  );
  let amber = minimumBalanceError != null,
    ...
    cedar = isDiscountedAutoReloadExperience
      ? intl.formatMessage({
          id: "settings.usage.creditReload.minimumBalance.discounted.ariaLabel.v2",
          defaultMessage: "Minimum balance",
          description:
            "Accessible label for the balance threshold in the discounted auto-reload modal",
        })
      : intl.formatMessage({
        ...
        {isDiscountedAutoReloadExperience ? (
          <MemoizedFormattedMessage
            {...{
              ...
              description:
                "Helper label marking the monthly reload spend limit as optional in the discounted auto-reload modal",
            }}
          />
        ) : (
          <MemoizedFormattedMessage
  ...
  let jasper = monthlyLimitError != null,
    ...
    lotus = isDiscountedAutoReloadExperience
      ? intl.formatMessage({
          id: "settings.usage.creditReload.spendLimit.discounted.ariaLabel",
          defaultMessage: "Maximum monthly spend (optional)",
          description:
            "Accessible label for the optional maximum monthly spend in the discounted auto-reload modal",
        })
      : intl.formatMessage({
  ...
  let nova =
    monthlyLimitError === "monthly-limit-below-target" &&
    isDiscountedAutoReloadExperience ? (
      <p id={umbra} className="text-sm text-token-error-foreground">
        {
          <MemoizedFormattedMessage
            {...{
              ...
              description:
                "Validation message when the optional maximum monthly spend is below the configured minimum balance plus reload amount",
            }}
          />
        }
      </p>
    ) : monthlyLimitError == null ? null : (
      <At
        {...{
          id: umbra,
  ...
  let prism = hasImmediateTopUpFailure ? (
