...
// Desktop localStorage / persistence key catalog (`Fl` / export `Kht`).

/** Bundle `Fl` / export `Kht`. */
export const DesktopPersistenceKeys = {
  ...
  THREAD_PROJECTLESS_OUTPUT_DIRECTORIES:
  ...
  REMOTE_PROJECT_CONNECTION_BACKFILL_COMPLETED:
  ...
  REMOTE_CONNECTION_ANALYTICS_ID_BY_HOST_ID:
  ...
  SITE_CREATOR_BUNDLED_PLUGIN_AUTO_INSTALL_DISABLED:
    "site-creator-bundled-plugin-auto-install-disabled",
  BROWSER_USE_BUNDLED_PLUGIN_AUTO_INSTALL_DISABLED:
    "browser-use-bundled-plugin-auto-install-disabled",
  COMPUTER_USE_BUNDLED_PLUGIN_AUTO_INSTALL_DISABLED:
...
export type DesktopPersistenceKey =
  (typeof DesktopPersistenceKeys)[keyof typeof DesktopPersistenceKeys];
