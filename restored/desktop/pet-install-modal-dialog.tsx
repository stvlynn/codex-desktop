...
export function PetInstallModalHostHelper1(falcon: any) {
  let { session, onClose, onInstall } = falcon,
    { setSelectedAvatarId } = useSelectedAvatar(),
                ...
                }
                {
                  <MemoizedFormattedMessage
                    {...{
                      ...
                      description:
                        "Loading state shown while a pet preview is prepared",
                      values: {
                        petName: session.name,
                      },
                    }}
              ...
              <div className="px-5 text-center text-sm text-token-text-secondary">
                {
                  <MemoizedFormattedMessage
                    {...{
                      ...
                      description:
                        "Error state shown when a pet cannot be prepared",
                      values: {
                        petName: session.name,
                      },
                    }}
            ...
            <div className="text-sm text-token-text-secondary">
              {
                <MemoizedFormattedMessage
                  {...{
                    ...
                    description:
                      "Error state shown when a pet preview is valid but installation fails",
                    values: {
                      petName: session.name,
                    },
                  }}
                      ...
                      children: (
                        <MemoizedFormattedMessage
                          {...{
                            ...
                            description:
                              "Button label to close a completed pet install modal",
                          }}
                        />
                      ),
                    }}
                      ...
                      children: (
                        <MemoizedFormattedMessage
                          {...{
                            ...
                            description:
                              "Button label to select an installed pet",
                          }}
                        />
                      ),
                    }}
                        ...
                        session.status === "installError" ? (
                          <MemoizedFormattedMessage
                            {...{
                              ...
                              description:
                                "Button label to retry a failed pet install",
                            }}
                          />
                        ) : (
                          <MemoizedFormattedMessage
