...
// Editor theme data: Linear Light.
...
export const fg: string = "#2a3140";
export const name: string = "Linear Light";
...
export const linearLightTheme: EditorTheme = {
  bg,
  colors,
  chromeTheme,
  fg,
