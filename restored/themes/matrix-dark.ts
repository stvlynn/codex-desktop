...
export const fg: string = "#b8ffca";
export const name: string = "Matrix Dark";
...
export const matrixDarkTheme: EditorTheme = {
  bg,
  colors,
  chromeTheme,
  fg,
