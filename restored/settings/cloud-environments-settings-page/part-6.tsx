...
function jasper(olive) {
  ...
  let acorn = (honey) => {
    ...
    if (
      delta(
        value,
        reef.data?.some((iris) => iris.id === value.machineId) === true,
          ...
          onError: () => {
            prism.get(toastAtom).danger(
              quill.formatMessage({
                ...
                description:
                  "Toast shown when creating a cloud environment fails",
              }),
            );
          },
        });
          ...
          onError: () => {
            prism.get(toastAtom).danger(
              quill.formatMessage({
                ...
                description:
                  "Toast shown when updating a cloud environment fails",
              }),
            );
          },
        },
  ...
  let frost = (knoll) => {
    let lunar = copper(knoll),
      ...
      north =
        environment?.machine_id === knoll.machineId
          ? environment.machine
          : undefined;
    return (
      <>
                                      ...
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            defaultMessage: "Name",
                                            description:
                                              "Label for a cloud environment name",
                                          }}
                                        />
                                      ),
                                      description: lunar.label ? (
                                        <MemoizedFormattedMessage
                                          {...{
                                            id: "settings.cloudEnvironments.editor.name.required",
                                            defaultMessage: "Name is required",
                                            description:
                                              "Validation message for a missing cloud environment name",
                                          }}
                                        />
                                      ) : undefined,
                                      control: (
                                          ...
                                          {...{
                                            "aria-label": quill.formatMessage({
                                              ...
                                              defaultMessage:
                                                "Environment name",
                                              description:
                                                "Accessible label for a cloud environment name input",
                                            }),
                                            disabled: drift,
                                            maxLength: 64,
                                      ...
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Label for a cloud environment description",
                                          }}
                                        />
                                      ),
                                      control: (
                                        <CloudEnvironmentsSettingsPageHelper6
                                          {...{
                                            "aria-label": quill.formatMessage({
                                              ...
                                              description:
                                                "Accessible label for a cloud environment description input",
                                            }),
                                            disabled: drift,
                                            maxLength: 512,
                                ...
                                label: (
                                  <MemoizedFormattedMessage
                                    {...{
                                      ...
                                      description:
                                        "Label for a cloud environment repository",
                                    }}
                                  />
                                ),
                                description: lunar.repositoryId ? (
                                  <MemoizedFormattedMessage
                                    {...{
                                      id: "settings.cloudEnvironments.editor.repository.required",
                                      defaultMessage: "Repository is required",
                                      description:
                                        "Validation message for a missing cloud environment repository",
                                    }}
                                  />
                                ) : undefined,
                                control:
                                  environment == null ? (
                                    <CloudEnvironmentsSettingsPageHelper43
                                      {...{
                                        form: coral,
                                        isPending: drift,
                                        preferredConnectorId,
                                    ...
                                    <CloudEnvironmentsSettingsPageHelper6
                                      {...{
                                        "aria-label": quill.formatMessage({
                                          ...
                                          defaultMessage: "Repository",
                                          description:
                                            "Accessible label for a cloud environment repository input",
                                        }),
                                        disabled: true,
                                      ...
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Label for a cloud environment machine",
                                          }}
                                        />
                                      ),
                                      description: reef.isError ? (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Error shown when cloud environment machines cannot be loaded",
                                          }}
                                        />
                                      ) : lunar.machineId ? (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            defaultMessage:
                                              "Machine is required",
                                            description:
                                              "Validation message for a missing cloud environment machine",
                                          }}
                                        />
                                      ) : undefined,
                                      control: reef.isError ? (
                                                ...
                                                children: (
                                                  <MemoizedFormattedMessage
                                                    {...{
                                                      ...
                                                      description:
                                                        "Button label for retrying cloud environment machine loading",
                                                    }}
                                                  />
                                                ),
                                              }}
                                                    ...
                                                    <MemoizedFormattedMessage
                                                      {...{
                                                        ...
                                                        defaultMessage:
                                                          "Select a machine",
                                                        description:
                                                          "Placeholder for a cloud environment machine selector",
                                                      }}
                                                    />
                                                  )}
                                              </DropdownTriggerButton>
                                            ),
                                            children: reef.data?.map(
                                              (storm) => (
                                                <DropdownMenu.Item
                                                  key={storm.id}
                                                  {...{
                                        ...
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            defaultMessage:
                                              "Workspace directory",
                                            description:
                                              "Label for a cloud environment workspace directory",
                                          }}
                                        />
                                      ),
                                      description: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Explanation for the cloud environment workspace directory",
                                          }}
                                        />
                                      ),
                                      control: (
                                          ...
                                          {...{
                                            "aria-label": quill.formatMessage({
                                              ...
                                              defaultMessage:
                                                "Workspace directory",
                                              description:
                                                "Accessible label for the cloud environment workspace directory input",
                                            }),
                                            disabled: drift,
        ...
        {yarn ? (
          <CloudEnvironmentsSettingsPageHelper13
            {...{
              form: coral,
              isPending: drift,
            }}
                ...
                children: (
                  <MemoizedFormattedMessage
                    {...{
                      ...
                      description:
                        "Button label for cancelling cloud environment editing",
                    }}
                  />
                ),
              }}
                  ...
                  environment == null ? (
                    <MemoizedFormattedMessage
                      {...{
                        ...
                        description:
                          "Button label for creating a cloud environment",
                      }}
                    />
                  ) : (
                    <MemoizedFormattedMessage
                      {...{
                        ...
                        description:
                          "Button label for saving a cloud environment",
                      }}
                    />
                  ),
              }}
  ...
  return (
    <form className="flex flex-col gap-[var(--padding-panel)]" onSubmit={eagle}>
      {glide}
    </form>
  );
}
