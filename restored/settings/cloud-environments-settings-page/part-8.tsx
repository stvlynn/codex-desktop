...
function honey(quest) {
  let { environmentId, onBack, onDeleted, onEdit } = quest,
                ...
                children: [
                  ...
                  <MemoizedFormattedMessage
                    {...{
                      ...
                      defaultMessage: "Edit",
                      description:
                        "Button label for editing a cloud environment",
                    }}
                  />,
                ],
              }}
                  ...
                  <CoerceLocalFilesystemPath
                    {...{
                      label: storm.formatMessage({
                        ...
                        description:
                          "Accessible label for cloud environment actions",
                      }),
                    }}
                  />
                ),
                        ...
                        children: (
                          <MemoizedFormattedMessage
                            {...{
                              ...
                              description:
                                "Menu item for resetting a cloud environment cache",
                            }}
                          />
                        ),
                      }}
                        ...
                        children: (
                          <MemoizedFormattedMessage
                            {...{
                              ...
                              description:
                                "Menu item for deleting a cloud environment",
                            }}
                          />
                        ),
                      }}
  ...
  let urn = (
    <CloudEnvironmentsSettingsPageHelper4
      {...{
        ...
        onSuccess: () => {
          ...
          ridge.get(toastAtom).success(
            storm.formatMessage({
              ...
              description:
                "Toast shown after resetting a cloud environment cache",
            }),
          );
        },
        onError: () => {
          ridge.get(toastAtom).danger(
            storm.formatMessage({
              ...
              description:
                "Toast shown when resetting a cloud environment cache fails",
            }),
          );
        },
      });
  ...
  let azure = (
    <CloudEnvironmentsSettingsPageHelper5
      {...{
...
function iris(grain) {
  let { environmentId, onBack, onRootClick } = grain,
...
function jewel(thorn) {
  let { current, environment, onRootClick } = thorn,
