  ...
  let cedar = (garnet) => (
    <EnsurePersonalizationCInit
      {...{
        ...
        control: (
          <CloudEnvironmentsSettingsPageHelper7
            {...{
              "aria-label": amber.formatMessage({
                id: "settings.cloudEnvironments.editor.setup.aria",
                defaultMessage: "Setup script",
                description:
                  "Accessible label for a cloud environment setup script",
              }),
              disabled: isPending,
              rows: 5,
        ...
        description: (
          <MemoizedFormattedMessage
            {...{
              ...
              description:
                "Explanation for the cloud environment maintenance script",
            }}
          />
        ),
        control: (
          <CloudEnvironmentsSettingsPageHelper7
            {...{
              "aria-label": amber.formatMessage({
                ...
                defaultMessage: "Maintenance script",
                description:
                  "Accessible label for a cloud environment maintenance script",
              }),
              disabled: isPending,
              rows: 5,
                  ...
                  title: (
                    <MemoizedFormattedMessage
                      {...{
                        ...
                        description:
                          "Heading for cloud environment network access",
                      }}
                    />
                  ),
                }}
                              ...
                              label: (
                                <MemoizedFormattedMessage
                                  {...{
                                    ...
                                    description:
                                      "Label for the cloud environment network access mode",
                                  }}
                                />
                              ),
                              description: (
                                <MemoizedFormattedMessage
                                  {...{
                                    ...
                                    defaultMessage:
                                      "Controls internet access after setup completes",
                                    description:
                                      "Explanation for cloud environment network access",
                                  }}
                                />
                              ),
                              control: (
                                <AppInitialPl
                                  ariaLabel={jasper.formatMessage({
                                    id: "settings.cloudEnvironments.editor.network.aria",
                                    defaultMessage: "Network access",
                                    description:
                                      "Accessible label for cloud environment network access",
                                  })}
                                  options={[
                                    {
                                      id: "off",
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            defaultMessage: "Off",
                                            description:
                                              "Label for disabled cloud environment network access",
                                          }}
                                        />
                                      ),
                                      disabled: isPending,
                                      ...
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Label for custom cloud environment network access",
                                          }}
                                        />
                                      ),
                                      disabled: isPending,
                                      ...
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            defaultMessage: "On",
                                            description:
                                              "Label for enabled cloud environment network access",
                                          }}
                                        />
                                      ),
                                      disabled: isPending,
                                  ...
                                  selectedId={mint.mode}
                                  onSelect={(nova) =>
                                    form.setFieldValue("agentNetworkAccess", {
                                      ...mint,
                                      mode: nova,
                                    })
                                  }
                                    ...
                                    label: (
                                      <MemoizedFormattedMessage
                                        {...{
                                          ...
                                          description:
                                            "Label for allowed cloud environment network domains",
                                        }}
                                      />
                                    ),
                                    control: (
                                      <CloudEnvironmentsSettingsPageHelper6
                                        {...{
                                          "aria-label": jasper.formatMessage({
                                            ...
                                            defaultMessage: "Allowed domains",
                                            description:
                                              "Accessible label for allowed cloud environment network domains",
                                          }),
                                          disabled: isPending,
                                    ...
                                    label: (
                                      <MemoizedFormattedMessage
                                        {...{
                                          ...
                                          description:
                                            "Label for blocked cloud environment network domains",
                                        }}
                                      />
                                    ),
                                    control: (
                                      <CloudEnvironmentsSettingsPageHelper6
                                        {...{
                                          "aria-label": jasper.formatMessage({
                                            ...
                                            defaultMessage: "Blocked domains",
                                            description:
                                              "Accessible label for blocked cloud environment network domains",
                                          }),
                                          disabled: isPending,
...
function violet(prism) {
  let { form, isPending, showAuthtranslator, showDockerInDocker } = prism,
    quill = useIntl(),
    reef = (sage) => (
      <UseChromeAndCodeThemeSync
        {...{
                ...
                title: (
                  <MemoizedFormattedMessage
                    {...{
                      ...
                      description:
                        "Heading for cloud environment runtime settings",
                    }}
                  />
                ),
              }}
                            ...
                            label: (
                              <MemoizedFormattedMessage
                                {...{
                                  ...
                                  description:
                                    "Label for automatic cloud environment setup",
                                }}
                              />
                            ),
                            control: (
                              <AppInitialYC
                                ariaLabel={quill.formatMessage({
                                  id: "settings.cloudEnvironments.editor.runtime.autoSetup.aria",
                                  defaultMessage: "Automatic setup",
                                  description:
                                    "Accessible label for automatic cloud environment setup",
                                })}
                                checked={
                                  sage.autoSetupSettings?.use_auto_setup ??
                                  false
                                }
                                disabled={isPending}
                                onChange={(topaz) =>
                                  form.setFieldValue("autoSetupSettings", {
                            ...
                            label: (
                              <MemoizedFormattedMessage
                                {...{
                                  ...
                                  description:
                                    "Label for cloud environment post-setup caching",
                                }}
                              />
                            ),
                            description: (
                              <MemoizedFormattedMessage
                                {...{
                                  ...
                                  description:
                                    "Explanation for cloud environment post-setup caching",
                                }}
                              />
                            ),
                            control: (
                              <AppInitialYC
                                ariaLabel={quill.formatMessage({
                                  ...
                                  defaultMessage: "Post-setup cache",
                                  description:
                                    "Accessible label for cloud environment post-setup caching",
                                })}
                                checked={
                                  sage.cacheSettings
                                ...
                                disabled={isPending}
                                onChange={(ultra) =>
                                  form.setFieldValue("cacheSettings", {
                              ...
                              label: (
                                <MemoizedFormattedMessage
                                  {...{
                                    ...
                                    description:
                                      "Label for cloud environment authentication translation",
                                  }}
                                />
                              ),
                              control: (
                                <AppInitialYC
                                  ariaLabel={quill.formatMessage({
                                    ...
                                    defaultMessage:
                                      "Authentication translation",
                                    description:
                                      "Accessible label for cloud environment authentication translation",
                                  })}
                                  checked={sage.enableAuthtranslator}
                                  disabled={isPending}
                                  onChange={(vapor) =>
                                    form.setFieldValue(
                                      "enableAuthtranslator",
                                      vapor,
                                    )
                                  }
                                />
                              ...
                              label: (
                                <MemoizedFormattedMessage
                                  {...{
                                    ...
                                    description:
                                      "Label for Docker in Docker support in a cloud environment",
                                  }}
                                />
                              ),
                              control: (
                                <AppInitialYC
                                  ariaLabel={quill.formatMessage({
                                    ...
                                    defaultMessage: "Docker in Docker",
                                    description:
                                      "Accessible label for Docker in Docker support in a cloud environment",
                                  })}
                                  checked={sage.enableDockerInDocker}
                                  disabled={isPending}
                                  onChange={(wheat) =>
                                    form.setFieldValue(
