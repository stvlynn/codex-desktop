...
export function ImportSettings() {
    ...
    marble;
  {
    let nickel = AppInitialEs({
        histories:
          (_data == null || jade ? _data : _data.slice(0, falcon)) ?? [],
      ...
      violet;
    {
      let willow = AppInitialOs({
        ...
        xenon =
          (_data?.some(bravo) ?? false) && (__isLoading || _error != null);
      river = openInBrowser;
      ...
      timber = (
        <MemoizedFormattedMessage
          {...{
            ...
            defaultMessage:
              "Bring setup, projects, and chats from other AI apps into {appName}",
                    ...
                    title: (
                      <MemoizedFormattedMessage
                        {...{
                          ...
                          description:
                            "Heading for imported setup that needs review or authentication",
                        }}
                      />
                    ),
                    subtitle: (
                      <MemoizedFormattedMessage
                        {...{
                          ...
                          defaultMessage:
                            "Finish setting up items from a previous import",
                          description:
                            "Subtitle for imported setup that needs review or authentication",
                        }}
                      />
                    ),
                  }}
                                  ...
                                  description: (
                                    <MemoizedFormattedMessage
                                      {...{
                                        ...
                                        description:
                                          "Description for an imported MCP server that requires authentication",
                                      }}
                                    />
                                  ),
                                  control: (
                                    <ReadLoginRouteQuerySnapshot
                                      {...{
                                        ...
                                        onClick: () => {
                                          gamma(
                                            `/settings/mcp-settings?search=${encodeURIComponent(item)}`,
                                          );
                                        },
                                        children: (
                                          <MemoizedFormattedMessage
                                            {...{
                                              ...
                                              description:
                                                "Button label to open an imported MCP server that needs authentication",
                                            }}
                                          />
                                        ),
                                      }}
                                    ...
                                    children: (
                                      <MemoizedFormattedMessage
                                        {...{
                                          ...
                                          defaultMessage:
                                            "Checking imported MCP servers",
                                          description:
                                            "Label shown while checking imported MCP servers for authentication requirements",
                                        }}
                                      />
                                    ),
                                  }}
                                    ...
                                    label: (
                                      <MemoizedFormattedMessage
                                        {...{
                                          ...
                                          defaultMessage:
                                            "Couldn't check imported MCP servers",
                                          description:
                                            "Error shown when imported MCP servers cannot be checked for authentication requirements",
                                        }}
                                      />
                                    ),
                                    control: (
                                          ...
                                          children: (
                                            <MemoizedFormattedMessage
                                              {...{
                                                ...
                                                description:
                                                  "Button label to retry checking imported MCP servers for authentication requirements",
                                              }}
                                            />
                                          ),
                                        }}
      ...
      <Alpha
        {...{
          ...
          children: [
            umbra,
            violet,
            nickel.length > 0 || _isLoading || error != null ? (
              <UseChromeAndCodeThemeSync
                {...{
                  children: [
                    <UseChromeAndCodeThemeSync.Header
                        ...
                        title: (
                          <MemoizedFormattedMessage
                            {...{
                              ...
                              description:
                                "Heading for the import history section",
                            }}
                          />
                        ),
                        subtitle: (
                          <MemoizedFormattedMessage
                            {...{
                              ...
                              defaultMessage:
                                "Current and previous import results",
                              description:
                                "Subtitle for the import history section",
                            }}
                          />
                        ),
                      }}
                    ...
                    <UseChromeAndCodeThemeSync.Content
                      {...{
                        children: [
                          nickel.map((item) => (
                            <ImportSettingsHelper7
                              key={
                                item.kind === "running"
                                  ? `running-${item.runningImport.startedAtMs}`
                                  : item.history.importId
                              }
                              {...{
                                defaultExpanded:
                                  item.kind === "completed" &&
                                      ...
                                      children: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Label shown while import history is loading",
                                          }}
                                        />
                                      ),
                                    }}
                                      ...
                                      label: (
                                        <MemoizedFormattedMessage
                                          {...{
                                            ...
                                            description:
                                              "Error shown when import history cannot be loaded",
                                          }}
                                        />
                                      ),
                                      control: (
                                            ...
                                            children: (
                                              <MemoizedFormattedMessage
                                                {...{
                                                  ...
                                                  defaultMessage: "Retry",
                                                  description:
                                                    "Button label to retry loading import history",
                                                }}
                                              />
                                            ),
                                          }}
                                ...
                                children: (
                                  <MemoizedFormattedMessage
                                    {...{
                                      ...
                                      description:
                                        "Link to reveal older import history entries",
                                    }}
                                  />
                                ),
                              }}
