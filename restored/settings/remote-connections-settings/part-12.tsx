...
esmInit(() => {
  mount = reactCompilerRuntime();
  ensureComposerEsm_Utt_Init();
  serializeCharacterReferenceNode();
  nozzle = commonJsInit(ensureGoogleDriveConnectorIconsInit(), 1);
  ensureComposerEsm_MT_Init();
  strongMarkerFromOptions();
  platen = commonJsInit(react(), 1);
  ...
  ratchet = "remote-connections-refresh-error";
  shim = "remote-connections-save-success";
  tappet = "remote-connections-save-error";
  arbor = "remote-connections-connect-toggle-error";
  is = "remote-connections-install-codex-error";
  as = "remote-connections-logout-error";
  os = "remote-control-environment-rename-success";
  bushing = "remote-control-environment-rename-error";
  collar = "remote-control-environment-delete-success";
  dowel = "remote-control-environment-delete-error";
  flange = "remote-control-authorize-success";
  gib = "remote-control-authorize-error";
  fs = "remote-connections-ssh-config-entry-not-found";
  hub = "remote-control-pairing-error";
  idler = "[remote-connections/settings]";
  jig = 15e3;
  keeper = [];
  _s = [];
  lug = [];
