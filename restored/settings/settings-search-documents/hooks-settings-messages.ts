...
// Settings search messages for section "hooks-settings".

export type SettingsSearchMessage = {
  id: string;
  defaultMessage?: string;
};
export const hookssettingsMessages: SettingsSearchMessage[] = [
  {
  ...
  {
    defaultMessage: "SessionEnd",
    id: "settings.hooks.event.sessionEnd",
  },
  {
