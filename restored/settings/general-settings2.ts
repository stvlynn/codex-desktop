...
export function setBindGeneralSettings2Peers(next: BindGeneralSettings2Peers): void {
  peers = next;
}
...
export function bindGeneralSettings2() {
  ...
  return peers.e(() => {
    peers.e6o(), KY = `general-settings`, t6o = function (e) {
      return peers.e.String = `string`, peers.e.Array = `array`, peers.e.Record = `record`, peers.e;
    }({}), n6o = [{
