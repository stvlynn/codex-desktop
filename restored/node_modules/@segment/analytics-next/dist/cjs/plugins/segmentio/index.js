...
function segmentio(analytics, settings, integrations) {
    ...
    var resolvedHttpConfig = (0, shared_dispatcher_1.resolveHttpConfig)(initHttpConfig, cdnHttpConfig);
    ...
    var client = deliveryStrategy &&
        ...
        ? (0, batched_dispatcher_1.default)(apiHost, deliveryStrategy.config, resolvedHttpConfig, protocol)
        : (0, fetch_dispatcher_1.default)(deliveryStrategy === null || deliveryStrategy === void 0 ? void 0 : deliveryStrategy.config, resolvedHttpConfig);
    function send(ctx) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, client
                        .dispatch("".concat(remote, "/").concat(path), (0, normalize_1.normalize)(analytics, json, settings, integrations, ctx), attempts)
