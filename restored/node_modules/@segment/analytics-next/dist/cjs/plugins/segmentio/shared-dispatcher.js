...
exports.resolveHttpConfig = exports.computeBackoff = exports.getStatusBehavior = exports.parseRetryAfter = exports.createHeaders = void 0;
var tslib_1 = require("tslib");
var createHeaders = function (headerSettings) {
    return tslib_1.__assign({ 'Content-Type': 'text/plain' }, (typeof headerSettings === 'function'
        ? headerSettings()
        : headerSettings));
};
...
exports.getStatusBehavior = getStatusBehavior;
/**
...
function resolveHttpConfig(config, cdnConfig) {
    ...
    var mergedConfig = config || cdnConfig
        ? {
            rateLimitConfig: tslib_1.__assign(tslib_1.__assign({}, config === null || config === void 0 ? void 0 : config.rateLimitConfig), cdnConfig === null || cdnConfig === void 0 ? void 0 : cdnConfig.rateLimitConfig),
            backoffConfig: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, config === null || config === void 0 ? void 0 : config.backoffConfig), cdnConfig === null || cdnConfig === void 0 ? void 0 : cdnConfig.backoffConfig), { statusCodeOverrides: tslib_1.__assign(tslib_1.__assign({}, (_a = config === null || config === void 0 ? void 0 : config.backoffConfig) === null || _a === void 0 ? void 0 : _a.statusCodeOverrides), (_b = cdnConfig === null || cdnConfig === void 0 ? void 0 : cdnConfig.backoffConfig) === null || _b === void 0 ? void 0 : _b.statusCodeOverrides) }),
        }
        : undefined;
    ...
    return {
        ...
        backoffConfig: {
            ...
            statusCodeOverrides: tslib_1.__assign(tslib_1.__assign({}, DEFAULT_STATUS_CODE_OVERRIDES), backoff === null || backoff === void 0 ? void 0 : backoff.statusCodeOverrides),
        },
    };
}
exports.resolveHttpConfig = resolveHttpConfig;
