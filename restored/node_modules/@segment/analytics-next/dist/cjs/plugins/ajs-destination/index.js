...
var LegacyDestination = /** @class */ (function () {
    ...
    LegacyDestination.prototype.load = function (ctx, analyticsInstance) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var integrationSource, _b, error_1;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 5, , 6]);
                        if (!((_a = this.integrationSource) !== null && _a !== void 0)) return [3 /*break*/, 2];
                        _b = _a;
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, (0, loader_1.loadIntegration)(ctx, this.name, this.version, this.options.obfuscate)];
                    case 3:
                        _b = (_c.sent());
                        _c.label = 4;
                    case 4:
