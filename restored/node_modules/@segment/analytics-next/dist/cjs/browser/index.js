...
var flushQueryString = function (analytics, queryString) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
        ...
        return tslib_1.__generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 11:
                    ...
                    return [4 /*yield*/, (0, remote_loader_1.remoteLoader)(cdnSettings, analytics.integrations, mergedSettings, options, tsubMiddleware, pluginSources).catch(function (err) {
                ...
                return [4 /*yield*/, (0, buffer_1.flushAddSourceMiddleware)(analytics, preInitBuffer)];
                case 19:
                    // register any user-defined plugins added via analytics.addSourceMiddleware()
                    _j.sent();
                    return [2 /*return*/, ctx];
