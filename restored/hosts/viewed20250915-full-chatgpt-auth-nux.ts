...
// Materialized via extractFn(internal `s_e`) / export `qht`.
...
/** Wire bindViewed20250915FullChatgptAuthNux peers once companions land. */
export function setBindViewed20250915FullChatgptAuthNuxPeers(next: BindViewed20250915FullChatgptAuthNuxPeers): void {
  peers = next;
}
...
export function bindViewed20250915FullChatgptAuthNux() {
  if (peers == null) {
    throw new Error("bindViewed20250915FullChatgptAuthNux peers are not configured");
  }
  ...
  return peers.e(() => {
    a_e = `always`, Fl = {
      ...
      [peers.Fl.GIT_ALWAYS_FORCE_PUSH]: !1,
      [peers.Fl.GIT_CREATE_PULL_REQUEST_AS_DRAFT]: !0,
      [peers.Fl.GIT_PULL_REQUEST_MERGE_METHOD]: `merge`,
      [peers.Fl.GIT_REVIEW_MODE]: `full`,
      [peers.Fl.GIT_BRANCH_PREFIX]: `codex/`,
      [peers.Fl.GIT_WORKTREE_ROOT]: ``,
      [peers.Fl.GIT_COMMIT_INSTRUCTIONS]: ``,
      [peers.Fl.GIT_PR_INSTRUCTIONS]: ``,
      [peers.Fl.SIDEBAR_PROJECT_THREAD_ORDERS]: {},
      [peers.Fl.PROJECT_APPEARANCES]: {},
      [peers.Fl.ADDED_REMOTE_CONTROL_ENV_IDS]: [],
      [peers.Fl.CODEX_MOBILE_SETUP_COMPLETED]: !1,
      [peers.Fl.AMBIENT_SUGGESTIONS_ENABLED]: !0,
      [peers.Fl.IA_WAITING_ON_USER_FOLLOWUP_SECONDS]: 1800,
      [peers.Fl.HOTKEY_WINDOW_PROJECTLESS_DEFAULT_ENABLED]: !1,
      [peers.Fl.GLOBAL_DICTATION_KEEP_VISIBLE]: !1,
      [peers.Fl.WORKTREE_AUTO_CLEANUP_ENABLED]: !0,
      [peers.Fl.WORKTREE_KEEP_COUNT]: 15,
      [peers.Fl.BROWSER_ANNOTATION_SCREENSHOTS_MODE]: peers.a_e,
      [peers.Fl.BROWSER_DOWNLOAD_DIRECTORY]: null,
      [peers.Fl.BROWSER_DOWNLOAD_PROMPT_ENABLED]: !1,
      [peers.Fl.DOCK_ICON_PREFERENCE]: `app-default`,
      [peers.Fl.REDUCED_MOTION_PREFERENCE]: `system`
    };
  });
}
