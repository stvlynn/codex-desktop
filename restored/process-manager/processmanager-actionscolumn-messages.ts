...
// defineMessages cluster (bundle `z9`).

import { defineMessages } from "react-intl";

export const processmanagerActionscolumnMessages = defineMessages({
  actionsColumn: {
  ...
  start: {
    ...
    description:
      "Menu item label to start a stopped process that was started by a task",
  },
  restart: {
    id: "codex.processManager.restart",
    defaultMessage: "Restart",
    description:
      "Menu item label to restart a process that was started by a task",
  },
  resizeColumn: {
  ...
  stop: {
    ...
    defaultMessage: "Stop",
    description: "Menu item label to stop a process that was started by a task",
  },
  stoppedStatus: {
