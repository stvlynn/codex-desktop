// Restored from ref/webview/assets/classDiagram-2ON5EDUG-sjELdLqU.js
// Mermaid class diagram definition (primary v1). Assembles mermaid-class-diagram-core.
...
export { ClassDiagram2ON5EDUG as diagram };
