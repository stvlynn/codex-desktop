...
// Mermaid Langium parser core (alt) — lazy diagram parser registry.
...
import {
  f as wrapLazy,
  p as langiumHelpersInit,
} from "./mermaid-langium-grammar-alt";
import { r as initArchitectureLangium } from "./mermaid-architecture-langium-services-alt";
import { r as initGitGraphLangium } from "./mermaid-git-graph-langium-services-alt";
import { r as initInfoLangium } from "./mermaid-info-langium-services-alt";
import { r as initPacketLangium } from "./mermaid-packet-langium-services-alt";
import { r as initPieLangium } from "./mermaid-pie-langium-services-alt";
import { r as initRadarLangium } from "./mermaid-radar-langium-services-alt";
import { r as initTreemapLangium } from "./mermaid-treemap-langium-services-alt";
