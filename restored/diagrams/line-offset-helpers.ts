...
// Mermaid diagram line offset helpers (primary bundle).
...
export const arrowTipOffsets: ArrowTipOffsets = {
  arrow_point: 9,
  arrow_cross: 12.5,
  arrow_circle: 12.5,
};
...
export const initMermaidLineOffsetChunk = esmInit(() => {
  initDayjsLoggerRuntime();
});
