// Restored from ref/webview/assets/classDiagram-v2-HSJHXN6E-Db4pWg__.js
// Mermaid class diagram definition (alt v2). Assembles mermaid-class-diagram-core-alt.
...
import { l } from "./svg-drawing-helpers-alt";
import { n as chunk55IACEB6N } from "./get-diagram-element-alt";
...
export { ClassDiagramV2HSJHXN6E as diagram };
