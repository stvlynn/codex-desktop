...
export function useChatgptComposerControllerHelper13(request8814: any, request8815: any) {
  return request8814 instanceof appInitialIdt &&
    request8814.status === 404
    ? useChatgptComposerControllerHelper14(
        request8814,
...
export function useChatgptComposerControllerHelper14(request8845: any) {
  try {
    ...
    return slot15571.success
      ? slot15571.data.detail
      : null;
  } catch {
    return null;
  }
