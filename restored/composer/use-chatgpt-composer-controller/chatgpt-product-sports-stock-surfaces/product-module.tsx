...
function useChatgptComposerControllerHelper214(
  ...
  let slot8579 =
      slot8578,
    slot8580 =
      slot8577 ?? _AppInitialOI(reference);
  let slot8581 =
    slot8580;
  if (
    slot8581 == null &&
...
function useChatgptComposerControllerHelper217(
  request10494: any) {
  return typeof request10494.type == "string" &&
    request10494.type.length > 0
    ? request10494.type
    : null;
}
...
function useChatgptComposerControllerHelper219(
  request11185: any) {
  return request11185 == null
    ? null
    : (_appInitialIL(request11185) ?? null);
}
...
function useChatgptComposerControllerHelper222(
  request10770: any) {
  return typeof request10770 == "string" &&
    request10770.trim().length > 0
    ? request10770
    : null;
}
let slot274: any;
