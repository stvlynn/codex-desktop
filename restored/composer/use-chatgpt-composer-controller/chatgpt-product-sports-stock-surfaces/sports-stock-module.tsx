...
function useChatgptComposerControllerHelper223(request5055: any) {
...
function useChatgptComposerControllerHelper224(request2087: any) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const Slot6273 = slot6273;
  let { reference } = request2087,
    ...
    slot6276,
    slot6277;
  slot6277 = Symbol.for("react.early_return_sentinel");
  bb0: {
    let slot10006 = Array.isArray(reference.games) ? reference.games : [];
    ...
    slot6273 = useChatgptComposerControllerHelper64;
    slot6276 = slot6272.formatMessage({
    ...
    slot6275 = slot10006.slice(0, 5).map(useChatgptComposerControllerHelper225);
  }
  if (slot6277 !== Symbol.for("react.early_return_sentinel")) return slot6277;
  let slot6278 = <div className={slot6274}>{slot6275}</div>;
  return <Slot6273 title={slot6276}>{slot6278}</Slot6273>;
}
  ...
  return (
    ...
    >
      <div className="font-medium">
        {useChatgptComposerControllerHelper234(request5513)}
      </div>
      {useChatgptComposerControllerHelper76(
        useChatgptComposerControllerHelper78(request5513)?.details,
      ) == null ? null : (
...
function useChatgptComposerControllerHelper226(request4898: any) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const UseChatgptComposerControllerHelper227 =
    useChatgptComposerControllerHelper227;
  let { reference } = request4898,
    slot11029 = slot286.safeParse(reference);
  let slot11030 = slot11029;
  if (!slot11030.success || slot11030.data.conferences.length === 0) {
    let slot15041;
    return <UseChatgptComposerControllerHelper68 reference={reference} />;
  }
  return (
    <UseChatgptComposerControllerHelper227 standingsRef={slot11030.data} />
  );
}
function useChatgptComposerControllerHelper227(request1230: any) {
  let { standingsRef } = request1230,
    [slot4751, slot4752] = slot280.useState(0),
    slot4753 =
      standingsRef.conferences[slot4751] ?? standingsRef.conferences[0];
  if (slot4753 == null) return null;
  let slot4754 =
    standingsRef.league?.id != null && slot282.includes(standingsRef.league.id);
  let slot4755 = slot4754,
    slot4756 =
  ...
  {
    let slot10503;
    slot10503 = (request5850, request5851) => {
    ...
    slot4757 = slot4753.divisions.map(slot10503);
  }
  let slot4758 = <div className="mt-3">{slot4757}</div>;
  return (
...
function useChatgptComposerControllerHelper228(request738: any) {
  const AppInitialGft = appInitialGft;
  let { division, teamsColumnHeader, useAlias } = request738,
    slot3538,
    slot3539,
    slot3540,
    slot3541;
  {
    let slot4351 = division.headers.map(useChatgptComposerControllerHelper230);
    ...
    let slot4354;
    slot4354 = division.headers.map(useChatgptComposerControllerHelper229);
    slot3540 = (
      <thead>
        <tr>
          {slot4353}
    ...
    slot3538 = division.teams.map((item, index) => {
  ...
  let slot3542 = <tbody>{slot3538}</tbody>;
  let slot3543 = (
  ...
  return <div className={slot3541}>{slot3543}</div>;
}
...
function useChatgptComposerControllerHelper231(request3820: any) {
  let { team } = request3820,
    slot9639 = useChatgptComposerControllerHelper31();
  if (team.logo == null || slot9639?.shouldBlockExternalEgress === true) {
    let slot13314;
    return (
      <span
        aria-hidden="true"
...
function useChatgptComposerControllerHelper232(request3120: any) {
...
function useChatgptComposerControllerHelper233(request6798: any) {
  let { data } = request6798;
  if (data == null) return null;
  let slot13174 = data.type === "text" ? data.text : data.alt;
  return slot13174 == null ? null : <>{slot13174}</>;
}
function useChatgptComposerControllerHelper234(request8726: any) {
  let slot14755 = useChatgptComposerControllerHelper78(request8726),
    slot14756 = useChatgptComposerControllerHelper235(
      useChatgptComposerControllerHelper78(slot14755?.first_team_info),
    ),
    slot14757 = useChatgptComposerControllerHelper235(
      useChatgptComposerControllerHelper78(slot14755?.second_team_info),
    );
  return slot14756 == null || slot14757 == null
    ? (useChatgptComposerControllerHelper76(slot14755?.date) ?? "")
    : `${slot14756} / ${slot14757}`;
}
function useChatgptComposerControllerHelper235(request10862: any) {
  let slot15870 = useChatgptComposerControllerHelper78(request10862?.team);
  return (
    useChatgptComposerControllerHelper76(slot15870?.name) ??
    useChatgptComposerControllerHelper76(slot15870?.alias)
  );
}
let $y: any;
let slot279: any;
...
function useChatgptComposerControllerHelper236(request1156: any) {
  ...
  let { reference } = request1156,
    ...
    slot4541;
  {
    let slot4784 = useChatgptComposerControllerHelper78(reference.stock),
      slot4785 = useChatgptComposerControllerHelper78(slot4784?.asset),
      slot4786 = useChatgptComposerControllerHelper78(slot4784?.price),
      slot4787 =
        useChatgptComposerControllerHelper76(reference.ticker) ??
        useChatgptComposerControllerHelper76(slot4785?.ticker),
      slot4788 = useChatgptComposerControllerHelper76(slot4785?.name),
      slot4789 = $d(slot4786?.price),
      slot4790 = $d(slot4786?.change),
      slot4791 = $d(slot4786?.change_percent),
      slot4792 = AppInitialSI(reference),
      slot4793 =
        slot4788 == null && slot4787 == null
          ...
          : [slot4788, slot4787 == null ? null : `(${slot4787})`]
              .filter(Boolean)
              .join(" "),
      slot4794 =
        slot4789 == null
          ? null
          : useChatgptComposerControllerHelper75(slot4789, {
      ...
      slot4795 =
        slot4790 == null
          ? null
          : useChatgptComposerControllerHelper237(slot4790),
      slot4796 =
        slot4791 == null
          ? null
          : `(${useChatgptComposerControllerHelper237(slot4791 * 100)}%)`;
    let slot4797 = slot4796,
      slot4798 =
        slot4794 == null ? null : (
          <div className="text-2xl font-semibold">{slot4794}</div>
        );
    let slot4799 =
      slot4790 == null && slot4791 == null ? null : (
        <div
          className={
            (slot4790 ?? slot4791 ?? 0) < 0
              ? "text-red-500"
              : "text-green-600 dark:text-green-400"
          }
        >
          {slot4795}
          {slot4790 != null && slot4791 != null ? slot290 : null}
          {slot4797}
        </div>
      );
    let slot4800;
    ...
    slot4541 = (
      <UseChatgptComposerControllerHelper64 title={slot4793}>
        {slot4800}
        {slot4792 == null ? null : (
          <div className="mt-2">
            {
              <UseChatgptComposerControllerHelper74 href={slot4792}>
                {useChatgptComposerControllerHelper77(slot4792)}
              </UseChatgptComposerControllerHelper74>
            }
          </div>
        )}
...
function useChatgptComposerControllerHelper237(request9209: any) {
  let slot15163 = useChatgptComposerControllerHelper75(Math.abs(request9209), {
    maximumFractionDigits: 2,
    minimumFractionDigits: 2,
  });
...
function useChatgptComposerControllerHelper238(request4587: any) {
  const AppInitialQL = appInitialQL;
  let { reference } = request4587,
    slot10635 = useChatgptComposerControllerHelper239(reference);
  let slot10636 = slot10635;
  if (slot10636 == null && reference.type === "hidden") return null;
  let slot10637 = slot10636 ?? _AppInitialNI(reference);
  let slot10638 = slot10637;
...
function useChatgptComposerControllerHelper239(request6943: any) {
  let slot13295 = useChatgptComposerControllerHelper76(request6943.utc_time);
  if (slot13295 == null) return null;
  let slot13296 = new Date(slot13295);
  return Number.isNaN(slot13296.getTime())
    ...
    : new Intl.DateTimeFormat(undefined, {
        ...
        new Date(
          slot13296.getTime() +
            useChatgptComposerControllerHelper240(request6943),
        ),
      );
}
function useChatgptComposerControllerHelper240(request6762: any) {
  let slot13130 = useChatgptComposerControllerHelper76(request6762.utc_offset);
  if (slot13130 == null) return 0;
  let slot13131 = /^([+-])(\d{2}):?(\d{2})?$/.exec(slot13130);
  if (slot13131 == null) return 0;
  let [, slot13132, slot13133, slot13134] = slot13131,
    slot13135 = Number(slot13133),
    slot13136 = Number(slot13134 ?? "0");
  return !Number.isFinite(slot13135) || !Number.isFinite(slot13136)
    ? 0
    : (slot13132 === "-" ? -1 : 1) * (slot13135 * 60 + slot13136) * 6e4;
}
let slot292: any;
let slot293: any;
...
function useChatgptComposerControllerHelper241(request3028: any) {
  ...
  let slot8123 = slot8122;
  if (slot8123 == null) {
    let slot15042;
    return <UseChatgptComposerControllerHelper70 reference={reference} />;
  }
  let slot8124 = E_(reference);
  let slot8125 = slot8124;
  if (slot8125 == null) {
    let slot13724;
    return (
      <span className="font-semibold text-token-text-primary">{slot8123}</span>
    );
  }
  return (
    <O_
...
function useChatgptComposerControllerHelper242(request2234: any) {
  const Slot6499 = slot6499;
  const Slot6500 = slot6500;
  let { reference } = request2234,
    slot6497 = _AppInitialOI(reference);
  let slot6498 = slot6497,
    slot6499,
    slot6500,
    slot6501,
    slot6502,
    slot6503,
    slot6504;
  slot6503 = Symbol.for("react.early_return_sentinel");
  bb0: {
    if (
      ((slot6504 = AppInitialSI(reference)),
      slot6498 == null && slot6504 == null)
    ) {
      slot6503 = null;
      break bb0;
    }
    slot6500 = useChatgptComposerControllerHelper64;
    slot6499 = useChatgptComposerControllerHelper73;
    slot6501 = "aspect-video";
    slot6502 = useChatgptComposerControllerHelper77(slot6504);
  }
  if (slot6503 !== Symbol.for("react.early_return_sentinel")) return slot6503;
  let slot6505 = useChatgptComposerControllerHelper76(reference.thumbnail_url);
  let slot6506 = slot6498 ?? slot6504 ?? "",
    slot6507 = (
      <Slot6499
  ...
  return <Slot6500>{slot6507}</Slot6500>;
}
let slot297: any;
let slot298: any;
