...
export function useChatgptComposerControllerHelper79(request2145: any) {
  ...
  let slot6368 = slot6367,
    slot6369,
    slot6370,
    slot6371,
    slot6372,
    slot6373;
  slot6373 = Symbol.for("react.early_return_sentinel");
  bb0: {
    let slot12360 = useChatgptComposerControllerHelper85(reference),
      slot12361 =
        slot12360.length > 0
          ? slot12360
    ...
    slot6369 = useChatgptComposerControllerHelper64;
    slot6372 = slot6368;
    slot6370 = "grid gap-2 sm:grid-cols-2";
    slot6371 = slot12361.slice(0, 6).map(of);
  }
  if (slot6373 !== Symbol.for("react.early_return_sentinel")) return slot6373;
  let slot6374 = <div className={slot6370}>{slot6371}</div>;
  return (
    <ContentReferenceCard title={slot6372}>{slot6374}</ContentReferenceCard>
  );
}
function of(request8195, request8196) {
...
function useChatgptComposerControllerHelper80(request1815) {
  let { reference } = request1815,
    ...
    slot5892,
    slot5893;
  slot5893 = Symbol.for("react.early_return_sentinel");
  bb0: {
    let slot9519 = useChatgptComposerControllerHelper85(reference).filter(
    ...
    let slot9520 = useChatgptComposerControllerHelper76(reference.title);
    let slot9521 = slot9520;
    ...
    slot5889 = slot9519.map(useChatgptComposerControllerHelper81);
  }
  if (slot5893 !== Symbol.for("react.early_return_sentinel")) return slot5893;
  let slot5894 = <div className={slot5888}>{slot5889}</div>;
  return (
    <div className={slot5890} data-testid={slot5891}>
      {slot5892}
      {slot5894}
    </div>
  );
}
function useChatgptComposerControllerHelper81(request10696, request10697) {
...
function useChatgptComposerControllerHelper82(request11352) {
  return request11352.url != null;
}
function useChatgptComposerControllerHelper83(request573) {
  ...
  let { item } = request573,
    ...
    slot3101 =
      item.dateLabel ??
      useChatgptComposerControllerHelper87(slot3099, item.pubDate);
  let slot3102 = slot3101,
    slot3103 = !slot3100,
    slot3104 = (
  ...
  let slot3107 =
    item.thumbnailUrl == null || slot3100 ? null : (
      <img
        alt={item.title}
  ...
  let slot3111 = <span className="truncate">{item.attribution}</span>;
  let slot3112 = (
  ...
  let slot3114 =
    slot3102 == null ? null : (
      <div className="text-xs text-token-text-secondary">{slot3102}</div>
    );
  let slot3115 = (
...
function useChatgptComposerControllerHelper85(request4429) {
  let slot10398 = Array.isArray(request4429.items) ? request4429.items : [],
    slot10399 = Array.isArray(request4429.domains) ? request4429.domains : [];
  return [...slot10398, ...slot10399].flatMap((item) => {
    let slot11591 = useChatgptComposerControllerHelper78(item),
      slot11592 = useChatgptComposerControllerHelper76(slot11591?.title),
      slot11593 = useChatgptComposerControllerHelper76(slot11591?.url);
    return slot11592 == null
      ? []
      : [
          {
            attribution:
              useChatgptComposerControllerHelper76(slot11591?.attribution) ??
              useChatgptComposerControllerHelper77(slot11593) ??
              slot11593,
            ...
            subtitle:
              useChatgptComposerControllerHelper76(slot11591?.subtitle) ??
              useChatgptComposerControllerHelper76(slot11591?.snippet) ??
              useChatgptComposerControllerHelper76(slot11591?.domain) ??
              useChatgptComposerControllerHelper77(slot11593),
...
function useChatgptComposerControllerHelper86(request7356) {
  let slot13721 =
    useChatgptComposerControllerHelper76(request7356.page_title) ??
    useChatgptComposerControllerHelper76(request7356.display_title);
  return slot13721 == null
    ? []
    : [
        {
          subtitle:
            useChatgptComposerControllerHelper76(request7356.snippet) ??
            useChatgptComposerControllerHelper76(request7356.display_title),
          thumbnailUrl: null,
          title: slot13721,
          url: useChatgptComposerControllerHelper76(request7356.url),
        },
      ];
}
function useChatgptComposerControllerHelper87(request5967, request5968) {
  if (request5968 == null) return null;
  let slot12306 = new Date(request5968 * 1e3),
    slot12307 = Math.max(
      Math.floor((Date.now() - slot12306.getTime()) / 86400000),
      0,
    );
  if (slot12307 > _f)
    return request5967.formatDate(slot12306, {
      dateStyle: "medium",
    });
  let slot12308 = request5967.formatRelativeTime(-slot12307, "day", {
    numeric: "auto",
  });
