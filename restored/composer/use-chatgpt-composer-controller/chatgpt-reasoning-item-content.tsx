...
function useChatgptComposerControllerHelper261(
  request1884,
) {
  ...
  let { item, localConversationId, resolvedApps, shouldBlockExternalEgress } =
      request1884,
    slot5956 = shouldBlockExternalEgress
      ? "restricted"
      : "allow",
    slot5957 = !item.completed,
    slot5958 =
      item.presentation === "thought" ? "tertiary" : "primary",
    slot5959 = {
