...
function TrustedContactPeopleIcon(props: any) {
  return (
    ...
    >
      <path
        d="M10.5 11.25C12.1569 11.25 13.5 9.90685 13.5 8.25C13.5 6.59315 12.1569 5.25 10.5 5.25C8.84315 5.25 7.5 6.59315 7.5 8.25C7.5 9.90685 8.84315 11.25 10.5 11.25Z"
        stroke="currentColor"
        strokeWidth={1.5}
      />
      <path
        d="M4.5 18.75C4.5 15.4363 7.18629 12.75 10.5 12.75C11.6177 12.75 12.664 13.0556 13.5599 13.5878"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth={1.5}
      />
      <path
        d="M17.25 19.5C17.1178 19.5 16.9856 19.4652 16.8675 19.3957C14.378 17.9305 13.5 16.4158 13.5 15.1875C13.5 14.0505 14.361 13.125 15.425 13.125C16.0064 13.125 16.4614 13.3988 16.7812 13.7137C16.8988 13.8295 17.1012 13.8295 17.2188 13.7137C17.5386 13.3988 17.9936 13.125 18.575 13.125C19.639 13.125 20.5 14.0505 20.5 15.1875C20.5 16.4158 19.622 17.9305 17.1325 19.3957C17.0144 19.4652 16.8822 19.5 16.75 19.5H17.25Z"
        fill="currentColor"
      />
    </svg>
  );
...
function useChatgptComposerControllerHelper250(request298) {
  ...
  let { conversationId, disclaimerMetadata, disclaimerType, hostId } =
    ...
    [slot1933, slot1934] = React.useState(false),
    [slot1935, slot1936] = React.useState(false),
    slot1937,
    slot1938,
    slot1939,
    slot1940,
    slot1941;
  slot1941 = Symbol.for("react.early_return_sentinel");
  bb0: {
    let slot9215 =
        useChatgptComposerControllerHelper254(
    ...
    slot1937 = useChatgptComposerControllerHelper249;
    slot1939 = "w-full bg-token-main-surface-primary";
    slot1940 = useChatgptComposerControllerHelper252({
      disclaimerType,
      intl: slot1931,
      trustedContactName: slot9215,
    });
  }
  if (slot1941 !== Symbol.for("react.early_return_sentinel")) return slot1941;
  let slot1942 =
    disclaimerType === "notify_trusted_contact_us5" ? (
      ...
      <div className="flex flex-wrap gap-3">
        {hostId == null ? null : (
          <UseChatgptComposerControllerHelper65
            ...
            className="inline-flex cursor-interaction rounded-full bg-token-foreground px-4 py-1.5 text-sm leading-[18px] text-token-dropdown-background hover:bg-token-foreground/80"
            onClickCapture={() => {
              appInitialJ9(slot1932, AppInitialY6, {
                entryPoint:
            ...
            onClick={() => {
              slot1935 ||
                ...
                slot1932
                  ...
                  .catch(() => {
                    slot1932.get(appInitialLlt).danger(
                      slot1931.formatMessage({
  ...
  let slot1943 = (
    <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-token-bg-secondary text-token-text-primary">
      {<PeopleIcon aria-hidden={true} className="icon-lg" />}
    </span>
  );
  return (
    <DisclaimerCard
