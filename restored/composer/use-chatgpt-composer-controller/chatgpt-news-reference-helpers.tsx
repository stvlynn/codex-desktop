...
export function useChatgptComposerControllerHelper75(request10963: any, request10964: any) {
...
export function $d(request10771: any) {
  return typeof request10771 == "number" &&
    Number.isFinite(request10771)
    ? request10771
    : null;
}
export function useChatgptComposerControllerHelper76(request10495: any) {
  return typeof request10495 == "string" &&
    request10495.trim().length > 0
    ? request10495.trim()
    : null;
}
export function useChatgptComposerControllerHelper77(request9336: any) {
  ...
  try {
    return new URL(request9336).hostname.replace(
      /^www\./,
      "",
    );
  } catch {
...
export function useChatgptComposerControllerHelper78(request9900: any) {
  return typeof request9900 == "object" &&
    request9900
