...
// Artifact / file-tree kind icon (bundle `VHi`).

import type { SVGProps, ReactElement } from "react";
export type ArtifactDocumentFileIconProps = SVGProps<SVGSVGElement>;
export function ArtifactDocumentFileIcon({
  ...props
}: ArtifactDocumentFileIconProps): ReactElement {
  const e = props;
  return (
    <svg
      width={24}
