...
// Artifact / file-tree kind icon (bundle `KHi`).

import type { SVGProps, ReactElement } from "react";
export type PresentationFileIconProps = SVGProps<SVGSVGElement>;
export function PresentationFileIcon({
  ...props
}: PresentationFileIconProps): ReactElement {
  const e = props;
  return (
    <svg
      width={24}
