...
// SVG icon (bundle `YR` / export `LB`).

import type { SVGProps, ReactElement } from "react";
export type ProjectDropdownGlyphIconProps = SVGProps<SVGSVGElement>;
export function ProjectDropdownGlyphIcon({
  ...props
}: ProjectDropdownGlyphIconProps): ReactElement {
  const e = props;
  return (
    <svg
