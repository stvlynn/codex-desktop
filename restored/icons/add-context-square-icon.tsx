...
// SVG icon (bundle `lh` / export `Olt`).

import type { SVGProps, ReactElement } from "react";
export type AddContextSquareIconProps = SVGProps<SVGSVGElement>;
export function AddContextSquareIcon({
  ...props
}: AddContextSquareIconProps): ReactElement {
  const e = props;
  return (
    <svg
      width={20}
