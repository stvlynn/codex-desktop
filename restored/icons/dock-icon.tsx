// Restored from ref/webview/assets/dock-B_5B6SvV.js
// Dock / window shelf SVG icon.

import type { ReactElement, SVGProps } from "react";

export type DockIconProps = SVGProps<SVGSVGElement>;

export function DockIcon(props: DockIconProps): ReactElement {
  return (
    <svg
      width={21}
      height={21}
