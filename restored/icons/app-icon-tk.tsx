...
// SVG icon (bundle `tEo` / export `Tk`).

import type { SVGProps, ReactElement } from "react";
export type AppIconTkProps = SVGProps<SVGSVGElement>;
export function AppIconTk({ ...props }: AppIconTkProps): ReactElement {
  const e = props;
  return (
    <svg
      width={16}
...
/** Bundle export `Ek` / init `nEo` — Rolldown ESM init retained as no-op. */
export function ensureAppIconTkInit(): void {}
