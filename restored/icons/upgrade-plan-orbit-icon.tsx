...
// SVG icon used near plan / credits upgrade surfaces (`XTs` / export `iy`).

import type { SVGProps, ReactElement } from "react";
export type UpgradePlanOrbitIconProps = SVGProps<SVGSVGElement>;

/** Bundle `XTs` / export `iy`. */
export function UpgradePlanOrbitIcon({
  ...props
}: UpgradePlanOrbitIconProps): ReactElement {
  return (
    <svg
      width={20}
      height={20}
