...
// SVG icon (bundle `ZCo` / export `Vk`).

import type { SVGProps, ReactElement } from "react";
export type BrowserTabMediaIconProps = SVGProps<SVGSVGElement>;
export function BrowserTabMediaIcon({
  ...props
}: BrowserTabMediaIconProps): ReactElement {
  const e = props;
  return (
    <svg
      width={20}
