// Restored from ref/webview/assets/star-zhAPZW1a.js
// Outline star SVG icon.

import type { ReactElement, SVGProps } from "react";

export type StarOutlineIconProps = SVGProps<SVGSVGElement>;

export function StarOutlineIcon(props: StarOutlineIconProps): ReactElement {
  return (
    <svg
...
export function ensureStarOutlineIconInit(): void {}
