...
// SVG icon (bundle `pP` / export `HG`).

import type { SVGProps, ReactElement } from "react";
export type AppIconHGProps = SVGProps<SVGSVGElement>;
export function AppIconHG({ ...props }: AppIconHGProps): ReactElement {
  const e = props;
  return (
    <svg
...
/** Bundle export `UG` / init `iei` — Rolldown ESM init retained as no-op. */
export function ensureAppIconHGInit(): void {}
