...
// Artifact / file-tree kind icon (bundle `WHi`).

import type { SVGProps, ReactElement } from "react";
export type PdfFileIconProps = SVGProps<SVGSVGElement>;
export function PdfFileIcon({ ...props }: PdfFileIconProps): ReactElement {
  const e = props;
  return (
    <svg
