...
// Materialized via extractFn(internal `wjo`) / export `YO`.

export type BindDeferredUiYO2Peers = {
  Cjo: (...args: unknown[]) => unknown;
  J: (...args: unknown[]) => unknown;
  Sjo: (...args: unknown[]) => unknown;
  e: (...args: unknown[]) => unknown;
  o: (...args: unknown[]) => unknown;
};
let peers: BindDeferredUiYO2Peers | null = null;

/** Wire bindDeferredUiYO2 peers once companions land. */
export function setBindDeferredUiYO2Peers(next: BindDeferredUiYO2Peers): void {
  peers = next;
}
 ...
 */
export function bindDeferredUiYO2() {
  if (peers == null) {
    throw new Error("bindDeferredUiYO2 peers are not configured");
  }
  return peers.e(() => {
    peers.o();
    Sjo = peers.J();
