...
// Materialized via extractFn(internal `DRl`) / export `qo`.

export type SvgEvenoddIcon2Peers = {
  ERl: (...args: unknown[]) => unknown;
...
/** Wire svgEvenoddIcon2 peers once companions land. */
 ...
 */
export function svgEvenoddIcon2() {
  if (peers == null) {
