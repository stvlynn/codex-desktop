...
// Materialized via extractFn(internal `xZa`) / export `Xj`.

export type BindDeferredUiXjPeers = {
  J: (...args: unknown[]) => unknown;
  bZa: (...args: unknown[]) => unknown;
  e: (...args: unknown[]) => unknown;
  o: (...args: unknown[]) => unknown;
  yZa: (...args: unknown[]) => unknown;
};
let peers: BindDeferredUiXjPeers | null = null;

/** Wire bindDeferredUiXj peers once companions land. */
 ...
 */
export function bindDeferredUiXj() {
  if (peers == null) {
