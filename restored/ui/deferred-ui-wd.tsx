...
// Materialized via extractFn(internal `oUo`) / export `WD`.

export type BindDeferredUiWDPeers = {
  J: (...args: unknown[]) => unknown;
  aUo: (...args: unknown[]) => unknown;
...
/** Wire bindDeferredUiWD peers once companions land. */
 ...
 */
export function bindDeferredUiWD() {
  if (peers == null) {
