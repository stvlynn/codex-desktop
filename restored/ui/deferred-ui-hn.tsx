...
// Materialized via extractFn(internal `Niu`) / export `Hn`.

export type BindDeferredUiHnPeers = {
  J: (...args: unknown[]) => unknown;
  Miu: (...args: unknown[]) => unknown;
...
/** Wire bindDeferredUiHn peers once companions land. */
 ...
 */
export function bindDeferredUiHn() {
  if (peers == null) {
