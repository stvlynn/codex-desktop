...
// Materialized via extractFn(internal `jKo`) / export `hD`.

export type BindDeferredUiHDPeers = {
  AKo: (...args: unknown[]) => unknown;
  J: (...args: unknown[]) => unknown;
  e: (...args: unknown[]) => unknown;
  kKo: (...args: unknown[]) => unknown;
  o: (...args: unknown[]) => unknown;
};
let peers: BindDeferredUiHDPeers | null = null;

/** Wire bindDeferredUiHD peers once companions land. */
 ...
 */
export function bindDeferredUiHD() {
  if (peers == null) {
