...
// Default spinner glyph used when Spinner is not given a custom Icon (`r$e`).

import type { SVGProps } from "react";

export type DefaultSpinnerIconProps = SVGProps<SVGSVGElement>;

export function DefaultSpinnerIcon(props: DefaultSpinnerIconProps) {
  return (
    <svg
      width={24}
      height={24}
