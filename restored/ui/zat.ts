...
export function zat() {
  ...
  return peers.e(() => {
    (peers.EAt(),
      ...
      (tv = `\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*`),
      (YAt = /^#([0-9a-f]{3,8})$/),
      (XAt = RegExp(`^rgb\\(${peers.ev},${peers.ev},${peers.ev}\\)$`)),
      (ZAt = RegExp(`^rgb\\(${peers.tv},${peers.tv},${peers.tv}\\)$`)),
      (QAt = RegExp(
        `^rgba\\(${peers.ev},${peers.ev},${peers.ev},${peers.JAt}\\)$`,
      )),
      ($At = RegExp(
        `^rgba\\(${peers.tv},${peers.tv},${peers.tv},${peers.JAt}\\)$`,
      )),
      (ejt = RegExp(`^hsl\\(${peers.JAt},${peers.tv},${peers.tv}\\)$`)),
      (tjt = RegExp(
        `^hsla\\(${peers.JAt},${peers.tv},${peers.tv},${peers.JAt}\\)$`,
      )),
      (njt = {
        aliceblue: 15792383,
      ...
      peers.wAt(
        ...
        peers.TAt(peers.Y_, {
          brighter(e) {
            return (
              (e = peers.e == null ? peers.qAt : peers.qAt ** +peers.e),
              new peers.X_(
                this.r * peers.e,
                this.g * peers.e,
                this.b * peers.e,
          ...
          darker(e) {
            return (
              (e = peers.e == null ? peers.KAt : peers.KAt ** +peers.e),
              new peers.X_(
                this.r * peers.e,
                this.g * peers.e,
                this.b * peers.e,
      ...
      peers.wAt(
        ...
        peers.TAt(peers.Y_, {
          brighter(e) {
            return (
              (e = peers.e == null ? peers.qAt : peers.qAt ** +peers.e),
              new peers.$_(this.h, this.s, this.l * peers.e, this.opacity)
            );
          },
          darker(e) {
            return (
          ...
          rgb() {
            var e = (this.h % 360) + (this.h < 0) * 360,
              ...
              i = 2 * n - r;
            return new peers.X_(
              peers.GAt(peers.e >= 240 ? peers.e - 240 : peers.e + 120, i, r),
              peers.GAt(peers.e, i, r),
              peers.GAt(peers.e < 120 ? peers.e + 240 : peers.e - 120, i, r),
              this.opacity,
            );
          },
          clamp() {
          ...
          displayable() {
            return (
              ((0 <= this.s && this.s <= 1) || peers.isNaN(this.s)) &&
              0 <= this.l &&
              this.l <= 1 &&
              0 <= this.opacity &&
              this.opacity <= 1
