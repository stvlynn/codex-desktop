...
export function setBindBindDeferredUiQxPeers(next: BindBindDeferredUiQxPeers): void {
  peers = next;
}
...
export function bindBindDeferredUiQx() {
  ...
  return peers.Oa(peers.Q, ({
    ...
    let o = t ? n(peers.gD, e) ?? null : null,
      ...
      m = p && o != null && l != null && c != null && d != null && u != null ? peers.cps({
        conversationId: e,
        getTurn: (e, t) => n(peers.drr, {
          conversationId: e,
          entityKey: t
        }),
        historyEntries: l,
