...
// Materialized via extractFn(internal `WNa`) / export `TN`.

export type BindDeferredUiTNPeers = {
  HNa: (...args: unknown[]) => unknown;
...
/** Wire bindDeferredUiTN peers once companions land. */
 ...
 */
export function bindDeferredUiTN() {
  if (peers == null) {
