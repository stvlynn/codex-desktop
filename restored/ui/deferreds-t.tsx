...
export function bindDeferredsT() {
  ...
  return peers.e(() => {
    (peers.Sl(),
      ...
      (ape = peers.rl().int().min(0).max(100)),
      (ope = {
        off: null,
        "30-seconds": 3e4,
        "1-minute": 6e4,
      ...
      peers.pl([`ACT06`, `ACT07`, `ACT08`, `ACT09`, `ACT10_ACT11`, `ACT12`]),
      (spe = peers.pl(
      ...
      (fpe = peers.pl([`push-to-talk`, `realtime`])),
      (ppe = peers.pl([`pinned`, `recent`, `priority`, `custom`])),
      (mpe = [`AG00`, `AG01`, `AG02`, `AG03`, `AG04`, `AG05`]),
      (hpe = {
        up: {
          type: `command`,
