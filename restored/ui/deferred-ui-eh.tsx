...
// Materialized via extractFn(internal `W3s`) / export `eh`.

export type BindDeferredUiEhPeers = {
  H3s: (...args: unknown[]) => unknown;
  J: (...args: unknown[]) => unknown;
  U3s: (...args: unknown[]) => unknown;
  e: (...args: unknown[]) => unknown;
  o: (...args: unknown[]) => unknown;
};
let peers: BindDeferredUiEhPeers | null = null;

/** Wire bindDeferredUiEh peers once companions land. */
 ...
 */
export function bindDeferredUiEh() {
  if (peers == null) {
