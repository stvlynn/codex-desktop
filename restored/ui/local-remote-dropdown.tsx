...
export function setBindLocalRemoteDropdownPeers(
  next: BindLocalRemoteDropdownPeers,
): void {
  peers = next;
}
        ...
        (
          ...
          for (let {
            ...
            let l = peers.bAr({
                ...
                destinationWorkspaceRoots: peers.c.map(
                  (e) => peers.e.remotePath,
                ),
                destinationGitOrigins: o?.data?.origins,
              }),
              u = peers.c.find(({ remotePath: e }) => peers.e === l);
            u != null &&
              s.push({
                status: `ready`,
                hostDisplayName: peers.e,
