...
// Materialized via extractFn(internal `Oas`) / export `YS`.

export type CreateSvgIconGlyph21Peers = {
  Das: (...args: unknown[]) => unknown;
  Eas: (...args: unknown[]) => unknown;
...
/** Wire createSvgIconGlyph21 peers once companions land. */
 ...
 */
export function createSvgIconGlyph21() {
  if (peers == null) {
