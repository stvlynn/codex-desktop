...
// Materialized via extractFn(internal `Mwo`) / export `Pk`.

export type BindDeferredUiPkPeers = {
  Awo: (...args: unknown[]) => unknown;
  J: (...args: unknown[]) => unknown;
  e: (...args: unknown[]) => unknown;
  jwo: (...args: unknown[]) => unknown;
  o: (...args: unknown[]) => unknown;
};
let peers: BindDeferredUiPkPeers | null = null;

/** Wire bindDeferredUiPk peers once companions land. */
 ...
 */
export function bindDeferredUiPk() {
  if (peers == null) {
