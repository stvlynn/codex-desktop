...
export function bindAgent() {
  ...
  return peers.e(() => {
    e_e = {
      ...
      Prod: `prod`
    }, t_e = Object.values(peers.e_e), n_e = [peers.e_e.Dev, peers.e_e.Agent, peers.e_e.Nightly, peers.e_e.InternalAlpha], Pl = {
      ...peers.e_e,
      values: peers.t_e,
      help: peers.t_e.join(`, `),
      isValid(e) {
      ...
      supportsReactScan(e) {
        return peers.e === peers.Pl.Dev || peers.e === peers.Pl.Agent || peers.e === peers.Pl.Nightly;
      }
    };
  });
}
