...
// Materialized via extractFn(internal `Q1l`) / export `mi`.

export type BindDeferredUiMiPeers = {
  J: (...args: unknown[]) => unknown;
  X1l: (...args: unknown[]) => unknown;
  Z1l: (...args: unknown[]) => unknown;
  e: (...args: unknown[]) => unknown;
  o: (...args: unknown[]) => unknown;
};
let peers: BindDeferredUiMiPeers | null = null;

/** Wire bindDeferredUiMi peers once companions land. */
 ...
 */
export function bindDeferredUiMi() {
  if (peers == null) {
