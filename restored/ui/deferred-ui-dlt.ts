...
export function bindDeferredUiDlt() {
  ...
  return peers.i(e => {
    var t = e && e.__createBinding || (Object.create ? function (e, t, n, r) {
        ...
        (!peers.i || (`get` in peers.i ? !t.__esModule : peers.i.writable || peers.i.configurable)) && (i = {
          enumerable: !0,
          get: function () {
            return t[n];
          }
    ...
    Object.defineProperty(e, "useStatsigUser", {
    ...
    }), n(peers.int(), e), Object.assign((0, r._getStatsigGlobal)(), {
      ...
      useStatsigInternalClientFactoryAsync: h.useStatsigInternalClientFactoryAsync,
      useStatsigInternalClientFactoryBootstrap: g.useStatsigInternalClientFactoryBootstrap,
