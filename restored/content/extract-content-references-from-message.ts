...
export function setMessageContentReferencesParser(parser: MessageContentRefsParser): void {
  parseMessageContentRefs = parser;
}

export function extractContentReferencesFromMessage(message: unknown): Record<string, unknown>[] {
