...
// Embedded mermaid package.json metadata (name/version/exports) used by diagram loaders.

export type MermaidPackageJson = {
  name: string;
  version: string;
  description: string;
  type: string;
...
/** Mermaid npm package.json snapshot bundled into the webview (export `n`). */
export const mermaidPackageJson: MermaidPackageJson = {
  name: "mermaid",
  version: "11.12.0",
  description:
...
} as MermaidPackageJson;

/** No-op lazy init matching the Rolldown `esmInit` wrapper (export `t`). */
export function initMermaidPackageJson(): void {}
