...
export function setBindApplyFooterUoylu22Peers(next: BindApplyFooterUoylu22Peers): void {
  peers = next;
}
...
export function bindApplyFooterUoylu22() {
  ...
  return peers.e(() => {
    det = `_footer_uoylu_2`, fet = `_homeUtilityBar_uoylu_2`, pet = `_utilityBarLabel_uoylu_2`, met = `_dropdownLabelCategory_uoylu_2`, het = `_dropdownLabelValue_uoylu_2`, get = `_dropdownLabelValueContent_uoylu_2`, _et = `_dropdownLabelValueOverflowing_uoylu_2`, vet = `_dropdownLabelText_uoylu_2`, yet = `_dropdownLabelTextWithCategory_uoylu_2`, bet = `_dropdownLabelChevron_uoylu_2`, xet = `_defaultUtilityBarOnly_uoylu_2`, Cet = `_runLocationEnvironmentSuffix_uoylu_2`, wet = `_homeUtilityBarOnly_uoylu_2`, Tet = `_projectClearAvailable_uoylu_2`, Eet = `_projectClearButton_uoylu_2`, Det = `_labelSm_uoylu_2`, Oet = `_labelXs_uoylu_2`, ket = `_secondaryLabel_uoylu_2`, Aet = `_secondaryChevron_uoylu_2`, gh = {
      footer: peers.det,
