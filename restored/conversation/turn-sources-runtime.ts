...
//
// MCP tool invocation + persisted AppScope signal helpers + turn-source
// connectors used by conversation/turn-sources-model and debug-state modules.
...
/** resolves a connector "app" descriptor from a URL. */
...
/** parses MCP `_meta` resource-activity annotations. */
...
/** extracts a display title from structured content. */
...
/** normalizes a Codex-apps MCP tool call result. */
...
/** reduced-motion preference for turn-source visuals. */
