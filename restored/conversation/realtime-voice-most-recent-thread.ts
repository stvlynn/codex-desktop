...
// Stage-3 fill for bundle export m4 / UE
...
/** Wire bindRealtimeVoiceMostRecentThread once companions land. */
 ...
 * Stage-3 fill for bundle export m4 / UE
 */
export function bindRealtimeVoiceMostRecentThread(...args: unknown[]): unknown {
  if (peers == null) {
    throw new Error(
