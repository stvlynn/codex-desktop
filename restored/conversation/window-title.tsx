...
export function setBindBindWindowTitlePeers(
  next: BindBindWindowTitlePeers,
): void {
  peers = next;
}
...
export function bindBindWindowTitle() {
  ...
  return peers.e(() => {
    ((S_t = `Please continue this conversation on the window where it was started.`),
      (Gg = 3e4),
      (C_t = 2e3),
      (w_t = 5e3),
      (T_t = 12e5),
