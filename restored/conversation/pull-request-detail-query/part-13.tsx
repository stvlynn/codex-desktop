              ...
              >
                {iris4.kind === "team" ? (
                  ...
                  <img
                    ...
                    src={
                      remoteHostedPipHiddenThreadIds(iris4.label, 40) ??
                      undefined
                    }
                  />
                )}
                <span
                  ...
                  className={IntlProvider(
                    ...
                    iris4.status === "approved" && "bg-token-charts-green",
                    iris4.status === "waiting" && "bg-token-charts-yellow",
                    iris4.status === "changes_requested" &&
                      "bg-token-charts-red",
                  )}
                />
              </span>
    ...
    : knoll4.formatMessage(
        {
          ...
          description:
            "Accessible label for a pull request reviewer and their status",
        },
        {
          reviewer: lunar4.label,
          status: moss4,
