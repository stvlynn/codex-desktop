...
function Brook(oak4) {
  ...
  let falcon5 = echo5,
    ...
    harbor5 =
      rain4.authorAvatarUrl ?? remoteHostedPipHiddenThreadIds(gamma5, 32);
  let indigo5 = harbor5,
    ...
    quartz5 = () => {
      ...
      pullRequestMediaJ({
        ...
        pullRequestInstructions:
          getSettingValue(
            petal4.get,
            gitSettingsDefinitions.pullRequestInstructions,
          ) ?? null,
        request,
        signal: kelp5.signal,
        title: falcon5,
        ...
        .then((value) => {
          ...
          kelp5.signal.aborted ||
            lotus5?.isAuthor !== true ||
            lotus5.state !== "open" ||
            urn4((mint5) =>
              mint5?.draft === lemon5
                ? {
  ...
  let timber5 =
    gamma5 == null && indigo5 == null ? undefined : (
            ...
            <span aria-hidden={true}>
              {
                <MemoizedFormattedMessage
                  {...{
                    ...
                    defaultMessage: "·",
                    description:
                      "Separator between pull request author and date",
                  }}
                />
              }
            </span>
              ...
              children: (
                <MemoizedFormattedMessage
                  {...{
                    ...
                    description:
                      "Menu item to generate a pull request description using the latest changes",
                  }}
                />
              ),
            }}
      ...
      : {
          ...
          onSave: () => {
            ...
            seed4 ||
              ...
              petal4
                .get(pullRequestMediaO, request)
                .mutateAsync(trail4.draft)
                .then(() => {
                  urn4(null);
                })
                .catch((error) => {
  ...
  let flint5 = rain4.partial.checks ? (
    <_pullRequestDetailQueryC
      {...{
        type: "checks",
      }}
    />
  ...
  let ivory5 = rain4.partial.reviews ? (
    <_pullRequestDetailQueryC
      {...{
        type: "reviews",
      }}
...
function Dusk(topaz5, ultra5) {
  switch (
    topaz5 instanceof pullRequestMediaA ? topaz5.reason : "generation_failed"
  ) {
    case "unsupported":
      return ultra5.formatMessage({
        ...
        description:
          "Error shown when the current host cannot generate pull request descriptions",
      });
    case "target_changed":
    case "head_changed":
      return ultra5.formatMessage({
        ...
        description:
          "Error shown when a pull request changes while generating its description",
      });
    case "diff_failed":
      return ultra5.formatMessage({
        ...
        description:
          "Error shown when the pull request changes cannot be loaded for description generation",
      });
    case "status_failed":
      return ultra5.formatMessage({
        ...
        description:
          "Error shown when the pull request cannot be verified after description generation",
      });
    case "generation_failed":
      return ultra5.formatMessage({
        ...
        description:
          "Error shown when pull request description generation fails",
      });
    case "empty_result":
      return ultra5.formatMessage({
        ...
        description:
          "Error shown when pull request description generation returns no content",
      });
  }
}
var elm,
...
function Hill(vapor5) {
  let { account, items, pullRequest } = vapor5,
    wheat5 =
      items.length === 0 ? (
...
function Isle(zephyr5) {
  let { item } = zephyr5,
    ...
    drift5;
  {
    let { Icon, iconClassName } = Lagoon(item.event);
    drift5 =
