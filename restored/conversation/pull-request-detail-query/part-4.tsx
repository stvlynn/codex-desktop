...
function Indigo(hill1) {
  let { account, detail, placement } = hill1,
  ...
  let yarrow1 =
      ...
      detail.state === "open" &&
      !detail.isDraft &&
      detail.isAutoMergeEnabled !== true &&
      !nest1,
    azure1;
  if (
    ((azure1 = {
    ...
    ContextMenuRegistration("git.mergePullRequest", wind1, azure1),
    !detail.isAuthor || detail.state !== "open")
  )
    return null;
    ...
    if (
      ((ember2 = async function (event) {
        if ((event.preventDefault(), !(oak1 == null || nest1))) {
          ...
          try {
            ...
            let ivory2 = hazel2;
            vine1(
              ivory2 instanceof Error
                ? ivory2.message
                : juniper1.formatMessage({
                  ...
                  title: (
                    <MemoizedFormattedMessage
                      {...{
                        ...
                        defaultMessage: "Merge pull request",
                        description:
                          "Title for the pull request merge confirmation",
                      }}
                    />
                  ),
                  subtitle: (
      ...
      let tide2 = (
        <DeferredUiU
          {...{
            children: (
              <SetRemoteControlEnabledForHostStub
                {...{
...
function Jade(cliff2) {
  let { disabled, isDraft, onUpdate } = cliff2,
