...
export function PullRequestDetailQueryI(meadow4: unknown) {
  let {
      actions,
      checks,
      comments,
    ...
    nest4 = <div className={`${ensureDetailPageInit} select-text`}>{description}{checks}{conflicts}{comments}</div>;
  return <div className="@container h-full min-h-0 overflow-y-auto bg-token-main-surface-primary select-none"><main className="px-5 pb-4">{<DetailPageSection {...{
        children: [header, overview, actions, nest4]
      }} />}</main></div>;
}
