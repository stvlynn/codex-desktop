...
export function PullRequestDetailQueryI(meadow4: unknown) {
  let { actions, checks, comments, conflicts, description, header, overview } =
      meadow4,
    nest4 = (
      <div className={`${ensureDetailPageInit} select-text`}>
        {description}
        {checks}
        {conflicts}
        {comments}
  ...
  return (
    <div className="@container h-full min-h-0 overflow-y-auto bg-token-main-surface-primary select-none">
