...
function Moss(north4) {
  let { children, className, tone, ...rest } = north4;
  let orbit4 =
      (tone === undefined ? "secondary" : tone) === "danger"
...
export function PullRequestDetailQueryL(unity4: unknown) {
  let { account, actions, body, editing, error, loading } = unity4,
    vale4 = useIntl(),
  ...
  let brook4 =
    editing == null ? (
              ...
              label: (
                <MemoizedFormattedMessage
                  {...{
                    ...
                    description:
                      "Loading label for the pull request description",
                  }}
                />
              ),
            }}
      ...
      <form
        aria-busy={editing.isPending || editing.isGenerating}
      ...
      >
        <textarea
          autoFocus={true}
          aria-label={vale4.formatMessage({
            id: "pullRequestDetail.editDescription.label",
            defaultMessage: "Pull request description",
            description:
              "Accessible label for the pull request description input",
          })}
          ...
          disabled={editing.isPending || editing.isGenerating}
          value={editing.draft}
          onChange={(event) => {
