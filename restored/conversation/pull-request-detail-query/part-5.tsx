...
var lemon,
  ...
  quartz = esmInit(() => {
    ...
    ensureAppScopeInit();
    AppInitialAp();
    pearl = clearActiveOverlayAfterNavigate(
      appScopeAtom,
      (quiet2, { get }) =>
        get(AppInitialJp, {
          request: quiet2,
...
function River(rain2) {
  let { items, labelTone = "tertiary", wrapLabels = false } = rain2,
    ...
    trail2;
  {
    ...
    urn2 = (vine2) => {
      let wind2 = (
                      ...
                      <OptionalTooltip
                        {...{
                          ...
                          children: (
                            <span
                              className={
                                wrapLabels ? "wrap-anywhere" : "truncate"
                              }
                            >
                              {vine2.label}
                            </span>
        ...
        yarrow2 =
          vine2.trailing == null ? null : (
            <PopoverMenu.ItemMeta
              {...{
                visibility:
                  vine2.trailingVisible === false ? "interaction" : "always",
                onClick: vine2.action == null ? undefined : vine2.onClick,
                children: vine2.trailing,
              }}
            />
          );
      return vine2.action == null ? (
        vine2.onClick == null ? (
          <PopoverMenu.Item
            key={vine2.id}
            {...{
...
export function PullRequestDetailQueryT(azure2: unknown) {
    ...
    birch2;
  {
    ...
    dew2 = (alpha3, bravo3) => {
      ...
      return {
        action:
          alpha3.status === "failing" && echo3 != null ? (
            <EnsureToolbarCircleDashedButtonInit
              {...{
                ...
                children: delta3 ? (
                  <MemoizedFormattedMessage
                    {...{
                      ...
                      description:
                        "Per-check action label for removing a failing pull request check from the task",
                    }}
                  />
                ) : (
                  <MemoizedFormattedMessage
        ...
        label: (
          <span className="inline-flex max-w-full min-w-0 items-center gap-1.5">
            <span className={wrapLabels ? "wrap-anywhere" : "truncate"}>
              {alpha3.name}
            </span>
            {copper3 == null ? null : (
              <HostFeatureConfigToggles
                {...{
                  className:
                    "icon-xs shrink-0 opacity-0 group-focus-within/summary-panel-item:opacity-100 group-hover/summary-panel-item:opacity-100",
                  href: copper3,
                }}
              />
            )}
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Status label for a pull request check with unknown status",
          }}
        />
      );
  }
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Tooltip shown for an individual failed pull request check",
          }}
        />
      );
    }
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Tooltip shown for an individual pending pull request check",
          }}
        />
      );
    }
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Tooltip shown for an individual skipped pull request check",
          }}
        />
      );
    }
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Tooltip shown for an individual neutral pull request check",
          }}
        />
      );
    }
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Tooltip shown for an individual passed pull request check",
          }}
        />
      );
    }
      ...
      return (
        <MemoizedFormattedMessage
          {...{
            ...
            description:
              "Tooltip shown for an individual pull request check with unknown status",
          }}
        />
      );
    }
