...
// Xu message catalog for automatic-approval review summaries (bundle `_$` / init `LUs`).
// Note: export `wft` is `cx` (`$`), not this catalog — IMPORT_MAP corrected in Phase C Wave O.

export const automaticApprovalReviewActionSummaryMessages = {
...
export type AutomaticApprovalReviewActionSummaryMessages =
  typeof automaticApprovalReviewActionSummaryMessages;
