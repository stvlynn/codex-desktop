...
export function setOpenThreadBrowserSidePanelTabPeers(
  next: OpenThreadBrowserSidePanelTabPeers,
): void {
  peers = next;
}
 ...
 */
export function openThreadBrowserSidePanelTab(
  e: unknown,
  t: unknown = !0,
  n: unknown = {},
  r: unknown = `right`,
  ...
  n.browserTransferSourceConversationId != null &&
    peers.Rj.reassociateTabState(
      n.browserTransferSourceConversationId,
      n.browserTransferSourceBrowserTabId ??
        peers.xT(n.browserTransferSourceConversationId),
      a,
      o,
      {
        removeSourceBrowserStateWhenEmpty: peers.qJn(
          e,
          n.browserTransferSourceConversationId,
        ),
      },
  ...
  let l = e.get(peers.LE).formatMessage({
    ...
    h =
      p?.icon ??
      (0, peers.d1o.createElement)(peers.VCo, {
    ...
    f.openTab(e, peers.R$o, {
      ...
      trailingContent:
        d.isCapturingUserMedia || d.isAudible
          ? (0, peers.d1o.createElement)(peers.$Co, {
      ...
      onClose: () => {
        ...
        (peers.yYn(e, a, o),
          e.get(peers.lT) || peers.Rj.removeTab(a, o),
