...
/** Wire bindDeferredAppsept peers once companions land. */
 ...
 */
export function bindDeferredAppsept(e: unknown, t: unknown) {
  if (peers == null) {
  ...
  var n = {
    ...
    a,
    o = Object.create(
      (typeof peers.Iterator == `function` ? peers.Iterator : Object).prototype,
    );
  return (
    (o.next = peers.s(0)),
    (o.throw = peers.s(1)),
          ...
          i &&
            (a =
              peers.s[0] & 2
                ? i.return
                : peers.s[0]
                  ? i.throw || ((a = i.return) && peers.a.call(i), 0)
                  : i.next) &&
            !(a = peers.a.call(i, peers.s[1])).done)
        )
          return peers.a;
        switch (
          ((i = 0),
          peers.a && (s = [peers.s[0] & 2, peers.a.value]),
          peers.s[0])
        ) {
          case 0:
          case 1:
          ...
          default:
            if (
              ((a = n.trys),
              !(a = peers.a.length > 0 && peers.a[peers.a.length - 1])) &&
              (peers.s[0] === 6 || peers.s[0] === 2)
            ) {
              n = 0;
              continue;
            }
            if (
              peers.s[0] === 3 &&
              (!peers.a || (peers.s[1] > peers.a[0] && peers.s[1] < peers.a[3]))
            ) {
              n.label = peers.s[1];
              break;
            }
