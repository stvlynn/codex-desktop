...
export function bindPublicationTermsBanner(impl: ComponentType<PublicationTermsBannerProps>): void {
  BannerImpl = impl;
}
 ...
 */
export function PublicationTermsBanner(props: PublicationTermsBannerProps): ReactNode {
