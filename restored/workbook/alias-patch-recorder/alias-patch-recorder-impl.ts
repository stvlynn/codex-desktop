...
export const Xht = esmInit(() => {
  ...
  Jht = (aprIn9516) => {
    ...
    return (workbookBinding1963.set(aprIn9516, aprBind20028), aprBind20028);
  };
  Yht = class {
    #e = [];
    #t;
    ...
    getPatch() {
      ...
      for (let aprBind22369 of aprBind14192) {
        ...
        aprBind22633 && aprBind14191.push(aprBind22633);
      }
      for (let aprBind22098 of aprBind14193.values()) {
        let aprBind22634 = aprBind22098();
        aprBind22634 && aprBind14191.push(aprBind22634);
      }
    ...
    assignAlias(aprIn9332, aprIn9333, aprIn9334) {
      let aprBind19890 = this.#t.get(aprIn9332),
        aprBind19891 = aprBind19890 ?? this.#o(aprIn9334);
      return (
        aprBind19890 || this.#t.set(aprIn9332, aprBind19891),
