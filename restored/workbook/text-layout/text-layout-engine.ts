  ...
  layoutParagraph({
    ...
    let workbookBinding2138 = [],
      ...
      _e = () =>
        Math.max(
          1,
          effectiveBoxW - workbookBinding2147() - workbookBinding2123,
        ),
    ...
    for (
      ...
      let workbookBinding2358 = resolveCssFontStack(
        ...
        workbookBinding2362 = this.fontMetrics.getMetricsForSize(
          workbookBinding2359,
          workbookBinding2355,
        ),
      ...
      if (workbookBinding2126 && !workbookBinding2144) {
        let workbookBinding4003 = workbookBinding2125
          ...
          workbookBinding4005 = this.measureCache.buildAdvance(
            workbookBinding2361,
            workbookBinding2360,
            workbookBinding2355,
            workbookBinding4003,
          ...
          workbookBinding4006 = this.measureCache.measureInkBounds(
            workbookBinding2360,
            workbookBinding4003,
          ),
      ...
      for (let workbookBinding2835 of workbookBinding2372) {
        ...
        let workbookBinding2837 = this.measureCache.buildAdvance(
            workbookBinding2361,
            workbookBinding2360,
            workbookBinding2355,
          ...
          workbookBinding2838 = (textIn530, textIn531) => {
            ...
            let workbookBinding4370 =
              ...
              workbookBinding4373 = this.measureCache.measureInkBounds(
                workbookBinding2360,
                workbookBinding4370,
              ),
            ...
            return (
              workbookBinding2145
                ? (workbookBinding2145.segments.push(workbookBinding4376),
                  ...
                  (workbookBinding2145.referenceSegment ||=
                    workbookBinding4376))
    ...
    if (workbookBinding2138.length === 0) {
      ...
      let workbookBinding5639 = resolveCssFontStack(
        ...
        workbookBinding5644 = this.fontMetrics.getMetricsForSize(
          workbookBinding5640,
          workbookBinding5641,
        );
      workbookBinding2138.push({
