...
import { patternTilePainters, ensurePatternTilePaintersInit } from "./pattern-tile-painters";
...
function devicePixelRatioOrOne() {
  ...
  return typeof fillBind20947 == "number" && Number.isFinite(fillBind20947) && fillBind20947 > 0 ? fillBind20947 : 1;
}
function patternTileCacheKey(resIn13216, resIn13217, resIn13218, resIn13219, resIn13220) {
...
function createOffscreenPatternTile(resIn9339, resIn9340) {
  if (typeof OffscreenCanvas < "u") return new OffscreenCanvas(resIn9339, resIn9340);
  throw Error("OffscreenCanvas API not available for pattern tiles.");
}
function paintPatternTileCanvas(resIn8504, resIn8505, resIn8506, resIn8507, resIn8508) {
...
export function resolvePatternFillStyle(resIn481: unknown, resIn482: unknown, resIn483: unknown, resIn484: unknown, resIn485: unknown) {
  let fillBind4111 = resIn485?.dpr ?? devicePixelRatioOrOne(),
    fillBind4112 = typeof resIn481.getTransform == "function" ? resIn481.getTransform() : null,
    fillBind4113 = fillBind4112 ? Math.hypot(fillBind4112.a, fillBind4112.b) : 1,
    fillBind4114 = fillBind4112 ? Math.hypot(fillBind4112.c, fillBind4112.d) : 1,
    fillBind4115 = fillBind4111 * Math.max(1, Math.min(8, Math.ceil(Math.max(fillBind4113, fillBind4114)))),
    fillBind4116 = resolveColorToCssRgba(resIn483.color, resIn484, {
      colorSpace: resIn485?.colorSpace,
      defaultFill: "#ffffff"
    }),
    fillBind4117 = resolveColorToCssRgba(patternForegroundColorOf(resIn483.pattern), resIn484, {
      colorSpace: resIn485?.colorSpace,
  ...
  if (fillBind4118 === patternTypeEnum.PATTERN_TYPE_SOLID || fillBind4118 === patternTypeEnum.PATTERN_TYPE_UNSPECIFIED) return fillBind4117;
  let fillBind4119 = patternTypePainterConfig[fillBind4118] ?? {
      id: "grid",
      scale: 1,
      extraAngle: 0
    },
    fillBind4120 = fillBind4118 === patternTypeEnum.PATTERN_TYPE_DOWNWARD_DIAGONAL || fillBind4118 === patternTypeEnum.PATTERN_TYPE_UPWARD_DIAGONAL || fillBind4118 === patternTypeEnum.PATTERN_TYPE_WIDE_DOWNWARD_DIAGONAL || fillBind4118 === patternTypeEnum.PATTERN_TYPE_WIDE_UPWARD_DIAGONAL || fillBind4118 === patternTypeEnum.PATTERN_TYPE_DASHED_DOWNWARD_DIAGONAL || fillBind4118 === patternTypeEnum.PATTERN_TYPE_DASHED_UPWARD_DIAGONAL || fillBind4118 === patternTypeEnum.PATTERN_TYPE_DIAGONAL_CROSS || fillBind4118 === patternTypeEnum.PATTERN_TYPE_DARK_DOWN || fillBind4118 === patternTypeEnum.PATTERN_TYPE_DARK_UP || fillBind4118 === patternTypeEnum.PATTERN_TYPE_LIGHT_DOWN || fillBind4118 === patternTypeEnum.PATTERN_TYPE_LIGHT_UP ? 3 : 4,
    fillBind4121 = Math.max(fillBind4120, Math.round(6 * (resIn485?.scale ?? fillBind4119.scale ?? 1))),
    fillBind4122 = fillBind4121 * fillBind4115,
    fillBind4123 = fillBind4119.id ?? "grid",
    fillBind4124 = patternTileCacheKey(fillBind4123, fillBind4117, fillBind4116, fillBind4121, fillBind4115),
    fillBind4125 = patternTileCache.get(fillBind4124);
  fillBind4125 || (fillBind4125 = paintPatternTileCanvas(fillBind4123, fillBind4117, fillBind4116, fillBind4122, fillBind4115), patternTileCache.set(fillBind4124, fillBind4125));
  let fillBind4126 = (resIn485?.angleDeg ?? 0) + (fillBind4119.extraAngle ?? 0),
    fillBind4127 = resIn485?.anchor ?? "object",
    fillBind4128 = resIn485?.anchorX ?? (fillBind4127 === "object" ? resIn482.x + resIn482.width / 2 : 0),
    fillBind4129 = resIn485?.anchorY ?? (fillBind4127 === "object" ? resIn482.y + resIn482.height / 2 : 0),
  ...
  if (typeof fillBind4130.setTransform == "function") {
    let fillBind16542 = fillBind4125.width / fillBind4115,
      ...
      fillBind16544 = ((fillBind4128 - fillBind16542 / 2) % fillBind16542 + fillBind16542) % fillBind16542,
      fillBind16545 = ((fillBind4129 - fillBind16543 / 2) % fillBind16543 + fillBind16543) % fillBind16543,
      fillBind16546 = fillBind4126,
      fillBind16547 = new DOMMatrix().translate(fillBind16544, fillBind16545).rotate(fillBind16546).scale(1 / fillBind4115, 1 / fillBind4115);
  ...
  let fillBind4131 = fillBind4125.width / fillBind4115,
    ...
    fillBind4133 = ((fillBind4128 - fillBind4131 / 2) % fillBind4131 + fillBind4131) % fillBind4131,
    fillBind4134 = ((fillBind4129 - fillBind4132 / 2) % fillBind4132 + fillBind4132) % fillBind4132,
    fillBind4135 = fillBind4125.width,
    fillBind4136 = fillBind4125.height,
    fillBind4137 = createOffscreenPatternTile(fillBind4135 * 8, fillBind4136 * 8),
  ...
  return fillBind4138.translate(fillBind4137.width / 2, fillBind4137.height / 2), fillBind4138.rotate(fillBind4126 * Math.PI / 180), fillBind4138.translate(-(fillBind4137.width / 2 - fillBind4140), -(fillBind4137.height / 2 - fillBind4141)), fillBind4138.fillStyle = fillBind4139, fillBind4138.fillRect(-fillBind4135, -fillBind4136, fillBind4137.width + 2 * fillBind4135, fillBind4137.height + 2 * fillBind4136), fillBind4138.restore(), resIn481.createPattern(fillBind4137, "repeat");
}
let patternTypePainterConfig: Record<number | string, { id?: string; scale?: number; extraAngle?: number }>;
