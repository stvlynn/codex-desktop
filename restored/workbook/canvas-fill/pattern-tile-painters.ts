...
function strokeDiagonalHatch(patIn4065, patIn4066, patIn4067, patIn4068, patIn4069) {
  ...
  patIn4069?.dashed && patIn4065.setLineDash([patIn4067 * 0.6, patIn4067 * 0.6]);
  patIn4065.beginPath();
...
export let patternTilePainters: Record<string, ((...args: unknown[]) => void) | undefined>;
export const ensurePatternTilePaintersInit = esmInit(() => {
    scaledStrokeWidth = (patIn15936, patIn15937) => Math.max(1, patIn15937 * patIn15936);
    halfScaledStrokeWidth = (patIn16255, patIn16256) => scaledStrokeWidth(patIn16255, patIn16256) / 2;
    paintHorizontalPattern = (patIn8868, patIn8869, patIn8870, patIn8871, patIn8872) => {
      ...
      patIn8868.fillRect(0, patIn8871 - fillBind19418 / 2, 2 * patIn8871, fillBind19418);
    };
    paintVerticalPattern = (patIn8873, patIn8874, patIn8875, patIn8876, patIn8877) => {
      ...
      patIn8873.fillRect(patIn8876 - fillBind19419 / 2, 0, fillBind19419, 2 * patIn8876);
    };
    paintCrossPattern = (patIn11829, patIn11830, patIn11831, patIn11832, patIn11833) => {
      paintHorizontalPattern(patIn11829, patIn11830, patIn11831, patIn11832, patIn11833);
      paintVerticalPattern(patIn11829, patIn11830, "rgba(0,0,0,0)", patIn11832, patIn11833);
    };
    paintDiagonalPattern = (patIn13211, patIn13212, patIn13213, patIn13214, patIn13215) => {
      fillSolidTileBackground(patIn13211, patIn13213, patIn13214);
      strokeDiagonalHatch(patIn13211, patIn13212, patIn13214, patIn13215);
    };
    paintDashedDiagonalPattern = (patIn12234, patIn12235, patIn12236, patIn12237, patIn12238) => {
      fillSolidTileBackground(patIn12234, patIn12236, patIn12237);
      strokeDiagonalHatch(patIn12234, patIn12235, patIn12237, patIn12238, {
        dashed: true
      });
    };
    paintDiagonalCrossPattern = (patIn7693, patIn7694, patIn7695, patIn7696, patIn7697) => {
    ...
    paintGridPattern = (patIn7490, patIn7491, patIn7492, patIn7493, patIn7494) => {
      ...
      patIn7490.fillRect(0, patIn7493 - fillBind17980 / 2, 2 * patIn7493, fillBind17980);
      patIn7490.fillRect(patIn7493 - fillBind17980 / 2, 0, fillBind17980, 2 * patIn7493);
    };
    paintDotsPattern = (patIn5414, patIn5415, patIn5416, patIn5417, patIn5418) => {
      ...
      patIn5414.beginPath();
      patIn5414.arc(0.5 * patIn5417, 0.5 * patIn5417, fillBind15171, 0, Math.PI * 2);
      patIn5414.fill();
      patIn5414.beginPath();
      patIn5414.arc(1.5 * patIn5417, 1.5 * patIn5417, fillBind15171, 0, Math.PI * 2);
      patIn5414.fill();
    };
    paintCheckPattern = (patIn7495, patIn7496, patIn7497, patIn7498, patIn7499) => {
      ...
      patIn7495.fillRect(0, 0, patIn7498 - fillBind17981, patIn7498 - fillBind17981);
      patIn7495.fillRect(patIn7498 + fillBind17981, patIn7498 + fillBind17981, patIn7498 - fillBind17981, patIn7498 - fillBind17981);
    };
    paintTrellisPattern = (patIn4902, patIn4903, patIn4904, patIn4905, patIn4906) => {
    ...
    paintHorizontalDashedPattern = (patIn4244, patIn4245, patIn4246, patIn4247, patIn4248) => {
    ...
    paintVerticalDashedPattern = (patIn4249, patIn4250, patIn4251, patIn4252, patIn4253) => {
    ...
    paintPlaidPattern = (patIn7500, patIn7501, patIn7502, patIn7503, patIn7504) => {
      ...
      patIn7500.fillRect(0, patIn7503 - fillBind17982 / 2, 2 * patIn7503, fillBind17982);
      patIn7500.fillRect(patIn7503 - fillBind17982 / 2, 0, fillBind17982, 2 * patIn7503);
    };
    paintHorizontalBrickPattern = (patIn2293, patIn2294, patIn2295, patIn2296, patIn2297) => {
    ...
    paintDiagonalBrickPattern = (patIn2637, patIn2638, patIn2639, patIn2640, patIn2641) => {
    ...
    paintOpenDiamondPattern = (patIn3088, patIn3089, patIn3090, patIn3091, patIn3092) => {
    ...
    paintDottedDiamondPattern = (patIn4995, patIn4996, patIn4997, patIn4998, patIn4999) => {
      ...
      let fillBind14413 = Math.max(1, 0.65 * patIn4999),
        fillBind14414 = [[patIn4998, 0.5 * patIn4998], [0.5 * patIn4998, patIn4998], [patIn4998, 1.5 * patIn4998], [1.5 * patIn4998, patIn4998]];
      for (let [fillBind22136, fillBind22137] of fillBind14414) {
        patIn4995.beginPath();
        patIn4995.arc(fillBind22136, fillBind22137, fillBind14413, 0, Math.PI * 2);
        patIn4995.fill();
      }
    };
    paintConfettiSmallPattern = (patIn4415, patIn4416, patIn4417, patIn4418) => {
      ...
      let fillBind13638 = Math.max(1, Math.round(patIn4418 / 6 * 0.5)),
        fillBind13639 = [[0.3 * patIn4418, 0.4 * patIn4418], [1.2 * patIn4418, 0.6 * patIn4418], [0.8 * patIn4418, 1.3 * patIn4418], [1.6 * patIn4418, 1.7 * patIn4418]];
      for (let [fillBind21991, fillBind21992] of fillBind13639) patIn4415.fillRect(Math.round(fillBind21991) - fillBind13638, Math.round(fillBind21992) - fillBind13638, 2 * fillBind13638, 2 * fillBind13638);
    };
    paintConfettiLargePattern = (patIn4419, patIn4420, patIn4421, patIn4422) => {
      ...
      let fillBind13640 = Math.max(1, Math.round(patIn4422 / 6 * 0.9)),
        fillBind13641 = [[0.4 * patIn4422, 0.5 * patIn4422], [1.3 * patIn4422, 0.8 * patIn4422], [0.6 * patIn4422, 1.5 * patIn4422], [1.7 * patIn4422, 1.2 * patIn4422]];
      for (let [fillBind21993, fillBind21994] of fillBind13641) patIn4419.fillRect(Math.round(fillBind21993) - fillBind13640, Math.round(fillBind21994) - fillBind13640, 2 * fillBind13640, 2 * fillBind13640);
    };
    paintSpherePattern = (patIn4575, patIn4576, patIn4577, patIn4578) => {
      ...
      let fillBind13850 = Math.max(1, Math.round(0.25 * patIn4578)),
        fillBind13851 = [[0.5 * patIn4578, 0.5 * patIn4578], [1.5 * patIn4578, 0.5 * patIn4578], [0.5 * patIn4578, 1.5 * patIn4578], [1.5 * patIn4578, 1.5 * patIn4578]];
      for (let [fillBind22138, fillBind22139] of fillBind13851) {
        patIn4575.beginPath();
        patIn4575.arc(fillBind22138, fillBind22139, fillBind13850, 0, Math.PI * 2);
        patIn4575.fill();
      }
    };
    paintWeavePattern = (patIn7024, patIn7025, patIn7026, patIn7027) => {
      ...
      patIn7024.fillRect(0, patIn7027 - fillBind17381 / 2, 2 * patIn7027, fillBind17381);
      patIn7024.fillRect(patIn7027 - fillBind17381 / 2, 0, fillBind17381, 2 * patIn7027);
    };
    paintDivotPattern = (patIn3674, patIn3675, patIn3676, patIn3677, patIn3678) => {
      ...
      let fillBind12296 = Math.max(1, Math.round(0.3 * patIn3677)),
        fillBind12297 = [[0.5 * patIn3677, 0.5 * patIn3677], [1.5 * patIn3677, 1.5 * patIn3677]];
      for (let [fillBind22072, fillBind22073] of fillBind12297) {
        patIn3674.beginPath();
        patIn3674.arc(fillBind22072, fillBind22073, fillBind12296, 0, Math.PI * 2);
        patIn3674.stroke();
      }
    };
    paintShinglePattern = (patIn3999, patIn4000, patIn4001, patIn4002, patIn4003) => {
    ...
    paintWavePattern = (patIn4640, patIn4641, patIn4642, patIn4643, patIn4644) => {
      ...
      patIn4640.bezierCurveTo(0.5 * patIn4643, 0.5 * patIn4643, 1.5 * patIn4643, 1.5 * patIn4643, 2 * patIn4643, patIn4643);
      patIn4640.stroke();
    };
    paintZigZagPattern = (patIn3966, patIn3967, patIn3968, patIn3969, patIn3970) => {
