      ...
      Mgt = class {
        ...
        constructor(wstIn1710) {
          ...
          this.#c = (wstIn11658, wstIn11659) => {
            wstIn11658.keysChanged.size !== 0 &&
              (this.#d(wstIn11659) || this.#u());
          };
          ...
          for (let wstBind22039 of wstBind11101?.toArray() ?? [])
            wstBind11103.has(wstBind22039) ||
              (wstBind11100.has(wstBind22039) &&
                (wstBind11103.add(wstBind22039),
                wstBind11102.push(wstBind22039)));
          for (let wstBind22784 of wstBind11100.keys())
            wstBind11103.has(wstBind22784) ||
              (wstBind11103.add(wstBind22784),
              wstBind11102.push(wstBind22784));
          let wstBind11104 = [];
          for (let wstBind18818 of wstBind11102) {
            let wstBind19362 =
              wstBind11100.get(wstBind18818);
        ...
        replaceEntries(wstIn3550) {
          ...
          let wstBind12026 = jgt(wstIn3550),
            wstBind12027 = new Set(
              wstBind12026.map((item) => item.sheetId),
            ),
            wstBind12028 = wstBind12026.map(
              (item) => item.sheetId,
            );
          this.#e(() => {
            for (let wstBind22868 of [...wstBind12024.keys()])
              wstBind12027.has(wstBind22868) ||
                wstBind12024.delete(wstBind22868);
            ...
            wstBind12028.length > 0 &&
              wstBind12025.insert(0, wstBind12028);
          });
        }
        #u() {
        ...
        #h() {
          ...
          if (wstBind21731 instanceof workbookBinding266)
            return wstBind21731;
        }
        #g() {
          let wstBind21776 = this.#n.get("entryOrder");
          if (wstBind21776 instanceof workbookBinding265)
            return wstBind21776;
        }
        #_() {
          let wstBind21983 = this.#n.get("meta");
          if (wstBind21983 instanceof workbookBinding266)
            return wstBind21983;
        }
      };
});
