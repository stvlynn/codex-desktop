...
export function colorsEqual(
  styleCfg11346: { toProto(): unknown } | undefined,
  styleCfg11347: { toProto(): unknown } | undefined,
): boolean {
...
export function deepCloneArray(
  styleCfg13386: unknown[] | null | undefined,
): unknown[] {
...
export function deepCloneValue(styleCfg7173: unknown): unknown {
  ...
  if (typeof styleCfg7173 == "object") {
    let styleBind21674 = styleCfg7173,
      styleBind21675 = {};
    for (let [styleBind22882, styleBind22883] of Object.entries(styleBind21674))
      styleBind21675[styleBind22882] = deepCloneValue(styleBind22883);
