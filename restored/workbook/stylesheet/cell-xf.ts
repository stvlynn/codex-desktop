...
export class CellXf {
  ...
  constructor(styleCfg2463?: Record<string, any> | null) {
    ...
    this.featurePropertyBagIndex = styleBind9770.featurePropertyBagIndex;
  ...
  equals(styleCfg2362: CellXf): boolean {
    return (
      ...
      this.featurePropertyBagIndex === styleCfg2362.featurePropertyBagIndex &&
  ...
  toProto() {
    ...
    return (
      ...
      (styleBind9520.featurePropertyBagIndex = this.featurePropertyBagIndex),
