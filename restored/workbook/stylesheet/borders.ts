...
export class Borders {
  ...
  constructor(styleCfg4160?: Record<string, any> | null) {
    this.top = styleCfg4160?.top ? new BorderSide(styleCfg4160.top) : undefined;
  ...
  clone() {
    ...
    return (
      ...
      (styleBind12099.bottom = this.bottom ? this.bottom.clone() : undefined),
      (styleBind12099.left = this.left ? this.left.clone() : undefined),
      (styleBind12099.right = this.right ? this.right.clone() : undefined),
