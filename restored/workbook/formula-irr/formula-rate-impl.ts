...
export function computeRate(irrIn2045: any, irrIn2046: any, irrIn2047: any, irrIn2048: any, irrIn2049: any, irrIn2050: any, ) {
  if (
    ((irrIn2050 =
      irrIn2050 === undefined ? 0.1 : irrIn2050),
    (irrIn2048 =
      irrIn2048 === undefined ? 0 : irrIn2048),
    (irrIn2049 =
      irrIn2049 === undefined ? 0 : irrIn2049),
  ...
  for (
    ...
    if (
      (Math.abs(irrBind8908) < 1e-10
        ? (irrBind12672 =
            ...
            irrIn2046 *
              (1 + irrBind8908 * irrIn2049) *
              irrIn2045 +
            irrIn2048)
        : ((irrBind12673 =
            (1 + irrBind8908) ** +irrIn2045),
          (irrBind12672 =
    ...
    if (Math.abs(irrBind8908) < 1e-10)
      irrBind12674 =
        irrIn2047 * irrIn2045 +
        irrIn2046 * irrIn2049 * irrIn2045;
    else {
      irrBind12673 = (1 + irrBind8908) ** +irrIn2045;
      let irrBind20582 =
        irrIn2045 *
        (1 + irrBind8908) ** (irrIn2045 - 1);
      irrBind12674 =
