...
export function computeIrr(irrIn689: any, irrIn690: any) {
    ...
    ((irrIn690 =
      typeof irrIn690 == "number"
        ...
        : irrIn690 === undefined
          ? 0.1
          : irrH.fn849(irrIn690)),
    (irrIn689 = irrH.fn841(irrIn689).filter(irrH.fn854)),
  ...
  let irrBind4962 = new Float64Array(irrIn689.length),
    irrBind4963 = false,
    irrBind4964 = false;
  for (let irrBind21876 = 0; irrBind21876 < irrIn689.length; irrBind21876++) {
    irrBind4962[irrBind21876] = irrIn689[irrBind21876];
    irrBind4962[irrBind21876] > 0 && (irrBind4963 = true);
    irrBind4962[irrBind21876] < 0 && (irrBind4964 = true);
  }
  ...
  let irrBind4965 = (irrIn8523) => {
      ...
      for (
        ...
        irrBind19033 += irrBind4962[irrBind22696] / irrBind19035;
      }
      return irrBind19033;
    },
    irrBind4966 = new Map(),
    irrBind4967 = function (irrIn9717) {
      ...
      if (irrBind4966.has(irrBind20238)) return irrBind4966.get(irrBind20238);
      let irrBind20239 = irrBind4965(irrBind20238);
      return (irrBind4966.set(irrBind20238, irrBind20239), irrBind20239);
    };
  return (function () {
    ...
    for (; irrBind6972 < 1e3; ) {
      ...
      if (irrBind6972 > 0 && Math.abs(irrBind6970 - irrBind6971) < 1e-9) break;
      let irrBind13039 = Math.max(1e-4, Math.abs(irrBind6970 * 1e-4)),
        irrBind13040 =
          (irrBind4967(irrBind6970 + irrBind13039) - irrBind13038) /
          irrBind13039;
      if (Math.abs(irrBind13040) < 1e-10) break;
      irrBind6971 = irrBind6970;
      let irrBind13041 = irrBind13038 / irrBind13040,
        irrBind13042 = Math.max(0.1, Math.abs(irrBind6970) * 0.5);
      Math.abs(irrBind13041) > irrBind13042
        ? (irrBind6970 -= Math.sign(irrBind13041) * irrBind13042)
    ...
    if (irrBind6973 > 0) {
      for (
        irrBind6974 = irrBind6970, irrBind6975 = irrBind6970 + 0.1;
        irrBind4967(irrBind6975) > 0 && irrBind6975 < 1e3;
      )
      ...
      for (
        irrBind6975 = irrBind6970,
          irrBind6974 = Math.max(-0.99999999, irrBind6970 - 0.1);
        irrBind4967(irrBind6974) < 0 && irrBind6974 > -0.99999999;
      )
        irrBind6974 = Math.max(-0.99999999, irrBind6974 - 0.1);
      if (irrBind6974 <= -0.99999999) return irrBind6970;
    }
    let irrBind6976;
    for (let irrBind19442 = 0; irrBind19442 < 1e3; irrBind19442++) {
...
export function computeXirr(irrIn1978: any, irrIn1979: any, irrIn1980: any) {
  ...
  let irrBind8747 = (irrIn9267, irrIn9268, irrIn9269) => {
      ...
      for (
        ...
        irrBind19821 +=
          ...
          irrBind19820 **
            (irrH.dayDiff(irrIn9268[irrBind22364], irrIn9268[0]) / 365);
      return irrBind19821;
    },
    irrBind8748 = (irrIn8201, irrIn8202, irrIn8203) => {
      ...
      for (
        ...
        let irrBind22217 =
          irrH.dayDiff(irrIn8202[irrBind21111], irrIn8202[0]) / 365;
        irrBind18706 -=
    ...
    irrBind8749 = false,
    irrBind8750 = false;
  for (let irrBind22324 = 0; irrBind22324 < irrIn1978.length; irrBind22324++) {
  ...
  let irrBind8751 = irrIn1980,
    ...
    irrBind8756 = true;
  do {
    irrBind8755 = irrBind8747(irrIn1978, irrIn1979, irrBind8751);
    irrBind8753 =
      irrBind8751 -
      irrBind8755 / irrBind8748(irrIn1978, irrIn1979, irrBind8751);
    irrBind8754 = Math.abs(irrBind8753 - irrBind8751);
    irrBind8751 = irrBind8753;
    irrBind8756 = irrBind8754 > 1e-10 && Math.abs(irrBind8755) > 1e-10;
  } while (irrBind8756);
  return irrBind8751;
}
