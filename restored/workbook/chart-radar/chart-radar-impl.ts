...
export function paintRadarChart(crIn213: any, crIn214: any, crIn215: any, crIn216: any, crIn217: any, crIn218: any, ) {
  let crBind3211 = crH.prepareRadarSeries(crIn214, crIn218),
    crBind3212 = crBind3211.categories;
  if (
    crBind3212.length === 0 ||
    crBind3211.visibleSeries.length === 0
  )
    return;
  let crBind3213 = crIn215.x + crIn215.width / 2,
    crBind3214 = crIn215.y + crIn215.height / 2,
    crBind3215 =
      Math.min(crIn215.width, crIn215.height) / 2 - 12;
  ...
  let crBind3220 = (crIn10867) => {
      ...
      return crBind21383 === 0
        ? -Math.PI / 2
        : -Math.PI / 2 +
            (crIn10867 * 2 * Math.PI) / crBind21383;
    },
    crBind3221 = (crIn14161) =>
      !Number.isFinite(crIn14161) ||
      crIn14161 < crBind3216
        ? crBind3216
        : crIn14161 > crBind3217
          ? crBind3217
          : crIn14161,
    crBind3222 = crH.bh428(
      crIn214.xAxis,
      crIn216,
    ),
    crBind3223 =
    ...
    crBind3224 = Array.from(
      new Set([...crBind3218.ticks(5), crBind3217]),
    )
      .filter(
        (item) =>
      ...
      !Number.isFinite(crBind15246) ||
        ...
        crBind3212.forEach((_item, index) => {
          let crBind19596 = crBind3220(index),
            crBind19597 =
              crBind3213 +
              crBind15246 * Math.cos(crBind19596),
            crBind19598 =
              crBind3214 +
              crBind15246 * Math.sin(crBind19596);
          index === 0
            ? crIn213.moveTo(
                crBind19597,
                crBind19598,
  ...
  crBind3212.forEach((item, index) => {
    let crBind19682 = crBind3220(index),
      crBind19683 =
        crBind3213 +
        crBind3219 * Math.cos(crBind19682),
      crBind19684 =
        crBind3214 +
        crBind3219 * Math.sin(crBind19682);
    crIn213.beginPath();
  ...
  let crBind3226 =
    crBind3219 + Math.max(crBind3222.fontSize, 10);
  crBind3212.forEach((item, index) => {
    let crBind13426 = crBind3220(index),
      crBind13427 = Math.cos(crBind13426),
      crBind13428 = Math.sin(crBind13426),
      crBind13429 =
        crBind3213 + crBind3226 * crBind13427,
      crBind13430 =
        crBind3214 + crBind3226 * crBind13428;
    crBind13427 > 0.25
  ...
  crBind3211.layers.forEach((item) => {
    ...
    let crBind4936 = crBind3212.map((_item, index) => {
      ...
      return {
        x:
          crBind3213 +
          crBind18023 * Math.cos(crBind18024),
        y:
          crBind3214 +
          crBind18023 * Math.sin(crBind18024),
        value: crBind18022,
        idx: index,
      };
    });
    ...
    if (
      ...
      let crBind19743 = (() => {
        ...
        return crBind21865
          ? crBind21865.formatRgb()
          : crBind4935;
      })();
      crBind19743 &&
        ((crIn213.fillStyle = crBind19743),
        crIn213.fill());
    }
    crIn213.stroke();
    ...
    if (
      ...
      crBind4936.forEach((_item) => {
        ...
        if (
          ...
          let crBind22354 =
            crBind14176 ?? crBind4935;
          crBind22354 &&
            ((crIn213.fillStyle = crBind22354),
            crIn213.fill());
        }
        let crBind14178 =
          crBind14177.color ?? crBind4935;
        crBind14178 &&
