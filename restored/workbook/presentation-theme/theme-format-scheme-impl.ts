      ...
      PXe = class WorkbookClass33 {
        ...
        replace(ptfIn5208) {
          ...
          this.backgroundFillStyleList =
            ptfBind14746.backgroundFillStyleList;
        ...
        setColorScheme(ptfIn2863) {
          if (
            ptfIn2863 &&
            (ptfIn2863.name &&
              (this.colorScheme.name = ptfIn2863.name),
            ...
            for (let ptfBind18973 of this.colorScheme.colors ?? []) {
              ...
              let ptfBind20348 = ptfBind12825.get(
                ptfBind18973.name,
              );
              ptfBind20348
            ...
            for (let [
              ...
              ptfBind12827.has(ptfBind22979) ||
                ptfBind12826.push(ptfBind22980);
