...
export function pasteHtmlIntoSheet(htmIn718: any) {
  ...
  if (!htmBind5086)
    throw Error(`Worksheet index ${sheetIndex} not found`);
  let htmBind5087 = workbook.worksheets.getItem(htmBind5086),
    htmBind5088 = htmH.parseHtmlTable(html),
  ...
  for (
    let htmBind16461 = 0;
    htmBind16461 <=
    htmBind5091.selectionRect.r2 - htmBind5091.selectionRect.r1;
    htmBind16461 += 1
  )
    for (
      let htmBind18416 = 0;
      htmBind18416 <=
      htmBind5091.selectionRect.c2 -
        htmBind5091.selectionRect.c1;
      htmBind18416 += 1
    ) {
      let htmBind20555 =
          htmBind5088.rows[
            htmBind16461 % htmBind5089
  ...
  let htmBind5094 =
      htmBind5091.selectionRect.r2 -
      htmBind5091.selectionRect.r1 +
      1,
    htmBind5095 =
      htmBind5091.selectionRect.c2 -
      htmBind5091.selectionRect.c1 +
      ...
      for (
        ...
        let htmBind13715 =
          ...
          htmBind13716 =
            ...
            htmBind12194.c,
          htmBind13717 =
            htmBind13715 + htmBind12194.rowspan - 1,
          htmBind13718 =
            htmBind13716 + htmBind12194.colspan - 1;
  ...
  if (htmBind5088.colWidthsPx.length > 0)
    for (
      let htmBind17227 = 0;
      htmBind17227 < htmBind5095;
      htmBind17227 += 1
    ) {
      let htmBind18068 =
        htmBind5088.colWidthsPx[
          htmBind17227 % htmBind5088.colWidthsPx.length
        ];
      if (
        htmBind18068 == null ||
