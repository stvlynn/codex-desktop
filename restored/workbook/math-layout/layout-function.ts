...
export function layoutMathFunction(
  ...
  let workbookBinding7647 = getMathLayoutConstants(mathIn1558.typeface),
    ...
    workbookBinding7652 = Math.max(
      0,
      workbookBinding7649 - workbookBinding7651,
    ),
    workbookBinding7653 = Math.max(
      mathIn1558.fontPx * MATH_PHANTOM_MIN_SIZE_FACTOR,
      workbookBinding7648 * 4,
    ),
  ...
  return {
    ...
    primaryFont: buildMeasureFontShorthand(
      workbookBinding7654,
      mathIn1558.fontPx,
    ),
    ...
    draw: (mathIn3638, mathIn3639, mathIn3640) => {
      let workbookBinding12195 = workbookBinding7648 / 2,
        workbookBinding12196 =
          mathIn3640 - workbookBinding7651 + workbookBinding12195,
        workbookBinding12197 =
          mathIn3640 + workbookBinding7652 - workbookBinding12195,
        workbookBinding12198 =
          mathIn1557 === "["
            ? mathIn3639 + workbookBinding12195
            : mathIn3639 + workbookBinding7653 - workbookBinding12195,
        workbookBinding12199 =
          mathIn1557 === "[" ? mathIn3639 + workbookBinding7653 : mathIn3639;
      mathIn3638.save();
...
export function layoutMathFunctionParts(
  mathIn9022: unknown,
  mathIn9023: unknown,
  mathIn9024: unknown,
) {
  return hboxMathBoxes(
    [
      mathIn9022.name
        ? layoutMathNode(mathIn9022.name, mathIn9023, mathIn9024)
        : emptyMathBox(mathIn9023),
      mathIn9022.argument
        ? layoutMathNode(mathIn9022.argument, mathIn9023, mathIn9024)
        : emptyMathBox(mathIn9023),
    ],
    mathIn9023,
    mathIn9023.fontPx * MATH_NARY_LIMIT_GAP_FACTOR,
  );
}
