...
export function paintChartTrendline(
  ctlIn577: any,
  ctlIn578: any,
  ctlIn579: any,
  ctlIn580: any,
  ...
  let ctlBind4550 = [],
    ctlBind4551 = [];
  for (let ctlBind18134 = 0; ctlBind18134 < ctlIn581.length; ctlBind18134++) {
  ...
  let ctlBind4552 = (ctlIn1721) => {
    let ctlBind8062 = ctlBind4551.findIndex((item) => Number.isFinite(item)),
      ctlBind8063 = (() => {
        for (
          ...
          if (Number.isFinite(ctlBind4551[ctlBind22265])) return ctlBind22265;
        return -1;
      })(),
      ctlBind8064 = ctlBind8062 >= 0 ? ctlBind4551[ctlBind8062] : 0,
      ctlBind8065 = ctlBind8063 >= 0 ? ctlBind4551[ctlBind8063] : ctlBind8064,
      ctlBind8066 = 0;
    if (ctlBind8062 >= 0 && ctlBind8063 > ctlBind8062) {
      ...
      for (
        ...
        let ctlBind18525 = ctlBind4551[ctlBind17594 - 1],
          ctlBind18526 = ctlBind4551[ctlBind17594];
        if (!Number.isFinite(ctlBind18525) || !Number.isFinite(ctlBind18526))
          continue;
        let ctlBind18527 = ctlBind18526 - ctlBind18525;
        !Number.isFinite(ctlBind18527) ||
          ctlBind18527 <= 0 ||
          ((ctlBind15795 += ctlBind18527), (ctlBind15796 += 1));
      }
      ctlBind15796 > 0 && (ctlBind8066 = ctlBind15795 / ctlBind15796);
    }
    if (ctlBind8066 > 0 && ctlIn1721 < ctlBind8062)
      return ctlBind8064 + (ctlIn1721 - ctlBind8062) * ctlBind8066;
    if (ctlBind8066 > 0 && ctlIn1721 > ctlBind8063)
      return ctlBind8065 + (ctlIn1721 - ctlBind8063) * ctlBind8066;
    let ctlBind8067 = Math.max(
      ...
      ctlBind8069 = ctlBind4551[ctlBind8067] ?? ctlBind8064,
      ctlBind8070 = ctlBind4551[ctlBind8068] ?? ctlBind8069;
    if (ctlBind8067 === ctlBind8068) return ctlBind8069;
    let ctlBind8071 = (ctlIn1721 - ctlBind8067) / (ctlBind8068 - ctlBind8067);
    return ctlBind8069 + (ctlBind8070 - ctlBind8069) * ctlBind8071;
  };
  ctlIn579.trendlines?.length &&
    ctlIn579.trendlines.forEach((item, index) => {
      ctlH.bh523(ctlIn577, ctlIn578, ctlIn579, ctlIn580, item, ctlIn583);
      let ctlBind9156 =
      ...
      for (let ctlBind18573 of ctlBind9157.points) {
        ...
        !Number.isFinite(ctlBind19294) ||
          ...
          (ctlBind9158
            ? ctlIn577.lineTo(ctlBind19294, ctlBind19295)
            : (ctlIn577.moveTo(ctlBind19294, ctlBind19295),
              (ctlBind9158 = true)));
      }
      ctlBind9158 && ctlIn577.stroke();
      ctlH.bh524(ctlIn577, item, ctlBind9157, ctlIn583, ctlIn585);
    });
}
