    ...
    RXe = class {
      ...
      createApi(nrIn1824) {
        ...
        return {
          ...
          getItem: (nrIn9149) => {
            let nrBind19720 = this.getItemApi(
              nrIn9149,
              nrBind8388,
            );
          ...
          get items() {
            return (
              nrBind8388
                ? nrBind8389.#u(nrBind8388)
                : nrBind8389.#l()
            ).map((item) => new DefinedNameItem(nrBind8389, item));
          },
        };
      }
      ingest(nrIn13274) {
        if (nrIn13274)
          for (let nrBind23089 of nrIn13274)
            this.#i(nrBind23089);
      }
      replace(nrIn10038) {
        this.#t.clear();
      ...
      parseEntry(nrIn7122) {
        if (!nrIn7122.parsed) {
          let nrBind19994 = parseFormula(
            nrIn7122.normalizedFormula,
          );
      ...
      resolveRange(nrIn1709) {
        ...
        let { sheetName, ref } = parseSheetRef(
            nrIn1709.normalizedFormula,
          ),
          nrBind8028 =
            sheetName?.trim() || nrIn1709.scopeSheet?.trim();
        if (!nrBind8028)
          throw Error(
        ...
        let nrBind8029 =
          this.#e.getWorksheetByName(nrBind8028);
        if (!nrBind8029)
          throw Error(
      ...
      #i(nrIn3843, nrIn3844) {
        ...
        if (!nrBind12657 || nrBind12657.startsWith("_XLNM."))
          return;
        let nrBind12658 = this.#e.getSheetNameByLocalId(
            nrIn3843.localSheetId ?? null,
          ),
          nrBind12659 =
            nrIn3844 ?? this.normalizeFormula(nrIn3843.text),
          nrBind12660 = {
            proto: {
              ...nrIn3843,
            },
      ...
      #a(nrIn8750) {
        if (nrIn8750.scopeSheet) {
          this.#o(nrIn8750.scopeSheet).set(
            nrIn8750.normalizedName,
            nrIn8750,
          );
          return;
        }
      ...
      #o(nrIn9569) {
        ...
        return (
          nrBind20101 ||
            ((nrBind20101 = new Map()),
            this.#n.set(nrBind20100, nrBind20101)),
          nrBind20101
        );
      }
      #s(nrIn9654) {
        return (
          ...
          (nrIn9654.name === "LAMBDA" ||
            nrIn9654.name === "_XLFN.LAMBDA")
        );
      }
      delete(nrIn3001, nrIn3002) {
        ...
        if (!nrBind11014)
          throw Error("Defined name requires a non-empty name");
        let nrBind11015 = this.#c(
          nrBind11014,
          nrIn3002,
        );
        if (!nrBind11015)
          throw Error(`Defined name ${nrIn3001} not found`);
        if (nrBind11015.scopeSheet) {
          let nrBind21145 = nrBind11015.scopeSheet
            .trim()
            .toUpperCase();
          this.#n
            .get(nrBind21145)
            ?.delete(nrBind11015.normalizedName);
      ...
      getItemApi(nrIn8429, nrIn8430) {
        ...
        if (!nrBind18933)
          return new NullDefinedNameItem(nrIn8429 || "");
        let nrBind18934 = this.#c(
          nrBind18933,
          nrIn8430,
        );
        return nrBind18934
      ...
      #l() {
        return [...this.#t.values()].sort(
          (nrIn13073, nrIn13074) =>
            nrIn13073.normalizedName.localeCompare(
              nrIn13074.normalizedName,
            ),
        );
      }
      #u(nrIn6894) {
        ...
        return nrBind17217
          ? [...nrBind17217.values()].sort(
              (nrIn12851, nrIn12852) =>
                nrIn12851.normalizedName.localeCompare(
                  nrIn12852.normalizedName,
                ),
            )
          : [];
      }
      #d(nrIn6895, nrIn6896) {
        let nrBind17218 =
          getAttachedWorksheet(nrIn6895)?.name ?? nrIn6896 ?? "";
        if (!nrBind17218)
          throw Error(
