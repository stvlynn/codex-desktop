...
export function buildThreadSelector(
  ...
  return (
    ...
    rootAuthorId !== undefined && (opBind14619.rootAuthorId = rootAuthorId),
    rootCreatedAt !== undefined && (opBind14619.rootCreatedAt = rootCreatedAt),
    {
      id: threadId,
...
export function normalizeThreadTarget(
  props: ThreadTargetInput,
): LooseBag | null {
  ...
  let opBind14317 = props.spreadsheetRange,
    opBind14318 = opBind14317?.startAddress ?? opBind14317?.endAddress;
