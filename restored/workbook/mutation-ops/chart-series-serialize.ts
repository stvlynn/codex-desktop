...
export function serializeChartSeriesItem(opIn2436: LooseBag): LooseBag {
  ...
  opBind9682 !== undefined && (opBind9681.values = [...opBind9682]);
  let opBind9683 = opIn2436.xValues;
  opBind9683 !== undefined && (opBind9681.xValues = [...opBind9683]);
  let opBind9684 = opIn2436.categories;
  opBind9684.length > 0 && (opBind9681.categories = [...opBind9684]);
  opIn2436.formula !== undefined && (opBind9681.formula = opIn2436.formula);
  opIn2436.categoryFormula !== undefined &&
    (opBind9681.categoryFormula = opIn2436.categoryFormula);
  opIn2436.xFormula !== undefined && (opBind9681.xFormula = opIn2436.xFormula);
  ...
  opIn2436.xValuesFormatCode !== undefined &&
    (opBind9681.xValuesFormatCode = opIn2436.xValuesFormatCode);
  ...
  return (
    opBind9687 !== undefined && (opBind9681.fill = opBind9687),
    opBind9681
  );
}
...
export function serializeChartStrokeAlias(
  opIn15642: LooseBag,
): LooseBag | undefined {
  return serializeChartStroke(opIn15642);
}
export function serializeChartStroke(opIn3917: LooseBag): LooseBag | undefined {
  let opBind12799 = fillToConfig(opIn3917.fill),
    opBind12800 =
      opBind12799 === undefined && typeof opIn3917.color == "string"
        ? opIn3917.color
        : undefined,
    opBind12801 =
      typeof opIn3917.style == "string" ? opIn3917.style : undefined,
    opBind12802 =
      typeof opIn3917.width == "number" ? opIn3917.width : undefined;
  if (
  ...
  let opBind12803 = {};
  return (
    opBind12799 !== undefined && (opBind12803.fill = opBind12799),
    opBind12800 !== undefined && (opBind12803.color = opBind12800),
    opBind12801 !== undefined && (opBind12803.style = opBind12801),
    opBind12802 !== undefined && (opBind12803.width = opBind12802),
    opBind12803
  );
}
export function serializeChartMarker(opIn8563: LooseBag): LooseBag | undefined {
  ...
  if (opBind19061 === undefined && opBind19062 === undefined) return;
  let opBind19063 = {};
  return (
    opBind19061 !== undefined && (opBind19063.symbol = opBind19061),
    opBind19062 !== undefined && (opBind19063.size = opBind19062),
    opBind19063
  );
}
