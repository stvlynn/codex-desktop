...
function pathRoundedRect(
  ...
  sbgIn5052.quadraticCurveTo(sbgIn5053, 0, sbgIn5053, sbgBind14516);
  sbgIn5052.lineTo(sbgIn5053, sbgIn5054 - sbgBind14516);
  ...
  sbgIn5052.quadraticCurveTo(0, sbgIn5054, 0, sbgIn5054 - sbgBind14516);
  sbgIn5052.lineTo(0, sbgBind14516);
  sbgIn5052.quadraticCurveTo(0, 0, sbgBind14516, 0);
  sbgIn5052.closePath();
}
export async function paintSlideBackground(
  sbgIn854: any,
  sbgIn855: any,
  sbgIn856: any,
  sbgIn857: any,
  ...
  (sbgIn859?.clipRadiusPx ?? 0) > 0 &&
    (pathRoundedRect(sbgIn854, sbgIn857, sbgIn858, sbgIn859?.clipRadiusPx ?? 0),
    sbgIn854.clip());
  ...
  if (sbgBind5530) {
    let { image } = sbgBind5530,
      ...
      sbgBind7498 = await image.getBitmap(sbgIn857, sbgIn858);
    ...
    (sbgIn859?.clipRadiusPx ?? 0) > 0 &&
      ...
      sbgIn854.clip());
    let sbgBind7499 = (sbgIn16312) => (sbgIn16312 ?? 0) / 1e5,
      sbgBind7500 = 0,
      sbgBind7501 = 0,
    ...
    if (sbgBind7504) {
      ...
      sbgBind7502 -= (sbgBind18313 + sbgBind18315) * sbgBind7498.width;
      sbgBind7503 -= (sbgBind18314 + sbgBind18316) * sbgBind7498.height;
    }
    let sbgBind7505 = 0,
      sbgBind7506 = 0,
    ...
    if (sbgBind7509) {
      ...
      sbgBind7507 = sbgIn857 * (1 - sbgBind19705 - sbgBind19707);
      sbgBind7508 = sbgIn858 * (1 - sbgBind19706 - sbgBind19708);
    }
