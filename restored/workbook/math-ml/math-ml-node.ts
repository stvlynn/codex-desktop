...
export function createMathMlElement(
  mathIn12106: unknown,
  mathIn12107: unknown,
  mathIn12108: unknown,
  mathIn12109: unknown,
...
export function wrapMathAstSequence(mathIn11120: unknown) {
  if (mathIn11120.length !== 0)
    return mathIn11120.length === 1
      ? mathIn11120[0]
      : {
          sequence: {
...
export function applyMathAstStyle(mathIn12656: unknown, mathIn12657: unknown) {
  return !mathIn12656 || !mathIn12657
    ? mathIn12656
    : {
        ...mathIn12656,
...
export function parseOptionalIntAttr(mathIn10642: unknown) {
  ...
  return Number.isFinite(workbookBinding21125)
    ? workbookBinding21125
    : undefined;
}
...
export function mathMlLeafText(mathIn12800: unknown) {
  return mathIn12800
    ? isMathMlTokenTag(mathIn12800.tag)
      ? (mathIn12800.text ?? "")
      : collectMathMlText(mathIn12800)
    : "";
}
