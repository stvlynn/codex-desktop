...
export function matchesCfDatePeriod(
  ...
  switch (cfIn1957.replace(/[^a-z0-9]/gi, "").toLowerCase()) {
    ...
    case "last7days":
      return (
        cfBind8700 >= cfH.addDays(cfBind8701, -6) && cfBind8700 <= cfBind8701
      );
    case "thisweek": {
      let cfBind22657 = cfH.weekStart(cfBind8701);
      return (
        cfBind8700 >= cfBind22657 && cfBind8700 < cfH.addDays(cfBind22657, 7)
      );
    }
    case "lastweek": {
      let cfBind22631 = cfH.weekStart(cfBind8701);
      return (
        cfBind8700 >= cfH.addDays(cfBind22631, -7) && cfBind8700 < cfBind22631
      );
    }
    case "nextweek": {
    ...
    case "lastmonth": {
      ...
      return (
        cfBind8700 >= cfH.monthStart(cfH.addDays(cfBind22565, -1)) &&
    ...
    case "nextmonth": {
      ...
      return (
        cfBind8700 >= cfBind22711 && cfBind8700 < cfH.monthEnd(cfBind22711)
      );
    }
    default:
      return false;
