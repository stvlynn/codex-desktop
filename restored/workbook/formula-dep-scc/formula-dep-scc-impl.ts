...
export function findFormulaSccs(
  sccIn1188: any,
  sccIn1189: any,
  sccIn1190: any,
) {
  ...
  for (let sccBind18469 of sccIn1189) {
    let sccBind19003 = sccIn1188.dependents.get(sccBind18469);
    if (sccBind19003)
      for (let sccBind20684 of sccBind19003) {
        if (!sccIn1189.has(sccBind20684)) continue;
        let sccBind21242 = sccBind6719.get(sccBind18469);
        sccBind21242 ||
          ((sccBind21242 = []), sccBind6719.set(sccBind18469, sccBind21242));
  ...
  let sccBind6720 = [],
    ...
    sccBind6726 = (sccIn2141) => {
      ...
      for (let sccBind13901 of sccBind6719.get(sccIn2141) ?? [])
        if (sccIn1190.has(sccBind13901)) {
          if (!sccBind6721.has(sccBind13901)) {
            sccBind6726(sccBind13901);
            let sccBind19996 = sccBind6722.get(sccBind13901),
              sccBind19997 = sccBind6722.get(sccIn2141);
            sccBind19996 !== undefined &&
              sccBind19997 !== undefined &&
              sccBind6722.set(sccIn2141, Math.min(sccBind19997, sccBind19996));
          } else if (sccBind6724.has(sccBind13901)) {
            let sccBind20543 = sccBind6721.get(sccBind13901),
              sccBind20544 = sccBind6722.get(sccIn2141);
            sccBind20543 !== undefined &&
              sccBind20544 !== undefined &&
              sccBind6722.set(sccIn2141, Math.min(sccBind20544, sccBind20543));
          }
        }
      if (sccBind6722.get(sccIn2141) === sccBind6721.get(sccIn2141)) {
        let sccBind16241 = [];
        ...
        if (sccBind16241.length > 1) sccBind6720.push(sccBind16241);
        else {
          let sccBind22216 = sccBind16241[0];
          (sccBind6719.get(sccBind22216) ?? []).includes(sccBind22216) &&
            sccBind6720.push(sccBind16241);
        }
      }
    };
  for (let sccBind23065 of sccIn1190)
    sccBind6721.has(sccBind23065) || sccBind6726(sccBind23065);
  return sccBind6720;
}
