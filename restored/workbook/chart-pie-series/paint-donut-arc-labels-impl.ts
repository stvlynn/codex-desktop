...
export function paintDonutArcLabels(cpsIn1946: any, cpsIn1947: any, cpsIn1948: any, cpsIn1949: any, ) {
  for (let cpsBind8928 of cpsIn1947) {
    if (!cpsBind8928.name) continue;
    let cpsBind9049 =
      cpsBind8928.endAngle - cpsBind8928.startAngle;
    if (!Number.isFinite(cpsBind9049) || cpsBind9049 <= 0)
      continue;
    ...
    let cpsBind9051 =
      cpsBind9049 *
      (cpsBind8928.innerRadius + cpsBind9050 / 2);
    if (
    ...
    let [cpsBind9054, cpsBind9055] =
        cpsIn1948.centroid(cpsBind8928),
