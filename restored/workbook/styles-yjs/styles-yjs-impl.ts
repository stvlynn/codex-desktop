...
export function styleEntryToProtoParts(syIn3887: any) {
  ...
  return {
    fillProto: syBind12743
      ? deepCloneJson(syBind12743)
      : undefined,
    fontProto: syBind12744
      ? deepCloneJson(syBind12744)
      : undefined,
    borderProto: syBind12745
      ? deepCloneJson(syBind12745)
      : undefined,
...
export function deepCloneJson(syIn12859: any) {
  return syIn12859 == null
    ? syIn12859
    : JSON.parse(JSON.stringify(syIn12859));
}
...
export function sortKeysDeep(syIn7360: any) {
  ...
  if (syIn7360 && typeof syIn7360 == "object") {
    ...
    for (let syBind23072 of syBind21256)
      syBind21255[syBind23072] = sortKeysDeep(
        syBind21254[syBind23072],
      );
    return syBind21255;
  }
  return syIn7360;
...
export const ensureStylesYjsInit = esmInit(() => {
    ...
    Ogt = class {
      ...
      getOrCreateStyleIdForIndex(syIn3047) {
        ...
        let syBind11119 = styleEntryToProtoParts(
            this.#n.describe(syIn3047),
          ),
      ...
      registerStyle(syIn1339) {
        ...
        let syBind7063 = this.#n.register(syIn1339),
          syBind7064 = styleEntryToProtoParts(
            this.#n.describe(syBind7063),
          ),
        ...
        if (
          ...
          syBind7061.get(syBind7067)?.signature !==
            syBind7065
        ) {
          let syBind21392 = 1;
          for (
      ...
      #y(syIn11999, syIn12000) {
        ...
        this.#l.has(syIn12000) ||
          this.#l.set(syIn12000, syIn11999);
      }
      #b() {
        ...
        (!syBind10910 &&
          ...
          this.#t(() => {
            for (let [
              syBind22733,
              syBind22734,
            ] of syBind10910?.entries() ?? [])
              this.#i.set(
                syBind22733,
                deepCloneJson(syBind22734),
              );
            ...
            for (let [
              syBind22798,
              syBind22799,
            ] of syBind10912?.entries() ?? [])
              this.#o.set(syBind22798, syBind22799);
            for (let [
              syBind22735,
              syBind22736,
            ] of syBind10913?.entries() ?? [])
              this.#s.set(
                syBind22735,
                deepCloneJson(syBind22736),
              );
          });
      }
      #C() {
      ...
      #w() {
        ...
        if (syBind21729 instanceof YMap)
          return syBind21729;
      }
      #T() {
        let syBind21774 = this.#r.get("entryOrder");
        if (syBind21774 instanceof YArray)
          return syBind21774;
      }
      #E() {
        let syBind21665 = this.#r.get("signatureToId");
        if (syBind21665 instanceof YMap)
          return syBind21665;
      }
      #D() {
        let syBind21981 = this.#r.get("meta");
        if (syBind21981 instanceof YMap)
          return syBind21981;
      }
      #O() {
        ...
        for (let syBind21915 of this.#a.toArray())
          syBind16856.has(syBind21915) ||
            ...
            (syBind16856.add(syBind21915),
            syBind16857.push(syBind21915));
        for (let syBind22685 of this.#i.keys())
          syBind16856.has(syBind22685) ||
            (syBind16856.add(syBind22685),
            syBind16857.push(syBind22685));
        return syBind16857;
      }
    };
  });
