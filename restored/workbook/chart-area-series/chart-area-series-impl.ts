...
export function paintAreaSeries(casIn691: any, casIn692: any, casIn693: any, casIn694: any, casIn695: any, casIn696: any, casIn697: any, ) {
  ...
  casBind4970.layers.forEach((item) => {
    ...
    for (
      ...
      casBind5438
        ...
        : (casIn691.moveTo(casBind18529, casBind18531),
          (casBind5438 = true));
    }
    if (!casBind5438) {
      casIn691.closePath();
