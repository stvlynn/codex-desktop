...
export function newtonRaphson(fnwIn5039: any, fnwIn5040: any, fnwIn5041: any, fnwIn5042: any = NEWTON_REL_TOL, fnwIn5043: any = NEWTON_YP_EPS, fnwIn5044: any = NEWTON_MAX_ITERS, ) {
  let fnwBind14492 = fnwIn5041;
  for (
    let fnwBind16193 = 0;
    fnwBind16193 <= fnwIn5044;
    fnwBind16193 += 1
  ) {
    ...
    let fnwBind16978 =
      fnwBind14492 - fnwBind16976 / fnwBind16977;
    if (
