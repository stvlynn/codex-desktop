...
export function densifyShapePath(spdIn1180: any, spdIn1181: any) {
  if (spdIn1181 <= 0 || spdIn1180.length < 2) return spdIn1180;
  ...
  if (spdBind6699.cmd === "lineTo") {
    ...
    let spdBind19258 = Math.min(spdIn1181, spdBind19257 - 0.001);
    spdBind6699.x -=
      ((spdBind6699.x - spdBind6697.x) / spdBind19257) * spdBind19258;
    spdBind6699.y -=
      ((spdBind6699.y - spdBind6697.y) / spdBind19257) * spdBind19258;
    ...
    let spdBind11541 = {
      ...
      spdBind11543 = Math.min(spdIn1181, spdBind11542 - 0.001);
    if (spdBind11543 > 0) {
      let [spdBind14982] = spdH.bh626(
        spdBind11541,
        spdH.bh625(spdBind11541, spdBind11542 - spdBind11543),
      );
      ...
      let spdBind14983 = spdH.bh628({
        ...
        spdBind14984 = {
          x: spdBind6699.x - spdBind14983.x * spdBind11543,
          y: spdBind6699.y - spdBind14983.y * spdBind11543,
        },
        spdBind14985 = Math.hypot(
          spdBind14982.p3.x - spdBind14982.p2.x,
          spdBind14982.p3.y - spdBind14982.p2.y,
        );
      spdBind6699.x2 = spdBind14984.x - spdBind14983.x * spdBind14985;
      spdBind6699.y2 = spdBind14984.y - spdBind14983.y * spdBind14985;
