...
import { pointsToPixels, pixelsToPoints } from "../../utils/spreadsheet-address-utils";
import { buildCellXfFormatMap, measureDefaultDigitWidthPx, computeColumnWidthsPx } from "../cell-xf-format";
...
import { cachedFormatCellDisplay, findTableResolverAt } from "./autofit-helpers";
export function autofitRowHeights(props: unknown) {
  ...
  let afBind4883 = workbook.toProto(),
    afBind4884 = afBind4883.sheets?.find(afIn16170 => afIn16170.name === worksheet.name) ?? null;
  ...
  let afBind4885 = themeStyleMapsFromProto(afBind4883.theme),
    ...
    afBind4895 = pointsToPixels(afBind4884.defaultRowHeight && afBind4884.defaultRowHeight !== 0 ? afBind4884.defaultRowHeight : 15),
    afBind4896 = worksheet.__getRows();
  for (let afBind6178 = afBind4882.startRow; afBind6178 <= afBind4882.endRow; afBind6178++) {
    ...
    for (let afBind8008 = afBind6327; afBind8008 <= afBind6328; afBind8008++) {
      ...
      if (afBind8186 && (afBind8186.rowMin !== afBind8186.rowMax || afBind6178 !== afBind8186.rowMin || afBind8008 !== afBind8186.colMin)) continue;
      let afBind8187 = resolveCellStyleIndex(afBind8185, afBind6178, afBind8008, afBind4890, afBind4889),
        afBind8188 = afBind4886[afBind8187],
        afBind8189 = findTableResolverAt(afBind4891, afBind6178, afBind8008)?.resolveCell(afBind6178, afBind8008),
        afBind8190 = cachedFormatCellDisplay(afBind8185, afBind4886, afBind4892, afBind8187),
        afBind8191 = afBind8185.paragraphs && afBind8185.paragraphs.length > 0 ? afBind8185.paragraphs : [{
          runs: [{
            text: afBind8190,
            citations: [],
            reviewMarkIds: []
        ...
        afBind8192 = 0;
      for (let afBind22751 = afBind8008; afBind22751 <= (afBind8186?.colMax ?? afBind8008); afBind22751++) afBind8192 += afBind4893[afBind22751] ?? 0;
      ...
      let {
        ...
        boxWidthPx: afBind8188?.wrapText === true ? Math.max(afBind8192 ?? 0, 1) : 1e6,
