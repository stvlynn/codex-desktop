...
export function autofitColumnWidths(props: unknown) {
  ...
  let afBind4668 = workbook.toProto(),
    afBind4669 =
      afBind4668.sheets?.find(
        (afIn16169) => afIn16169.name === worksheet.name,
      ) ?? null;
  ...
  let afBind4670 = themeStyleMapsFromProto(afBind4668.theme),
    ...
    afBind4681 = pointsToPixels(
      afBind4669.defaultRowHeight && afBind4669.defaultRowHeight !== 0
        ? afBind4669.defaultRowHeight
        : 15,
    ),
    afBind4682 = worksheet.__getColumns();
  for (
    let afBind5877 = afBind4667.startCol;
    afBind5877 <= afBind4667.endCol;
    afBind5877++
  ) {
    ...
    for (let afBind8998 = afBind6000; afBind8998 <= afBind6001; afBind8998++) {
      ...
      let afBind9265 = resolveCellStyleIndex(
          afBind9264,
          afBind8998,
          afBind5877,
          afBind4675,
        ...
        afBind9267 = findTableResolverAt(
          afBind4676,
          afBind8998,
          afBind5877,
        )?.resolveCell(afBind8998, afBind5877),
        afBind9268 = cachedFormatCellDisplay(
          afBind9264,
          afBind4671,
          afBind4679,
          afBind9265,
      ...
      let { widthPx } = measureCellTextPx({
          style: afBind9266,
          themeMap: afBind4670,
          wrap: false,
          boxWidthPx: 1e6,
          paragraphs:
            afBind9264.paragraphs && afBind9264.paragraphs.length > 0
              ? afBind9264.paragraphs
              : [
                  {
                    runs: [
                      {
        ...
        afBind9269 = widthPx;
      afBind4677.has(`${afBind8998}:${afBind5877}`) &&
        (afBind9269 += filterButtonExtraWidth(afBind9266));
      isInListValidationRange(afBind4678, afBind8998, afBind5877) &&
        (afBind9269 += dropdownExtraWidthForRowHeight(
          afBind4680[afBind8998] ?? afBind4681,
        ));
