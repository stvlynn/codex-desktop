...
void workbookBinding1574;
void workbookBinding1575;
void workbookBinding1576;
void workbookBinding1577;
void workbookBinding1578;
void workbookBinding1579;
void workbookBinding1580;
void workbookBinding1581;
void workbookBinding1582;
void workbookBinding1583;
void workbookBinding1584;
void workbookBinding1585;
void workbookBinding1586;
void workbookBinding1587;
void workbookBinding1588;
void $Y;
void workbookBinding1589;

export function lowerComposeChildren(
  cjIn1354: any,
  cjIn1355: any,
  cjIn1356: any,
  cjIn1357: any,
  ...
  return (
    cjIn1354.forEach((item) => {
      if (Array.isArray(item)) {
        cjBind7108.push(
          ...lowerComposeChildren(item, cjIn1355, cjIn1356, cjIn1357),
        );
        return;
      }
      if (
        !(
          item == null ||
          typeof item == "boolean" ||
          isComposeFormattingWhitespace(item)
        )
      ) {
        ...
        if (!isPresentationJsxElement(item))
          throw Error(`${cjIn1357} contains an unsupported JSX value.`);
        ...
        cjBind7108.push(lowerComposeElement(item, cjIn1355, cjIn1356));
      }
    }),
    cjBind7108
  );
...
export function lowerComposeElement(cjIn306: any, cjIn307: any, cjIn308: any) {
  ...
  if (cjlH.isSemanticTag(cjBind3549))
    return cjlH.lowerSemanticTag(cjIn306, {
      ...
      lowerElement: (cjIn16390) =>
        lowerComposeElement(cjIn16390, cjIn307, cjIn308),
      lowerRun: lowerRunElement,
      readRef: readComposeRef,
      registerRef: (cjIn15871, cjIn15872, cjIn15873) =>
        registerComposeRef(cjIn15871, cjIn15872, cjIn307, cjIn308, cjIn15873),
      toChildArray: toComposeChildArray,
      isFormattingWhitespace: isComposeFormattingWhitespace,
    });
  if (cjBind3549 === "row")
    return (
      assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1576),
      workbookBinding1508(
        omitComposeKeys(cjBind3549, stripClassName(cjBind3550), [
          "children",
          "id",
        ]),
        lowerComposeChildren(
  ...
  if (cjBind3549 === "column")
    return (
      assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1577),
      workbookBinding1509(
        omitComposeKeys(cjBind3549, stripClassName(cjBind3550), [
          "children",
          "id",
  ...
  if (cjBind3549 === "layers" || cjBind3549 === "group")
    return (
      assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1578),
      workbookBinding1513(
        omitComposeKeys(cjBind3549, stripClassName(cjBind3550), [
          "children",
          "id",
  ...
  if (cjBind3549 === "grid")
    return (
      assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1579),
      workbookBinding1510(
        omitComposeKeys(cjBind3549, stripClassName(cjBind3550), [
          "children",
          "id",
  ...
  if (cjBind3549 === "box" || cjBind3549 === "panel" || cjBind3549 === "card") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1580);
    let cjBind9370 = readComposeRef(cjBind3550.ref, cjBind3549),
          ...
          ? workbookBinding1512(
              omitComposeKeys(
                cjBind3549,
                {
                  ...
                  materialize: cjBind9370 === undefined ? undefined : true,
                },
    ...
    return (
      registerComposeRef(cjBind9373, cjBind9370, cjIn307, cjIn308, cjBind3549),
      cjBind9373
    );
  }
  if (cjBind3549 === "text-box" || cjBind3549 === "text") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1581);
    let cjBind18904 = workbookBinding1501(
      ...
      omitComposeKeys(
        cjBind3549,
        mergePosition(stripClassName(cjBind3550), cjBind3549),
        ["children", "ref", "className", "id"],
      ),
    );
    return (
  ...
  if (cjBind3549 === "paragraph") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1582);
  ...
  if (cjBind3549 === "shape") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1583);
    assertLeafChildren(cjBind3549, cjBind3550.children);
    let cjBind20123 = workbookBinding1503(
      omitComposeKeys(
        cjBind3549,
        applyClassNameStyle(stripClassName(cjBind3550), cjBind3549),
        ["ref", "className", "id"],
      ),
    );
    return (
  ...
  if (cjBind3549 === "connector") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1584);
    assertLeafChildren(cjBind3549, cjBind3550.children);
    let cjBind20710 = workbookBinding1504(
      omitComposeKeys(cjBind3549, stripClassName(cjBind3550), ["ref", "id"]),
    );
    return (
      registerComposeRef(
        cjBind20710,
  ...
  if (cjBind3549 === "image") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1585);
    assertLeafChildren(cjBind3549, cjBind3550.children);
  ...
  if (cjBind3549 === "table") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1586);
    assertLeafChildren(cjBind3549, cjBind3550.children);
  ...
  if (cjBind3549 === "rule") {
    assertAllowedComposeProps(cjBind3549, cjBind3550, workbookBinding1587);
    assertLeafChildren(cjBind3549, cjBind3550.children);
...
export function lowerRunElement(cjIn8013: any) {
  ...
  let cjBind18501 = pickTextStyleProps(cjIn8013.props, ["children"]),
...
export function resolveImageSource(cjIn3269: any) {
  let cjBind11496 = "",
    ...
    cjBind11498 = (cjIn3892) => {
      if (!(cjIn3892 == null || typeof cjIn3892 == "boolean")) {
        if (Array.isArray(cjIn3892)) {
          cjIn3892.forEach(cjBind11498);
          return;
        }
        if (typeof cjIn3892 == "string" || typeof cjIn3892 == "number") {
  ...
  return (cjBind11498(cjIn3269), cjBind11497 ? cjBind11496 : undefined);
}
export function normalizeComposeProps(cjIn1621: any, cjIn1622: any) {
  ...
  if (typeof cjBind7838 != "object" || !cjBind7838 || Array.isArray(cjBind7838))
  ...
  if ((delete cjBind7840.frame, cjBind7839.width !== undefined)) {
  ...
  if (
    (["left", "top", "right", "bottom"].forEach((item) => {
      cjBind7839[item] !== undefined && (cjBind7841[item] = cjBind7839[item]);
    }),
...
export function assertAllowedComposeProps(
  cjIn10013: any,
  cjIn10014: any,
  cjIn10015: any,
) {
  Object.keys(cjIn10014).forEach((item) => {
    if (!cjIn10015.has(item))
      throw Error(`<${cjIn10013}> does not support the \`${item}\` prop.`);
  });
}
export function pickTextStyleProps(cjIn9442: any, cjIn9443: any) {
  let cjBind19957 = {};
  return (
    Object.entries(cjIn9442).forEach(([cjIn13059, cjIn13060]) => {
...
export function omitComposeKeys(
  cjIn10984: any,
  cjIn10985: any,
  cjIn10986: any,
) {
  let cjBind21513 = pickTextStyleProps(cjIn10985, cjIn10986);
  return (
...
export function readComposeRef(cjIn7645: any, cjIn7646: any) {
  if (cjIn7645 !== undefined) {
    if (typeof cjIn7645 != "object" || !cjIn7645 || !("current" in cjIn7645))
      throw Error(
...
export function registerComposeRef(
  cjIn6333: any,
  cjIn6334: any,
  cjIn6335: any,
  cjIn6336: any,
  ...
  if (cjIn6334) {
    if (!workbookBinding1575.has(cjIn6333.kind))
      throw Error(`<${cjIn6337}> does not materialize an element ref.`);
...
export function collectRefsByPath(
  cjIn5614: any,
  cjIn5615: any,
  cjIn5616: any,
  cjIn5617: any,
  ...
  if (
    (cjBind15454 && cjIn5616.set(cjIn5617, cjBind15454),
    cjIn5614.kind === "panel")
  ) {
    cjIn5614.child &&
      collectRefsByPath(
...
export function applyClassNameStyle(cjIn5560: any, cjIn5561: any) {
  ...
  if (typeof cjBind15363 != "string" || cjBind15363.trim().length === 0)
    return cjIn5560;
  ...
  return cjBind15364
    ? {
        ...
        borderRadius: cjIn5560.borderRadius ?? cjBind15364.borderRadius,
        shadow: cjIn5560.shadow ?? cjBind15364.shadow,
        name: isAbsolutePosition(cjIn5560) ?? cjIn5560.name ?? cjIn5561,
      }
    : cjIn5560;
}
export function mergePosition(cjIn9609: any, cjIn9610: any) {
  let cjBind20146 =
    typeof cjIn9609.className == "string" ? cjIn9609.className : undefined;
  return cjBind20146
    ? {
        ...cjIn9609,
        style: cjlH.bh700(
...
export function lowerTableRows(cjIn3317: any, cjIn3318: any) {
  ...
  if (typeof cjBind11614 != "string" || cjBind11614.trim().length === 0)
...
export function isAbsolutePosition(cjIn8519: any) {
  let cjBind19028 =
    typeof cjIn8519.name == "string" && cjIn8519.name.trim().length > 0
      ? cjIn8519.name
      : cjIn8519.id;
