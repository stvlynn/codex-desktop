  ...
  ensureWorkbookThemeInit = esmInit(() => {
    ...
    WorkbookTheme = class {
      ...
      constructor(dtIn1828: unknown, dtIn1829: unknown, dtIn1830: unknown) {
        ...
        this.#a = dtIn1830;
        let dtBind8405 =
            dtIn1829?.colorScheme?.colors?.reduce(
              (dtIn10514, dtIn10515) => (
                (dtIn10514[dtIn10515.name] = new WorkbookColor(
                  {
                    type: "proto",
          ...
          dtBind8406 =
            nonEmptyStringOrUndefined(dtIn1829?.colorScheme?.name) ?? "ChatGPT";
        this.#r =
          nonEmptyStringOrUndefined(themeProtoDisplayName(dtIn1829)) ??
          dtBind8406;
        this.#t = {
          name: dtBind8406,
        ...
        this.#n = {
          fillStyleList:
            dtIn1829?.fillStyleList ?? chatgptThemeWarm.fillStyleList,
          backgroundFillStyleList:
            dtIn1829?.backgroundFillStyleList ??
            chatgptThemeWarm.backgroundFillStyleList,
          lineStyleList:
            dtIn1829?.lineStyleList ?? chatgptThemeWarm.lineStyleList,
          effectStyleList:
            dtIn1829?.effectStyleList ?? chatgptThemeWarm.effectStyleList,
        };
      ...
      replaceFromProto(dtIn1903: unknown) {
        let dtBind8569 =
            dtIn1903?.colorScheme?.colors?.reduce(
              (dtIn8446, dtIn8447) => (
                (dtIn8446[dtIn8447.name] = new WorkbookColor(
                  {
                    type: "proto",
          ...
          dtBind8570 =
            nonEmptyStringOrUndefined(dtIn1903?.colorScheme?.name) ?? "ChatGPT";
        this.#r =
          nonEmptyStringOrUndefined(themeProtoDisplayName(dtIn1903)) ??
          dtBind8570;
        this.#t = {
          name: dtBind8570,
        ...
        this.#n = {
          fillStyleList:
            dtIn1903?.fillStyleList ?? chatgptThemeWarm.fillStyleList,
          backgroundFillStyleList:
            dtIn1903?.backgroundFillStyleList ??
            chatgptThemeWarm.backgroundFillStyleList,
          lineStyleList:
            dtIn1903?.lineStyleList ?? chatgptThemeWarm.lineStyleList,
          effectStyleList:
            dtIn1903?.effectStyleList ?? chatgptThemeWarm.effectStyleList,
        };
      ...
      set colorScheme(dtIn5965) {
        this.#t = {
          name: dtIn5965.name,
          themeColors: Object.entries(dtIn5965.themeColors).reduce(
            (accumulator, [dtIn15175, dtIn15176]) => (
              (accumulator[dtIn15175] = new WorkbookColor(dtIn15176, this.#a)),
              accumulator
            ),
            {},
          ),
      ...
      get hexColorMap() {
        return Object.fromEntries(
          Object.entries(this.#t.themeColors).map(([dtIn12913, dtIn12914]) => [
            dtIn12913,
            dtIn12914?.hex ?? "",
          ]),
        );
      ...
      ensureEffectStyle(dtIn4863: unknown) {
        let dtBind14267 = JSON.stringify(dtIn4863),
          dtBind14268 = this.#n.effectStyleList.findIndex(
            (item) => JSON.stringify(item) === dtBind14267,
          );
        return dtBind14268 >= 0
          ? String(dtBind14268 + 1)
          : (this.#n.effectStyleList.push(dtIn4863),
            this.#e.queueCollaborativePublish?.(),
            String(this.#n.effectStyleList.length));
      }
      textStyles(dtIn3172: unknown) {
        let dtBind11328 = dtIn3172 ?? DEFAULT_THEME_TEXT_STYLES;
        if (!this.#o())
          throw Error(
            "presentation.theme.textStyles(...) requires a presentation-backed theme context.",
          );
        let dtBind11329 = {};
        for (let [dtBind15804, dtBind15805] of Object.entries(dtBind11328)) {
          let dtBind16694 = assertThemeTextStyleName(dtBind15804);
          applyTextStylePatch(
            this.#e.addTextStyle(dtBind16694),
            resolveTextStyleTokens(dtBind15805, {
      ...
      toProto() {
        return {
          ...
          colorScheme: {
            name: this.#t.name,
            colors: Object.entries(this.#t.themeColors).map(
              ([dtIn11722, dtIn11723]) => ({
                name: dtIn11722,
      ...
      #o() {
        return (
          typeof this.#e.addTextStyle == "function" &&
          typeof this.#e.resolveTextStyle == "function"
        );
      }
    };
    assertThemeTextStyleName = (dtIn9553) => {
      let dtBind20080 = dtIn9553.trim();
      if (dtBind20080.length === 0)
        throw Error("theme text style names must be non-empty.");
      return dtBind20080;
    };
    nonEmptyStringOrUndefined = (dtIn14784) =>
      dtIn14784 !== undefined && dtIn14784.length > 0 ? dtIn14784 : undefined;
