...
export function reserveTitleBand(
  clpIn1280: any,
  clpIn1281: any,
  clpIn1282: any,
  clpIn1283: any = clpH.titleHeightFrac,
) {
  ...
  if (
    ...
    let clpBind20508 = clpH.applyManualLayout(
      ...
      clpBind20509 = clpBind20508.x + clpBind20508.width;
    clpBind6937 = {
      ...clpBind6937,
      width: Math.min(
        clpBind6937.width,
  ...
  let clpBind6939 = clpH.layoutTitleElement(clpIn1280, clpIn1282, clpBind6937),
  ...
  let clpBind6941 = clpIn1280.titleManualLayout?.h,
    clpBind6942 = clpBind6941 !== undefined && Number.isFinite(clpBind6941),
    clpBind6943 = Math.min(clpBind6937.height, clpBind6940 + clpH.titlePadPx);
  ...
  return (
    clpBind6935 !== "centeredOverlay" &&
      (clpBind6945 = Math.min(
        clpIn1281.height,
        Math.max(0, clpBind6944.y - clpIn1281.y) + clpBind6944.height,
      )),
    {
