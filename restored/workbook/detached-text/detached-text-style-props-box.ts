...
export function getDetachedColor(host: DetachedTextStyleHost): any {
  ...
  return dtBind19091?.toProto() ? dtBind19091 : undefined;
}

export function setDetachedColor(
  host: DetachedTextStyleHost,
  dtIn7177: any,
): void {
  let dtBind17528 = host.fullSelection();
  dtBind17528.isEmpty || (dtBind17528.color = dtIn7177);
...
export function getDetachedFill(host: DetachedTextStyleHost): any {
  ...
  return dtBind19184?.toProto() ? dtBind19184 : undefined;
}

export function setDetachedFill(
  host: DetachedTextStyleHost,
  dtIn7566: any,
): void {
  let dtBind18045 = host.fullSelection();
  dtBind18045.isEmpty || (dtBind18045.fill = dtIn7566);
  host.patchDefaultStyle(dtIn7566, (dtIn13105, dtIn13106) => {
    dtIn13106 !== undefined && (dtIn13105.fill = dtIn13106);
  });
  host.recordStyle({
...
export function getDetachedHighlight(host: DetachedTextStyleHost): any {
  ...
  return dtBind18742?.toProto() ? dtBind18742 : undefined;
}

export function setDetachedHighlight(
  host: DetachedTextStyleHost,
  dtIn7507: any,
): void {
  let dtBind17985 = host.fullSelection();
  dtBind17985.isEmpty || (dtBind17985.highlight = dtIn7507);
...
export function getDetachedOutline(host: DetachedTextStyleHost): any {
  ...
  return dtBind18913?.toProto() ? dtBind18913 : undefined;
}

export function setDetachedOutline(
  host: DetachedTextStyleHost,
  dtIn7742: any,
): void {
  let dtBind18227 = host.fullSelection();
  dtBind18227.isEmpty || (dtBind18227.outline = dtIn7742);
...
export function setDetachedShadow(
  host: DetachedTextStyleHost,
  dtIn7938: any,
): void {
  let dtBind18420 = host.fullSelection();
  dtBind18420.isEmpty || (dtBind18420.shadow = dtIn7938);
...
export function getDetachedAlignment(host: DetachedTextStyleHost): any {
  ...
  return dtBind18988 ? alignmentProtoToName(dtBind18988.alignment) : undefined;
}

export function setDetachedAlignment(
  host: DetachedTextStyleHost,
  dtIn7611: any,
): void {
  let dtBind18102 = host.fullSelection();
  dtBind18102.isEmpty || (dtBind18102.alignment = dtIn7611);
...
export function setDetachedVerticalAlignment(
  host: DetachedTextStyleHost,
  dtIn8297: any,
): void {
...
export function setDetachedAutoFit(
  host: DetachedTextStyleHost,
  dtIn9341: any,
): void {
...
export function setDetachedWrap(
  host: DetachedTextStyleHost,
  dtIn9629: any,
): void {
...
export function setDetachedInsets(
  host: DetachedTextStyleHost,
  dtIn9465: any,
): void {
