...
export function getDetachedBold(host: DetachedTextStyleHost): any {
    ...
    return dtBind21166 === undefined
      ? host.defaultTextStyle?.bold
      : dtBind21166;
}

export function setDetachedBold(host: DetachedTextStyleHost, dtIn8171: any): void {
    let dtBind18680 = host.fullSelection();
    dtBind18680.isEmpty ||
      (dtBind18680.bold = dtIn8171);
...
export function setDetachedItalic(host: DetachedTextStyleHost, dtIn7937: any): void {
    let dtBind18419 = host.fullSelection();
    dtBind18419.isEmpty ||
      (dtBind18419.italic = dtIn7937);
...
export function setDetachedFontSize(host: DetachedTextStyleHost, dtIn7740: any): void {
    let dtBind18225 = host.fullSelection();
    dtBind18225.isEmpty ||
      (dtBind18225.fontSize = dtIn7740);
...
export function setDetachedTypeface(host: DetachedTextStyleHost, dtIn7741: any): void {
    let dtBind18226 = host.fullSelection();
    dtBind18226.isEmpty ||
      (dtBind18226.typeface = dtIn7741);
...
export function setDetachedLineSpacing(host: DetachedTextStyleHost, dtIn7421: any): void {
    let dtBind17882 = host.fullSelection();
    dtBind17882.isEmpty ||
      (dtBind17882.lineSpacing = dtIn7421);
...
export function setDetachedUnderline(host: DetachedTextStyleHost, dtIn7610: any): void {
    let dtBind18101 = host.fullSelection();
    dtBind18101.isEmpty ||
      (dtBind18101.underline = dtIn7610);
