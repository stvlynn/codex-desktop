...
import { workbookFn912 } from "../formula-skew";
import { flattenSingleCellArg as workbookFn914 } from "../formula-averageif";
import {
  isFormulaErrorToken,
  formulaErrorFromMessage,
} from "../formula-average-a";
import { modeArgs, OQe } from "../formula-scalar-funcs";
import { workbookFn917 } from "./formula-eng-mids-impl";
import {
  workbookBinding1849,
  workbookBinding1855,
  workbookBinding1862,
...
export function d4e(fdwIn5609: any) {
  let fdwBind15446 = workbookFn914(fdwIn5609),
    fdwBind15447 = 0;
  for (let fdwBind18338 of fdwBind15446) {
    ...
    let fdwBind18843 = workbookFn912(fdwBind18338);
...
export function h3e(
  ...
  let fdwBind18379 = workbookFn905(fdwIn7898);
  if (typeof fdwBind18379 != "number") return fdwBind18379;
  let fdwBind18380 = workbookFn906(fdwIn7899);
  if (typeof fdwBind18380 != "number") return fdwBind18380;
  let fdwBind18381 = workbookFn906(fdwIn7900);
...
export function g3e(fdwIn7088: any, fdwIn7089: any, fdwIn7090: any) {
  let fdwBind17429 = workbookFn908(fdwIn7088, {
    inclusiveZero: false,
    inclusiveOne: false,
  });
  if (typeof fdwBind17429 != "number") return fdwBind17429;
  let fdwBind17430 = workbookFn906(fdwIn7089);
  if (typeof fdwBind17430 != "number") return fdwBind17430;
  let fdwBind17431 = workbookFn906(fdwIn7090);
...
export function H3e(
  ...
  let fdwBind18382 = workbookFn905(fdwIn7902);
  if (typeof fdwBind18382 != "number") return fdwBind18382;
  let fdwBind18383 = workbookFn906(fdwIn7903);
  if (typeof fdwBind18383 != "number") return fdwBind18383;
  let fdwBind18384 = workbookFn906(fdwIn7904);
...
export function Y3e(
  ...
  let fdwBind18385 = workbookFn905(fdwIn7906);
  if (typeof fdwBind18385 != "number") return fdwBind18385;
  let fdwBind18386 = workbookFn909(fdwIn7907);
  if (typeof fdwBind18386 != "number") return fdwBind18386;
  let fdwBind18387 = workbookFn909(fdwIn7908);
...
export function X3e(fdwIn8204: any, fdwIn8205: any, fdwIn8206: any) {
  let fdwBind18707 = workbookFn905(fdwIn8204);
  if (typeof fdwBind18707 != "number") return fdwBind18707;
  let fdwBind18708 = workbookFn909(fdwIn8205);
  if (typeof fdwBind18708 != "number") return fdwBind18708;
  let fdwBind18709 = workbookFn909(fdwIn8206);
...
export function Z3e(fdwIn7091: any, fdwIn7092: any, fdwIn7093: any) {
  let fdwBind17432 = workbookFn908(fdwIn7091, {
    inclusiveZero: false,
    inclusiveOne: false,
  });
  if (typeof fdwBind17432 != "number") return fdwBind17432;
  let fdwBind17433 = workbookFn909(fdwIn7092);
  if (typeof fdwBind17433 != "number") return fdwBind17433;
  let fdwBind17434 = workbookFn909(fdwIn7093);
