...
export function cloneWorkbookColor(rfIn12167: unknown) {
  if (rfIn12167 !== undefined) return rfIn12167 instanceof WorkbookColor ? rfIn12167.clone() : new WorkbookColor(rfIn12167);
}
export function isNonProtoConfig(rfIn11620: unknown) {
  return !(typeof rfIn11620 == "object" && rfIn11620 && "type" in rfIn11620 && rfIn11620.type === "proto");
}
export function isNonProtoValue(props: unknown) {
  return !(typeof props == "object" && props && "type" in props && props.type === "proto");
}
export function fillConfigFromFillOrValue(props: unknown) {
  if (props !== undefined) {
    ...
    if (props instanceof Fill) {
      ...
      return rfBind21827 ? isNonProtoConfig(rfBind21827) ? rfBind21827 : undefined : props.isSet ? undefined : null;
    }
    return typeof props == "object" && props && "type" in props ? isNonProtoConfig(props) ? props : undefined : props;
  }
}
export function workbookColorToConfig(rfIn12006: unknown) {
  if (rfIn12006) return rfIn12006 instanceof WorkbookColor ? rfIn12006.toConfig() : isNonProtoValue(rfIn12006) ? rfIn12006 : undefined;
}
export function borderSideToConfig(rfIn5392: unknown) {
  if (!rfIn5392) return;
  let rfBind15133 = {};
  if ("style" in rfIn5392 && rfIn5392.style !== undefined && (rfBind15133.style = rfIn5392.style), "weight" in rfIn5392 && rfIn5392.weight !== undefined && (rfBind15133.weight = rfIn5392.weight), "color" in rfIn5392 && rfIn5392.color !== undefined) {
...
export function borderPresetToConfig(props: unknown) {
  ...
  return rfBind19840 !== undefined && (rfBind19839.color = rfBind19840), rfBind19839;
}
...
export function borderSidePartialFromEdge(rfIn6282: unknown) {
  if (!rfIn6282) return;
  let rfBind16389 = {};
  if (rfIn6282.style !== undefined && (rfBind16389.style = rfIn6282.style), rfIn6282.weight !== undefined && (rfBind16389.weight = rfIn6282.weight), rfIn6282.color !== undefined) {
...
export function borderSideFromPartial(rfIn8764: unknown) {
  ...
  return rfBind19286.style = rfIn8764.style, rfBind19286.weight = rfIn8764.weight, rfBind19286.color = rfIn8764.color ? rfIn8764.color.clone() : undefined, rfBind19286;
}
...
export function requireHorizontalAlignment(rfIn10608: unknown) {
  ...
  if (!rfBind21098) throw Error(`Unsupported horizontal alignment "${rfIn10608}".`);
  return rfBind21098;
}
...
export function requireVerticalAlignment(rfIn10663: unknown) {
  ...
  if (!rfBind21165) throw Error(`Unsupported vertical alignment "${rfIn10663}".`);
  return rfBind21165;
}
...
export function borderPresetEdges(rfIn4473: unknown) {
  switch (rfIn4473) {
    ...
    case "all":
      return ["top", "bottom", "left", "right", "insideHorizontal", "insideVertical"];
    case "doubleBottom":
      return ["bottom"];
    default:
      return [];
...
export function fillSolidColorFromFill(props: unknown) {
  ...
  if (rfBind15521.color) return new WorkbookColor({
    type: "proto",
    proto: rfBind15521.color
  });
  if (rfBind15521.pattern?.color) return new WorkbookColor({
    type: "proto",
    proto: rfBind15521.pattern.color
  });
  let rfBind15522 = rfBind15521.gradientStops?.[rfBind15521.gradientStops.length - 1];
  if (rfBind15522?.color) return new WorkbookColor({
    type: "proto",
