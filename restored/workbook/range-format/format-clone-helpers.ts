...
export function borderSideConfigFromSide(rfIn6967: unknown) {
  if (!rfIn6967) return;
  let rfBind17321 = {};
  return rfIn6967.style !== undefined && (rfBind17321.style = rfIn6967.style), rfIn6967.color && (rfBind17321.color = rfIn6967.color.clone()), rfIn6967.weight !== undefined && (rfBind17321.weight = rfIn6967.weight), Object.keys(rfBind17321).length > 0 ? rfBind17321 : undefined;
}
