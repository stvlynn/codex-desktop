...
export function reserveDataTablePlot(cplIn3747: any, cplIn3748: any, cplIn3749: any = {}) {
  ...
  let cplBind12455 = cplIn3749.maxHeightFrac ?? 0.3,
    ...
    cplBind12457 = Math.max(
      0,
      cplIn3748.height * cplBind12455,
    ),
    cplBind12458 = Math.max(cplBind12456, cplBind12457),
    cplBind12459 = Math.min(
      cplIn3748.height,
      cplBind12458,
    ),
    cplBind12460 = {
      ...
      y:
        cplIn3748.y +
        Math.max(0, cplIn3748.height - cplBind12459),
