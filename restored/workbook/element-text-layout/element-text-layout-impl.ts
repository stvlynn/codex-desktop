...
export function mergeInheritedShapeStyle(etlIn1260: any, etlIn1261: any) {
  ...
  for (let etlBind10315 of etlBind6837) {
    ...
    etlBind10491.fill !== undefined &&
      ((etlBind6842 = etlBind10491.fill),
      (etlBind6849 = etlBind10315));
    etlBind10491.line !== undefined &&
      (etlBind6843 = etlBind10491.line);
    etlBind10491.effects !== undefined &&
      (etlBind6844 = etlBind10491.effects);
...
export function buildElementTextLayoutMap(etlIn2137: any, etlIn2138: any) {
  ...
  return (
    etlIn2137.elements.items.forEach((item) => {
      ...
      if (!etlBind11079 || !etlBind11078.paragraphs?.length)
        return;
      let etlBind11080 = etlH.resolvePlaceholderTextStyle(
        ...
        etlBind11081 =
          etlBind11080?.wrap !== etlH.TEXT_WRAPPING_TYPE_NONE,
        etlBind11082 =
          etlBind11080?.autoFit?.normalAutoFit?.fontScale,
        etlBind11083 =
          typeof etlBind11082 == "number" &&
          Number.isFinite(etlBind11082)
            ? etlBind11082 / 1e5
            : 1,
      ...
      etlBind11085 &&
        etlBind9089.set(
          etlBind11079,
          summarizeTextLayout(etlBind11085),
        );
    }),
    etlBind9089
  );
...
export function resolveTextLayoutSource(etlIn9317: any, etlIn9318: any) {
  ...
  let etlBind19884 =
    etlIn9318.getInheritedPlaceholderShapes(etlIn9317);
