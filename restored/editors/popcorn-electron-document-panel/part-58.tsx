...
function _s(glideR9) {
  if (!(!glideR9 || glideR9.val === "nil")) return WorkbookW({
...
function bloomR1(marbleR6) {
  ...
  if (!(orbitR23.left === undefined && orbitR23.right === undefined && orbitR23.top === undefined && orbitR23.bottom === undefined)) return orbitR23;
}
...
function eagleR1(topazR7) {
  if (!(!topazR7 || topazR7.val === "nil")) return glideR1({
    val: topazR7.val,
    color: topazR7.fill,
...
function frostR1(violetR8) {
  if (violetR8.val !== "nil") return glideR1({
...
function js(yellowR5, zincR5) {
  zincR5.firstColumn && (yellowR5.cells.block({
    row: 0,
    column: 0,
    rowCount: yellowR5.rowCount,
    columnCount: 1
  }).textStyle.bold = true);
  zincR5.lastColumn && (yellowR5.cells.block({
    row: 0,
...
function orbitR1(acornR5, bloomR5) {
  ...
  for (let basaltR25 = nickelR23; basaltR25 <= onyxR23; basaltR25 += 1) (basaltR25 - nickelR23) % 2 == 0 && (acornR5.cells.block({
    row: basaltR25,
    column: 0,
    rowCount: 1,
...
function pineR1(emberR5, flintR5) {
  ...
  let alphaR23 = +!!flintR5.firstColumn,
    copperR23 = flintR5.lastColumn ? emberR5.columnCount - 2 : emberR5.columnCount - 1;
  for (let hazelR25 = alphaR23; hazelR25 <= copperR23; hazelR25 += 1) (hazelR25 - alphaR23) % 2 == 0 && (emberR5.cells.block({
    row: 0,
    column: hazelR25,
...
function ridgeR1(amberR11) {
  if (!(amberR11 === undefined || !Number.isFinite(amberR11) || amberR11 <= 0)) return amberR11;
}
function stormR1(mossR7, northR7 = {}) {
  ...
  return northR7.inline && (violetR25.left = undefined, violetR25.top = undefined), violetR25;
}
function tideR1(lotusR8, mintR8, novaR8) {
  let questR25 = valeR1(mintR8, novaR8);
  if (!(!lotusR8 && !apexR1(questR25))) return {
...
function unityR1(quartzR5, basaltR5, mintR5) {
  if (quartzR5?.wrap === "inline") return tideR1(quartzR5.alignment, quartzR5, mintR5);
  let valeR18 = basaltR5.left !== undefined || basaltR5.top !== undefined,
    brookR18 = mintR5?.spaceBefore !== undefined || mintR5?.spaceAfter !== undefined;
  if (!quartzR5?.wrap && !valeR18) return brookR18 ? tideR1(undefined, quartzR5, mintR5) : undefined;
  ...
  return {
    ...
    xOffsetEmu: basaltR5.left === undefined ? undefined : workbookP(basaltR5.left),
    yOffsetEmu: basaltR5.top === undefined ? undefined : workbookP(basaltR5.top),
    horizontalAlignment: basaltR5.left === undefined ? quartzR5?.horizontalAlignment ?? quartzR5?.alignment : quartzR5?.horizontalAlignment,
    ...
    distanceLeftEmu: quartzR5?.distanceLeft === undefined ? undefined : workbookP(quartzR5.distanceLeft),
    distanceRightEmu: quartzR5?.distanceRight === undefined ? undefined : workbookP(quartzR5.distanceRight),
...
function valeR1(kelpR5, lotusR5) {
  ...
  return {
    ...
    distanceBottomEmu: indigoR23 === undefined ? undefined : workbookP(indigoR23),
    distanceLeftEmu: kelpR5?.distanceLeft === undefined ? undefined : workbookP(kelpR5.distanceLeft),
    distanceRightEmu: kelpR5?.distanceRight === undefined ? undefined : workbookP(kelpR5.distanceRight)
  };
}
function apexR1(emberR8) {
  return emberR8.distanceTopEmu !== undefined || emberR8.distanceBottomEmu !== undefined || emberR8.distanceLeftEmu !== undefined || emberR8.distanceRightEmu !== undefined;
}
...
function duskR1(elmR5) {
  return elmR5 === "none" ? o.ELEMENT_WRAP_TYPE_NONE : elmR5 === "tight" ? o.ELEMENT_WRAP_TYPE_TIGHT : elmR5 === "through" ? o.ELEMENT_WRAP_TYPE_THROUGH : elmR5 === "topAndBottom" ? o.ELEMENT_WRAP_TYPE_TOP_AND_BOTTOM : o.ELEMENT_WRAP_TYPE_SQUARE;
}
...
function elmR1(yarnR10) {
  return Object.fromEntries(Object.entries(yarnR10).filter(([, cedarR13]) => cedarR13 !== undefined));
}
function fernR1(kelpR9) {
  return kelpR9 ? kelpR9.trim().toLowerCase().replace(/[^a-z0-9]+/g, "") === "tablegrid" : false;
}
var ridgeR25,
  $s,
  fernR25,
    ...
    harborR26 = class {
      ...
      add(zephyrR11) {
        ...
        let {
          ...
          waveR17 = valeR17.left !== undefined || valeR17.top !== undefined || valeR17.width !== undefined || valeR17.height !== undefined,
          apexR17 = {
            ...rest,
        ...
        let cliffR17 = typeof style == "string" ? {
            preset: style
          } : style,
        ...
        if (cliffR17) {
          ...
          pearlR23 ? brookR17.styleId = pearlR23 : quartzR23 ? brookR17.styleId = lotusR1(quartzR23) : preset && (brookR17.styleId = preset);
        ...
        fernR1(duskR17) && brookR17.rowCount > 0 && brookR17.columnCount > 0 && brookR17.cells.block({
          row: 0,
          column: 0,
        ...
        return elmR17 && jewelR1(brookR17, elmR17), columnWidths !== undefined && (brookR17.columnWidths = columnWidths), brookR17;
      }
    };
  });
...
function isleR1(vaporR6) {
  ...
  if (pearlR24 instanceof ArrayBuffer && vaporR6.byteOffset === 0 && vaporR6.byteLength === pearlR24.byteLength) return pearlR24;
  ...
  oliveR26 = esmInit(() => {
    ...
    daisyR26 = class {
      ...
      add(nickelR6) {
        ...
        return stormR23.placement = unityR1(nickelR6.style, pineR23, {
...
function alphaR2(timberR6) {
  ...
  return timberR6.style?.wrap === "inline" && (apexR23.left = undefined, apexR23.top = undefined), apexR23;
}
var acornR26,
  lunarR26 = esmInit(() => {
    glideR25();
    acornR26 = class {
      ...
      add(ivoryR4) {
        ...
        return ivoryR4.text !== undefined && (ridgeR21.text = ivoryR4.text), ridgeR21.placement = unityR1(ivoryR4.style, pineR21, {
