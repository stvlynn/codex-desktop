...
function brook(frostR13) {
  ...
  let reefR20 = false,
    sageR20 = quillR20.rows.map((item) => {
      let ultraR21 = false,
        vaporR21 = item.cells.map((_item) =>
          _item.marginLeft === alphaR21.leftEmu &&
          _item.marginRight === alphaR21.rightEmu &&
          _item.marginTop === alphaR21.topEmu &&
          _item.marginBottom === alphaR21.bottomEmu
            ? ((ultraR21 = true),
              {
                ..._item,
...
function grove(frostR9) {
  return [
    frostR9.layoutMode ?? "paged",
    frostR9.pagelessMinHeightPx ?? "default-min-height",
  ].join(":");
}
...
function copperR1(wheatR10) {
  if (!(wheatR10 === undefined || !Number.isFinite(wheatR10)))
    return Math.round(wheatR10 * 100) / 100;
}
...
function falconR1(isleR3) {
  ...
  for (let [bloomR18, coralR18] of isleR3.entries()) {
    let questR18 = coralR18.paragraphStyle,
      ridgeR18 = (questR18?.tabStops ?? [])
        .map((item) => echoR1(item.position))
      ...
      stormR18 = {
        ...
        marginLeftPx:
          deltaR1(coralR18.marginLeft) ?? echoR1(questR18?.marginLeft),
    ...
    (stormR18.bulletCharacter !== undefined ||
      stormR18.autoNumberType !== undefined ||
      stormR18.autoNumberStartAt !== undefined ||
      stormR18.directMarginLeftTwips !== undefined ||
      stormR18.directIndentTwips !== undefined ||
      stormR18.styleMarginLeftEmu !== undefined ||
      stormR18.styleIndentEmu !== undefined ||
      stormR18.spaceBeforeTwips !== undefined ||
      stormR18.spaceAfterTwips !== undefined ||
      stormR18.lineSpacingPercent !== undefined ||
      stormR18.tabStopsPx !== undefined) &&
      prismR18.push(stormR18);
  }
...
function jadeR1(timberR11, umbraR11) {
  return alphaR1(
    timberR11.left - umbraR11.left,
    timberR11.top - umbraR11.top,
    timberR11.width,
    timberR11.height,
  );
}
...
function lemonR1(topazR4, ultraR4) {
  ...
  return {
    ...
    gradientStopCount:
      topazR4.gradientStops && topazR4.gradientStops.length > 0
        ? topazR4.gradientStops.length
        : undefined,
...
function nickelR1(wheatR6, yarnR6) {
  if (wheatR6)
    return {
      ...
      widthPx:
        wheatR6.widthEmu === undefined
          ? undefined
          : copperR1(wheatR6.widthEmu * workbookE),
      color:
        wheatR6.fill?.color && yarnR6
          ? workbookSt(wheatR6.fill.color, yarnR6)
          : undefined,
...
function onyxR1(frostR3) {
  ...
  if (stormR20)
    return {
      ...
      columnFrame: stormR20.columnFrame
        ? indigoR1(stormR20.columnFrame)
        : undefined,
...
function slateR1(
  ...
  orbitR3 = 0,
  pineR3 = 0,
  questR3 = mossR3.topY ?? 0,
) {
  let waveR20 = mossR3.segments.map((item, index) =>
    quartzR1(item, index, mossR3, orbitR3, pineR3, questR3),
  );
  return {
    index: northR3 + 1,
...
function violetR1(ultraR9) {
  let irisR26 = new Map();
  for (let oliveR14 of ultraR9.cellLayouts ?? [])
    irisR26.set(
      umbraR1(oliveR14.row, oliveR14.col),
      timberR1(oliveR14.block.lines),
    );
  return irisR26;
}
...
function xenonR1(novaR4) {
  ...
  let cliffR21 = {
    left:
      novaR4.marginLeft === undefined
        ? undefined
        : copperR1(novaR4.marginLeft * workbookE),
    right:
      novaR4.marginRight === undefined
        ? undefined
        : copperR1(novaR4.marginRight * workbookE),
    top:
      novaR4.marginTop === undefined
        ? undefined
        : copperR1(novaR4.marginTop * workbookE),
    bottom:
      novaR4.marginBottom === undefined
        ? undefined
        : copperR1(novaR4.marginBottom * workbookE),
  };
  return cliffR21.left !== undefined ||
    cliffR21.right !== undefined ||
    cliffR21.top !== undefined ||
    cliffR21.bottom !== undefined
    ? cliffR21
    : undefined;
}
function yellowR1(bloomR13, yarnR3, jewelR3, unityR3) {
  ...
  let willowR18 = violetR1(violetR18),
    ...
    zincR18 = violetR18.rowHeightsPx.map((item, index) => {
      let hillR19 = violetR18.cellRects
          ...
          .map((_item) => {
            ...
            return {
              ...
              elementFrames:
                glideR20 && glideR20.length > 0 ? glideR20 : undefined,
            };
          }),
        isleR19 = {
          index: index + 1,
...
function _o(kiteR6, willowR6, hazelR6, sageR6, eagleR6, pineR6, duskR6) {
  let basaltR19 = pearlR1(kiteR6),
    cedarR19 = kiteR6.textLines
      ? timberR1(kiteR6.textLines, kiteR6.xPx, kiteR6.yPx)
      : undefined,
  ...
  return {
    ...
    tableColumns: Math.max(
      0,
      ...(kiteR6.element.table?.rows.map(
        (jasperR13) => jasperR13.cells.length,
      ) ?? [0]),
    ),
    tableLayout:
      pineR6 && duskR6 ? yellowR1(kiteR6, pineR6, duskR6, eagleR6) : undefined,
    children: (kiteR6.children ?? []).map((item, index) =>
      _o(
        item,
        willowR6,
        `${hazelR6}.children.${index + 1}`,
        index + 1,
        eagleR6,
        pineR6,
        duskR6,
...
function amberR1(lotusR10, mintR10, novaR10, oliveR10, prismR10) {
  return lotusR10.map((item, index) =>
    _o(
      item,
      mintR10,
      `${mintR10}.${index + 1}`,
