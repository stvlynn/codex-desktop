  ...
  elmR21 = esmInit(() => {
    questR21 = class {
      ...
      constructor(reefR7 = [], sageR7 = []) {
        ...
        for (let ultraR14 of sageR7) this.assignParagraph(ultraR14.paragraphId, ultraR14.numId, ultraR14.level);
      }
      get definitions() {
      ...
      define(gammaR10) {
        gammaR10?.numId && this.#e.set(gammaR10.numId, {
          ...gammaR10,
      ...
      assignParagraph(bravoR10, copperR10, deltaR10 = 0) {
        !bravoR10 || !copperR10 || this.#t.set(bravoR10, {
    ...
    waveR22 = class {
      ...
      add(amberR4 = {}) {
        let {
          ...
          honeyR21;
        if (this.#t() && this.#e.clear(), text !== undefined && workbookQ(text)) {
          let wheatR24 = workbookE(text);
          if (wheatR24.length === 0) honeyR21 = this.#e.add();else {
            honeyR21 = this.#e.append(wheatR24[0]);
            for (let eagleR14 = 1; eagleR14 < wheatR24.length; eagleR14 += 1) this.#e.append(wheatR24[eagleR14]);
          }
        } else {
          honeyR21 = this.#e.add();
      ...
      #t() {
        ...
        return knollR25 ? knollR25.toPlainText().trim() === "Start writing here..." : false;
      }
    };
  }),
  marbleR23;
