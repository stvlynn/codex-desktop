...
const bloomR1: any = undefined;
const c: any = undefined;
const coralR1: any = undefined;
const daisyR24: any = undefined;
const driftR1: any = undefined;
const eagleR1: any = undefined;
const elmR23: any = undefined;
const f: any = undefined;
const frostR23: any = undefined;
const gammaR24: any = undefined;
const glideR1: any = undefined;
const ivoryR23: any = undefined;
const marbleR23: any = undefined;
const marbleR25: any = undefined;
const questR23: any = undefined;
const slateR24: any = undefined;
const topazR23: any = undefined;
...
function jasperR1(ridgeR11) {
  return Object.prototype.hasOwnProperty.call(lunarR24, ridgeR11);
}
function kelpR1(brookR5) {
  return {
    id: brookR5.styleId,
    name: brookR5.name,
...
function lotusR1(gammaR13) {
  return acornR24[gammaR13].styleId;
}
function mintR1(topazR10) {
  switch (topazR10) {
    case "wholeTable":
...
function os(eagleR13) {
  let garnetR20 = reefR1(eagleR13.tcPr?.shading),
    hazelR20 = coralR1(eagleR13.tcPr?.margins?.left),
    ivoryR20 = coralR1(eagleR13.tcPr?.margins?.right),
    jasperR20 = coralR1(eagleR13.tcPr?.margins?.top),
    kelpR20 = coralR1(eagleR13.tcPr?.margins?.bottom),
    lotusR20 = fs(eagleR13.tcPr?.borders),
...
function topazR1(brookR6) {
  if (!brookR6) return;
  let topazR24 = {
    top: yarnR1(brookR6.top),
    right: yarnR1(brookR6.right),
...
function ultraR1(violetR7) {
  if (!violetR7) return;
  let duskR24 = {
    top: yarnR1(violetR7.top),
    right: yarnR1(violetR7.right),
