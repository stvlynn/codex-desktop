...
export var _pluginDetailPageC = esmInit(() => {});
export function _pluginDetailPageI({ localVersion, shareContext }: unknown) {
  return (
    localVersion != null &&
    shareContext?.remotePluginId != null &&
    shareContext.remoteVersion != null &&
    compareSemver(localVersion, shareContext.remoteVersion) > 0
  );
}
