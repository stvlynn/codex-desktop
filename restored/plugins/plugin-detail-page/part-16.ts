...
export function pluginDetailPageK(garnet3: unknown) {
  return garnet3.reduce((accumulator, current) => (current.isAccessible ? accumulator.installedApps.push(current) : accumulator.discoverApps.push(current), accumulator), {
    installedApps: [],
    discoverApps: []
  });
}
