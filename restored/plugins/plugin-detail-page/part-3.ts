...
export function pluginDetailPageHt(dew1: unknown) {
  ...
  let {
    ...
    copper2 = falcon2 => canonicalizeWorkspacePathKey("save-plugin-share", {
      hostId: hostId,
      ...falcon2
    });
  let delta2 = () => {
...
function Copper(gamma2) {
  ...
  let {
    ...
    jade2 = marble2 => canonicalizeWorkspacePathKey("delete-plugin-share", {
      hostId: hostId,
      ...marble2
    });
  let kite2 = () => {
...
function Delta(nickel2) {
  return nickel2.flatMap(item => item.principal_type === "workspace" ? [] : [{
