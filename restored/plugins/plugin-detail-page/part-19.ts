...
const pluginDetailPageCt: any = undefined;
const pluginDetailPageH: any = undefined;
const remoteSshConnections: any = undefined;
export var pluginDetailPageN = esmInit(() => {
  $o = reactCompilerRuntime();
  kelp = commonJsInit(ght(), 1);
  ensureComposerEsm_MT_Init();
...
var $o, kelp, lotus, mint;
export function _pluginDetailPageJ(quiet3: unknown) {
  let rain3 = remoteControlHostKey(quiet3);
  return rain3 == null ||
    (!isOpenaiBundledId(rain3) && rain3 !== "openai-primary-runtime")
    ? null
    : `${as}/${encodeURIComponent(quiet3)}`;
}
