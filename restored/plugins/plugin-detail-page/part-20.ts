...
export var pluginDetailPageM = esmInit(() => {
  strongMarkerFromOptions();
  as = `${new URL(lazyWithSuspense).origin}/plugins/share`;
});
var as;
function Nova(seed3) {
  let {
    ...
    urn3 = useIntl(),
    vine3 = usePrefersReducedMotion(),
    wind3 = blockedReason === "disabled-by-admin",
    yarrow3 = installProgressPercent != null,
    azure3 = isInstalled && !yarrow3,
    birch3 = !azure3 && blockedReason === "connector-unavailable",
    canyon3;
  if (yarrow3) {
    let copper4 = <CircularProgressRing {...{
      percent: installProgressPercent,
      reducedMotion: vine3,
      size: 16,
      transitionDurationMs: 500
    }} />;
    let delta4 = installPhase === "installing" ? <MemoizedFormattedMessage {...{
    ...
    let echo4;
    echo4 = <ReadLoginRouteQuerySnapshot {...{
      className: "disabled:opacity-100",
      color: "primary",
      disabled: true,
      size: "toolbar",
      children: [copper4, delta4]
    }} />;
    canyon3 = echo4;
  } else if (wind3) {
    let falcon4;
    falcon4 = <ReadLoginRouteQuerySnapshot {...{
      color: "primary",
      disabled: true,
      size: "toolbar",
      children: [<AppIconIt {...{
    ...
    let gamma4 = isEnabled ? trail3 : onEnable,
      harbor4 = !isUpdatingEnabled && isEnabled ? <AppIconDG {...{
        className: "icon-xs"
      }} /> : null;
    let indigo4 = isEnabled ? <MemoizedFormattedMessage {...{
    ...
    let jade4;
    jade4 = <ReadLoginRouteQuerySnapshot {...{
      color: "primary",
      disabled: isUninstalling,
      loading: isUpdatingEnabled,
      onClick: gamma4,
      size: "toolbar",
      children: [harbor4, indigo4]
    }} />;
    canyon3 = jade4;
  } else {
    let kite4 = blockedReason != null || isInstallBlockedLoading || isInstallLocked,
      lemon4,
      marble4;
    lemon4 = <EnsureComposerEsm_Wlt_Init {...{
      className: "icon-xs"
    }} />;
    marble4 = <MemoizedFormattedMessage {...{
      id: "plugins.detail.install",
      defaultMessage: "Install plugin",
      description: "Primary install action on the plugin detail page"
    }} />;
    let nickel4;
    nickel4 = <ReadLoginRouteQuerySnapshot {...{
      color: "primary",
      disabled: kite4,
      onClick: onInstall,
      size: "toolbar",
      children: [lemon4, marble4]
    }} />;
    canyon3 = nickel4;
  }
  let dew3 = azure3 ? <DropdownMenuPopover {...{
    align: "end",
    contentWidth: "sm",
    triggerButton: <CoerceLocalFilesystemPath {...{
      label: urn3.formatMessage({
        id: "plugins.detail.moreActions",
        defaultMessage: "More actions",
        description: "Aria label for the plugin detail page overflow menu"
      })
    }} />,
    children: [onShare == null ? null : <DropdownMenu.Item {...{
      LeftIcon: AppInitialUO,
      ...
      LeftIcon: deferredConversationWH3,
      leftIconClassName: "icon-xs",
      onSelect: onManage,
      children: <MemoizedFormattedMessage {...{
    ...
    }} />, onShare == null ? null : <DropdownMenu.Separator {...{}} />, <DropdownMenu.Item {...{
      LeftIcon: AppIconBO,
      className: "!text-token-error-foreground",
      disabled: isUpdatingEnabled || isUninstalling || isInstalledByDefault,
      leftIconClassName: "icon-xs text-token-error-foreground",
      onSelect: onUninstall,
      children: isInstalledByDefault ? <MemoizedFormattedMessage {...{
  ...
  let alpha4 = birch3 ? <OptionalTooltip {...{
  ...
  let bravo4 = <_pluginDetailPageK {...{
    measurement: canyon3,
    reducedMotion: vine3,
    children: alpha4
  }} />;
  return <div className="flex flex-wrap items-center justify-end gap-2">{dew3}{shareActions}{bravo4}</div>;
}
export function _pluginDetailPageK(onyx4: unknown) {
  let {
      children,
      measurement,
      reducedMotion
    } = onyx4,
    [pearl4, quartz4] = reuseArrayIfShallowEqual(),
    river4 = <div ref={pearl4} className="pointer-events-none invisible fixed top-0 left-0 min-w-max" aria-hidden={true} inert={true}>{measurement}</div>;
  let slate4 = quartz4 ?? "auto",
    timber4 = {
      width: slate4
    };
  let umbra4 = reducedMotion ? 0 : 0.18,
    violet4 = [0.77, 0, 0.175, 1];
  let willow4 = {
    duration: umbra4,
    ease: violet4
  };
  let xenon4 = <EnsureIntlFormattersInit.div {...{
    animate: timber4,
