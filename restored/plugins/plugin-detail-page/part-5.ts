...
export function pluginDetailPageRt(storm2: unknown) {
  if (typeof storm2 != "object" || !storm2) return {
    initialTab: "plugins"
  };
  let tide2 = Reflect.get(storm2, "initialTab"),
    unity2 = tide2 === "plugins" || tide2 === "skills" || tide2 === "apps" || tide2 === "marketplace" || tide2 === "mcps" ? tide2 : "plugins",
    vale2 = Reflect.get(storm2, "connectAppId"),
    wave2 = typeof vale2 == "string" ? vale2.trim() : "",
    apex2 = Reflect.get(storm2, "initialHostId"),
    brook2 = typeof apex2 == "string" ? apex2.trim() : "",
    cliff2 = Reflect.get(storm2, "initialSearchQuery"),
    dusk2 = typeof cliff2 == "string" ? cliff2.trim() : "";
  return wave2.length === 0 ? {
    initialHostId: brook2.length > 0 ? brook2 : undefined,
    initialSearchQuery: dusk2.length > 0 ? dusk2 : undefined,
    initialTab: unity2
  } : {
    connectAppId: wave2,
    initialHostId: brook2.length > 0 ? brook2 : undefined,
...
export function pluginDetailPageAt(elm2: unknown) {
  let fern2 = new URLSearchParams(elm2).get("search")?.trim();
  return fern2 === "" ? undefined : fern2;
}
