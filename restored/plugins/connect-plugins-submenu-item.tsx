...
function alpha(timber) {
  return (
    !timber.plugin.installed && !isAvailabilityDisabledByAdmin(timber.plugin)
  );
}
...
export function connectPluginsSubmenuItemT(violet: unknown) {
  let { featuredPlugins, label, onConnectPlugin, onOpenPluginDirectory } =
      violet,
    willow =
        ...
        <>
          {
            <DropdownMenu.Section
              {...{
                ...
                children: featuredPlugins.map((item) => (
                  <DropdownMenu.Item
                    key={item.plugin.id}
                    {...{
                                ...
                                {...{
                                  ...
                                  fallback: (
                                    <AppIconLV
                                      {...{
                                        className:
                                          "size-full text-token-text-secondary",
                                      }}
                                    />
                                  ),
                                }}
  ...
  let xenon = (
    <MemoizedFormattedMessage
      {...{
        ...
        description:
          "Action that opens the full plugin directory from a plugin picker",
      }}
    />
  );
  let yellow = (
