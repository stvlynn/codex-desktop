...
// vendored re-export boundary for React CJS interop (react / jsx-runtime /
// compiler-runtime / react-dom / react-is). Stock packages stay npm-backed; this
// boundary only wraps the bundle's `alias()` call shape.
