...
// Stage-3 wave-13: map widgets Helper182–207+Value273, pie Value182–197, forecast/file Value234–239 drained. Residual: Helper243 router + peer surfaces.
...
function useChatgptComposerControllerHelper114(
  useChatgptComposerControllerParam497,
) {
  const UseChatgptComposerControllerHelper65 =
    useChatgptComposerControllerHelper65;
  let { product } = useChatgptComposerControllerParam497,
    useChatgptComposerControllerValue2712 =
      useChatgptComposerControllerHelper31(),
    useChatgptComposerControllerValue2713 =
      useChatgptComposerControllerHelper116(product);
  let useChatgptComposerControllerValue2714 =
      useChatgptComposerControllerValue2713,
    useChatgptComposerControllerValue2715 =
      useChatgptComposerControllerHelper115(product);
  let useChatgptComposerControllerValue2716 =
      useChatgptComposerControllerValue2715,
    useChatgptComposerControllerValue2717 =
      useChatgptComposerControllerHelper118(product.featured_tag) ??
      useChatgptComposerControllerHelper118(product.description);
  let useChatgptComposerControllerValue2718 =
      useChatgptComposerControllerValue2717,
    useChatgptComposerControllerValue2719 =
      useChatgptComposerControllerHelper118(product.price);
  let useChatgptComposerControllerValue2720 =
      useChatgptComposerControllerValue2719,
    useChatgptComposerControllerValue2721 =
      useChatgptComposerControllerHelper118(product.merchants);
  let useChatgptComposerControllerValue2722 =
      useChatgptComposerControllerValue2721,
    useChatgptComposerControllerValue2723 =
      useChatgptComposerControllerHelper117(product);
  let useChatgptComposerControllerValue2724 =
      useChatgptComposerControllerValue2723,
    useChatgptComposerControllerValue2725 =
      product.showcase_metadata?.background?.primary,
    useChatgptComposerControllerValue2726 =
      useChatgptComposerControllerHelper118(
        useChatgptComposerControllerValue2725,
      );
  let useChatgptComposerControllerValue2727 =
      useChatgptComposerControllerValue2726,
    useChatgptComposerControllerValue2728 =
      useChatgptComposerControllerValue2727 == null
        ? undefined
        : {
            backgroundColor: useChatgptComposerControllerValue2727,
          };
  let useChatgptComposerControllerValue2729 =
    useChatgptComposerControllerValue2714 != null &&
    useChatgptComposerControllerValue2712?.shouldBlockExternalEgress !==
      true ? (
      <img
        alt={product.title}
        className="absolute inset-0 m-0 h-full w-full object-contain"
        src={useChatgptComposerControllerValue2714}
      />
    ) : (
      <div className="absolute inset-0" aria-hidden={true} />
    );
  let useChatgptComposerControllerValue2730 = (
    <div
      className="relative aspect-[13/16] w-full overflow-clip rounded-xl bg-[#F3F3F3] dark:bg-[#F3F3F3]"
      style={useChatgptComposerControllerValue2728}
    >
      {useChatgptComposerControllerValue2729}
    </div>
  );
  let useChatgptComposerControllerValue2731 = (
    <div className="line-clamp-2 text-sm font-medium text-token-foreground">
      {product.title}
    </div>
  );
  let useChatgptComposerControllerValue2732 =
    useChatgptComposerControllerValue2718 == null ? null : (
      <div className="line-clamp-2 text-sm text-token-text-secondary">
        {useChatgptComposerControllerValue2718}
      </div>
    );
  let useChatgptComposerControllerValue2733 =
    useChatgptComposerControllerValue2720 != null ||
    useChatgptComposerControllerValue2722 != null ? (
      <div className="flex min-w-0 gap-1 text-sm text-token-text-secondary">
        {useChatgptComposerControllerValue2720 == null ? null : (
          <span>{useChatgptComposerControllerValue2720}</span>
        )}
        {useChatgptComposerControllerValue2720 != null &&
        useChatgptComposerControllerValue2722 != null ? (
          <span aria-hidden={true}>{useChatgptComposerControllerValue121}</span>
        ) : null}
        {useChatgptComposerControllerValue2722 == null ? null : (
          <span className="truncate">
            {useChatgptComposerControllerValue2722}
          </span>
        )}
      </div>
    ) : null;
  let useChatgptComposerControllerValue2734 =
    useChatgptComposerControllerValue2724 == null ? null : (
      <div className="text-sm text-token-text-secondary">
        {useChatgptComposerControllerValue2724}
      </div>
    );
  let useChatgptComposerControllerValue2735 = (
    <div className="flex min-w-0 flex-col gap-1 px-1">
      {useChatgptComposerControllerValue2731}
      {useChatgptComposerControllerValue2732}
      {useChatgptComposerControllerValue2733}
      {useChatgptComposerControllerValue2734}
    </div>
  );
  let useChatgptComposerControllerValue2736 = (
    <>
      {useChatgptComposerControllerValue2730}
      {useChatgptComposerControllerValue2735}
    </>
  );
  let useChatgptComposerControllerValue2737 =
    useChatgptComposerControllerValue2736;
  if (useChatgptComposerControllerValue2716 == null) {
    let useChatgptComposerControllerValue12910;
    return (
      <div
        className="flex w-[10.5rem] shrink-0 snap-start flex-col gap-2 pb-2"
        data-testid="chatgpt-product-card"
      >
        {useChatgptComposerControllerValue2737}
      </div>
    );
  }
  return (
    <UseChatgptComposerControllerHelper65
      ...
      data-testid="chatgpt-product-card"
      href={useChatgptComposerControllerValue2716}
...
function useChatgptComposerControllerHelper115(
  useChatgptComposerControllerParam7833,
) {
  let useChatgptComposerControllerValue14116 =
      useChatgptComposerControllerParam7833.offers?.find(
        (useChatgptComposerControllerParam11316) => {
          return (
            useChatgptComposerControllerParam11316.available === true &&
            useChatgptComposerControllerHelper118(
              useChatgptComposerControllerParam11316.url,
            ) != null
          );
        },
      ),
    useChatgptComposerControllerValue14117 =
      useChatgptComposerControllerParam7833.offers?.find(
        (useChatgptComposerControllerParam11581) => {
          return (
            useChatgptComposerControllerHelper118(
              useChatgptComposerControllerParam11581.url,
            ) != null
          );
        },
      ),
    useChatgptComposerControllerValue14118 =
      useChatgptComposerControllerHelper118(
        useChatgptComposerControllerValue14116?.url,
      ) ??
      useChatgptComposerControllerHelper118(
        useChatgptComposerControllerValue14117?.url,
      ) ??
      useChatgptComposerControllerHelper118(
        useChatgptComposerControllerParam7833.url,
      );
  return useChatgptComposerControllerValue14118 == null
    ? null
    : (_appInitialIL(useChatgptComposerControllerValue14118) ?? null);
}
function useChatgptComposerControllerHelper116(
  useChatgptComposerControllerParam9176,
) {
  let useChatgptComposerControllerValue15141 =
    useChatgptComposerControllerHelper118(
      useChatgptComposerControllerParam9176.showcase_metadata?.image?.url,
    ) ??
    useChatgptComposerControllerParam9176.image_urls?.find(
      (useChatgptComposerControllerParam11662) => {
        return AppInitialAL(useChatgptComposerControllerParam11662);
      },
    );
  return useChatgptComposerControllerValue15141 == null
    ? null
    : (AppInitialAL(useChatgptComposerControllerValue15141) ?? null);
}
function useChatgptComposerControllerHelper117(
  useChatgptComposerControllerParam8535,
) {
  if (useChatgptComposerControllerParam8535.rating == null) return null;
  let useChatgptComposerControllerValue14587 =
    useChatgptComposerControllerValue119.format(
      useChatgptComposerControllerParam8535.rating,
    );
  return useChatgptComposerControllerParam8535.num_reviews == null ||
    useChatgptComposerControllerParam8535.num_reviews < 100
    ? useChatgptComposerControllerValue14587
    : `${useChatgptComposerControllerValue14587} (${useChatgptComposerControllerValue120.format(useChatgptComposerControllerParam8535.num_reviews)})`;
}
function useChatgptComposerControllerHelper118(
  useChatgptComposerControllerParam10564,
) {
  let useChatgptComposerControllerValue15801 =
    useChatgptComposerControllerParam10564?.trim();
  return useChatgptComposerControllerValue15801 == null ||
    useChatgptComposerControllerValue15801.length === 0
    ? null
    : useChatgptComposerControllerValue15801;
}
var useChatgptComposerControllerValue117,
  useChatgptComposerControllerValue118,
  useChatgptComposerControllerValue119,
  useChatgptComposerControllerValue120,
  useChatgptComposerControllerValue121,
  useChatgptComposerControllerValue122 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue117 = appInitialIvt();
    AppInitialOL();
    useChatgptComposerControllerValue85();
    useChatgptComposerControllerValue43();
    useChatgptComposerControllerValue118 = appInitialJvt();
    useChatgptComposerControllerValue119 = new Intl.NumberFormat(undefined, {
      maximumFractionDigits: 1,
      minimumFractionDigits: 1,
    });
    useChatgptComposerControllerValue120 = new Intl.NumberFormat(undefined, {
...
function useChatgptComposerControllerHelper119(
  useChatgptComposerControllerParam2822,
) {
  let { reference } = useChatgptComposerControllerParam2822,
    useChatgptComposerControllerValue7710,
    useChatgptComposerControllerValue7711,
    useChatgptComposerControllerValue7712,
    useChatgptComposerControllerValue7713,
    useChatgptComposerControllerValue7714;
  useChatgptComposerControllerValue7714 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    let useChatgptComposerControllerValue13640 = appInitialPI(reference);
    if (useChatgptComposerControllerValue13640.length === 0) {
      useChatgptComposerControllerValue7714 = null;
      break bb0;
    }
    useChatgptComposerControllerValue7712 = "my-3";
    useChatgptComposerControllerValue7713 = "chatgpt-product-carousel";
    useChatgptComposerControllerValue7710 =
      "hide-scrollbar flex snap-x snap-mandatory gap-3 overflow-x-auto py-1";
    useChatgptComposerControllerValue7711 =
      useChatgptComposerControllerValue13640.map(
        useChatgptComposerControllerHelper120,
      );
  }
  if (
    useChatgptComposerControllerValue7714 !==
    ...
    return useChatgptComposerControllerValue7714;
  let useChatgptComposerControllerValue7715 = (
    <div className={useChatgptComposerControllerValue7710}>
      {useChatgptComposerControllerValue7711}
    </div>
  );
  return (
    <div
      className={useChatgptComposerControllerValue7712}
      data-testid={useChatgptComposerControllerValue7713}
    >
      {useChatgptComposerControllerValue7715}
    </div>
  );
}
function useChatgptComposerControllerHelper120(
  useChatgptComposerControllerParam10252,
  useChatgptComposerControllerParam10253,
) {
  ...
  return (
    <UseChatgptComposerControllerHelper114
      key={
        useChatgptComposerControllerParam10252.id ??
        `${useChatgptComposerControllerParam10252.title}-${String(useChatgptComposerControllerParam10253)}`
      }
      product={useChatgptComposerControllerParam10252}
    />
  );
}
var useChatgptComposerControllerValue123,
  useChatgptComposerControllerValue124,
  useChatgptComposerControllerValue125 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue123 = appInitialIvt();
    _appInitialYI();
    useChatgptComposerControllerValue122();
    useChatgptComposerControllerValue124 = appInitialJvt();
  });
function useChatgptComposerControllerHelper121(
  useChatgptComposerControllerParam5523,
) {
  let { reference } = useChatgptComposerControllerParam5523,
    useChatgptComposerControllerValue11804 = _AppInitialNI(reference);
  let useChatgptComposerControllerValue11805 =
    useChatgptComposerControllerValue11804;
  return useChatgptComposerControllerValue11805 == null ? null : (
    <span className="rounded bg-token-bg-secondary px-0.5">
      {useChatgptComposerControllerValue11805}
    </span>
  );
}
var useChatgptComposerControllerValue126,
  useChatgptComposerControllerValue127,
  useChatgptComposerControllerValue128 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue126 = appInitialIvt();
    _appInitialYI();
    useChatgptComposerControllerValue127 = appInitialJvt();
  });
function useChatgptComposerControllerHelper122(
  useChatgptComposerControllerParam2376,
) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const UseChatgptComposerControllerHelper64 =
    useChatgptComposerControllerHelper64;
  let { reference } = useChatgptComposerControllerParam2376,
    useChatgptComposerControllerValue6890 =
      useChatgptComposerControllerHelper76(reference.expression);
  let useChatgptComposerControllerValue6891 =
      useChatgptComposerControllerValue6890,
    useChatgptComposerControllerValue6892 =
      useChatgptComposerControllerHelper76(reference.result);
  let useChatgptComposerControllerValue6893 =
    useChatgptComposerControllerValue6892;
  if (
    useChatgptComposerControllerValue6891 == null &&
    useChatgptComposerControllerValue6893 == null
  ) {
    let useChatgptComposerControllerValue15024;
    return <UseChatgptComposerControllerHelper68 reference={reference} />;
  }
  let useChatgptComposerControllerValue6894 =
    useChatgptComposerControllerValue6891 == null ? null : (
      <div className="font-mono text-sm text-token-text-secondary">
        {useChatgptComposerControllerValue6891}
      </div>
    );
  let useChatgptComposerControllerValue6895 =
    useChatgptComposerControllerValue6893 == null ? null : (
      <div className="mt-1 text-2xl font-semibold text-token-text-primary">
        {useChatgptComposerControllerHelper76(reference.prefix)}
        {useChatgptComposerControllerValue6893}
        {useChatgptComposerControllerHelper76(reference.suffix)}
      </div>
    );
  return (
    <UseChatgptComposerControllerHelper64>
      {useChatgptComposerControllerValue6894}
      {useChatgptComposerControllerValue6895}
    </UseChatgptComposerControllerHelper64>
  );
}
var useChatgptComposerControllerValue129,
  useChatgptComposerControllerValue130,
  useChatgptComposerControllerValue131 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue129 = appInitialIvt();
    useChatgptComposerControllerValue81();
    useChatgptComposerControllerValue88();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue130 = appInitialJvt();
  });
function useChatgptComposerControllerHelper123(
  useChatgptComposerControllerParam3123,
) {
  let { isTerminalInline, reference } = useChatgptComposerControllerParam3123,
    useChatgptComposerControllerValue8290,
    useChatgptComposerControllerValue8291;
  useChatgptComposerControllerValue8291 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    let useChatgptComposerControllerValue11393 = appInitialEI(reference);
    if (useChatgptComposerControllerValue11393.length === 0) {
      useChatgptComposerControllerValue8291 = null;
      break bb0;
    }
    let useChatgptComposerControllerValue11394;
    useChatgptComposerControllerValue11394 = (
      useChatgptComposerControllerParam7411,
      useChatgptComposerControllerParam7412,
    ) => {
      const UseChatgptComposerControllerHelper24 =
        useChatgptComposerControllerHelper24;
      return (
        <UseChatgptComposerControllerHelper24
          key={`${useChatgptComposerControllerParam7411.attributes.url}-${String(useChatgptComposerControllerParam7412)}`}
          attributes={useChatgptComposerControllerParam7411.attributes}
          isTerminalInline={isTerminalInline}
          sources={useChatgptComposerControllerParam7411.sources}
        />
      );
    };
    useChatgptComposerControllerValue8290 =
      useChatgptComposerControllerValue11393.map(
        useChatgptComposerControllerValue11394,
      );
  }
  if (
    ...
    return useChatgptComposerControllerValue8291;
  return <>{useChatgptComposerControllerValue8290}</>;
}
setChatgptContentReferenceFootnoteRenderer(useChatgptComposerControllerHelper123);
...
var useChatgptComposerControllerValue178,
  ...
  useChatgptComposerControllerValue181 = rolldownRuntimeN(() => {
    ...
    useChatgptComposerControllerValue196 = chartWidgetStoresP;
  });
...
function useChatgptComposerControllerHelper179(
  useChatgptComposerControllerParam4637,
) {
  const AppInitialQL = appInitialQL;
  let { reference } = useChatgptComposerControllerParam4637,
    useChatgptComposerControllerValue10710 = appInitialJft(),
    useChatgptComposerControllerValue10711 =
      _AppInitialOI(reference) ??
      useChatgptComposerControllerValue10710.formatMessage({
        id: "chatgpt.contentReferences.code.label",
        defaultMessage: "Code",
        description: "Fallback label for a code execution citation",
      });
  let useChatgptComposerControllerValue10712 =
    useChatgptComposerControllerValue10711;
  return (
    <AppInitialQL icon={appInitialMH}>
      {useChatgptComposerControllerValue10712}
    </AppInitialQL>
  );
}
...
function useChatgptComposerControllerHelper180(
  useChatgptComposerControllerParam3133,
) {
  const UseChatgptComposerControllerHelper70 =
    useChatgptComposerControllerHelper70;
  let { reference } = useChatgptComposerControllerParam3133,
    useChatgptComposerControllerValue8320 = _AppInitialOI(reference);
  let useChatgptComposerControllerValue8321 =
      useChatgptComposerControllerValue8320,
    useChatgptComposerControllerValue8322 = E_(reference);
  let useChatgptComposerControllerValue8323 =
    useChatgptComposerControllerValue8322;
  if (useChatgptComposerControllerValue8321 == null) {
    let useChatgptComposerControllerValue15028;
    return <UseChatgptComposerControllerHelper70 reference={reference} />;
  }
  if (useChatgptComposerControllerValue8323 == null) {
    let useChatgptComposerControllerValue13601;
    return (
      <span className="underline decoration-current underline-offset-2">
        {useChatgptComposerControllerValue8321}
      </span>
    );
  }
  return (
    <O_
      ...
      href={useChatgptComposerControllerValue8323}
    >
      {useChatgptComposerControllerValue8321}
    </O_>
  );
}
var useChatgptComposerControllerValue240,
  useChatgptComposerControllerValue241,
  useChatgptComposerControllerValue242 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue240 = appInitialIvt();
    _appInitialYI();
    D_();
    useChatgptComposerControllerValue88();
    j_();
    useChatgptComposerControllerValue241 = appInitialJvt();
  });
function useChatgptComposerControllerHelper181(
  useChatgptComposerControllerParam2676,
) {
  let { reference } = useChatgptComposerControllerParam2676,
    useChatgptComposerControllerValue7423 = appInitialJft(),
    useChatgptComposerControllerValue7424 = E_(reference);
  let useChatgptComposerControllerValue7425 =
      useChatgptComposerControllerValue7424,
    useChatgptComposerControllerValue7426 =
      useChatgptComposerControllerHelper76(reference.provider);
  let useChatgptComposerControllerValue7427 =
      useChatgptComposerControllerValue7426,
    useChatgptComposerControllerValue7428 =
      useChatgptComposerControllerValue7427 === "google_maps"
        ? useChatgptComposerControllerValue245
        : (_AppInitialOI(reference) ??
          useChatgptComposerControllerValue7423.formatMessage({
            id: "chatgpt.contentReferences.locationSearch.maps",
            defaultMessage: "Maps",
            description: "Fallback label for a location search citation link",
          }));
  let useChatgptComposerControllerValue7429 =
      useChatgptComposerControllerValue7428,
    useChatgptComposerControllerValue7430 = `${useChatgptComposerControllerValue246}${useChatgptComposerControllerValue7429}${useChatgptComposerControllerValue247}`;
  if (useChatgptComposerControllerValue7425 == null) {
    let useChatgptComposerControllerValue14989;
    return <span>{useChatgptComposerControllerValue7430}</span>;
  }
  return (
    <span>
      {useChatgptComposerControllerValue246}
      <O_ href={useChatgptComposerControllerValue7425}>
        {useChatgptComposerControllerValue7429}
      </O_>
      {useChatgptComposerControllerValue247}
    </span>
  );
}
var useChatgptComposerControllerValue243,
  useChatgptComposerControllerValue244,
  useChatgptComposerControllerValue245,
  useChatgptComposerControllerValue246,
  useChatgptComposerControllerValue247,
  useChatgptComposerControllerValue248 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue243 = appInitialIvt();
    appInitialHft();
    _appInitialYI();
    D_();
    j_();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue244 = appInitialJvt();
    useChatgptComposerControllerValue245 = "Google Maps";
    useChatgptComposerControllerValue246 = " (";
    useChatgptComposerControllerValue247 = ") ";
  });
    useChatgptComposerControllerValue266 = new Intl.NumberFormat(undefined);
    useChatgptComposerControllerValue267 = "© ";
    useChatgptComposerControllerValue268 = " ";
    useChatgptComposerControllerValue269 = " © ";
    useChatgptComposerControllerValue270 = "· ";
    useChatgptComposerControllerValue271 = "Mapbox";
    useChatgptComposerControllerValue272 = "OpenStreetMap";
  });
function useChatgptComposerControllerHelper208(
  useChatgptComposerControllerParam2142,
) {
  ...
  let { reference } = useChatgptComposerControllerParam2142;
  switch (useChatgptComposerControllerHelper217(reference)) {
    case "products":
    case "product_group":
    case "explore_more": {
      let useChatgptComposerControllerValue14822;
      return <UseChatgptComposerControllerHelper119 reference={reference} />;
    }
    case "product": {
      let useChatgptComposerControllerValue13370;
...
function useChatgptComposerControllerHelper209(
  useChatgptComposerControllerParam4686,
) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const UseChatgptComposerControllerHelper114 =
    useChatgptComposerControllerHelper114;
  let { reference } = useChatgptComposerControllerParam4686,
    useChatgptComposerControllerValue10824 = appInitialPI(reference);
  let useChatgptComposerControllerValue10825 =
    useChatgptComposerControllerValue10824[0];
  if (useChatgptComposerControllerValue10825 == null) {
    let useChatgptComposerControllerValue15040;
    return <UseChatgptComposerControllerHelper68 reference={reference} />;
  }
  return (
    <div className="my-3 max-w-fit">
      {
        <UseChatgptComposerControllerHelper114
          product={useChatgptComposerControllerValue10825}
        />
      }
    </div>
  );
}
function useChatgptComposerControllerHelper210(
  useChatgptComposerControllerParam2008,
) {
  const UseChatgptComposerControllerHelper216 =
    useChatgptComposerControllerHelper216;
  let { reference } = useChatgptComposerControllerParam2008,
    useChatgptComposerControllerValue6183,
    useChatgptComposerControllerValue6184,
    useChatgptComposerControllerValue6185,
    useChatgptComposerControllerValue6186;
  useChatgptComposerControllerValue6186 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    let useChatgptComposerControllerValue8641 = appInitialPI(reference)[0];
    if (useChatgptComposerControllerValue8641 == null) {
      useChatgptComposerControllerValue6186 = null;
      break bb0;
    }
    useChatgptComposerControllerValue6184 = [
      useChatgptComposerControllerValue8641.title,
      useChatgptComposerControllerHelper222(
        useChatgptComposerControllerValue8641.price,
      ),
      useChatgptComposerControllerHelper222(
        useChatgptComposerControllerValue8641.merchants,
      ),
    ...
    useChatgptComposerControllerValue6185 =
      useChatgptComposerControllerHelper218(
        useChatgptComposerControllerValue8641,
      );
  }
  if (
    useChatgptComposerControllerValue6186 !==
    ...
    return useChatgptComposerControllerValue6186;
  let useChatgptComposerControllerValue6187 =
    useChatgptComposerControllerValue6185;
  if (useChatgptComposerControllerValue6187 == null)
    return useChatgptComposerControllerValue6183;
  let useChatgptComposerControllerValue6188 =
    useChatgptComposerControllerValue6184.join(" ");
  return (
    <UseChatgptComposerControllerHelper216
      aria-label={useChatgptComposerControllerValue6188}
      href={useChatgptComposerControllerValue6187}
    >
      {useChatgptComposerControllerValue6183}
    </UseChatgptComposerControllerHelper216>
  );
}
function useChatgptComposerControllerHelper211(
  useChatgptComposerControllerParam11386,
) {
  return useChatgptComposerControllerParam11386 != null;
}
function _y(useChatgptComposerControllerParam1958) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const AppInitialGft = appInitialGft;
  const UseChatgptComposerControllerHelper215 =
    useChatgptComposerControllerHelper215;
  let { reference } = useChatgptComposerControllerParam1958,
    useChatgptComposerControllerValue6115 = _appInitialI(reference);
  let useChatgptComposerControllerValue6116 =
      useChatgptComposerControllerValue6115,
    useChatgptComposerControllerValue6117,
    useChatgptComposerControllerValue6118;
  useChatgptComposerControllerValue6118 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    let useChatgptComposerControllerValue7368 = appInitialGI(reference);
    if (
      useChatgptComposerControllerValue6116 == null &&
      useChatgptComposerControllerValue7368.length === 0
    ) {
      let useChatgptComposerControllerValue14691;
      useChatgptComposerControllerValue14691 = (
        <UseChatgptComposerControllerHelper68 reference={reference} />
      );
      useChatgptComposerControllerValue6118 =
        useChatgptComposerControllerValue14691;
    ...
    let useChatgptComposerControllerValue7369 = (
      <AppInitialGft
    ...
    let useChatgptComposerControllerValue7370;
    useChatgptComposerControllerValue7370 =
      useChatgptComposerControllerValue6116 == null ? null : (
        <div className="text-token-text-secondary">
          {useChatgptComposerControllerValue6116}
        </div>
      );
    useChatgptComposerControllerValue6117 = (
      <UseChatgptComposerControllerHelper215
        title={useChatgptComposerControllerValue7369}
      >
        {useChatgptComposerControllerValue7370}
        {useChatgptComposerControllerValue7368.length === 0 ? null : (
          <div className="mt-3 flex flex-col gap-2">
            {useChatgptComposerControllerValue7368
              .slice(0, 3)
              .map(useChatgptComposerControllerHelper212)}
          </div>
        )}
      </UseChatgptComposerControllerHelper215>
    );
  }
  return useChatgptComposerControllerValue6118 ===
    Symbol.for("react.early_return_sentinel")
    ? useChatgptComposerControllerValue6117
    : useChatgptComposerControllerValue6118;
}
function useChatgptComposerControllerHelper212(
  useChatgptComposerControllerParam2669,
  useChatgptComposerControllerParam2670,
) {
  const UseChatgptComposerControllerHelper216 =
    useChatgptComposerControllerHelper216;
  let useChatgptComposerControllerValue7402 =
      useChatgptComposerControllerHelper222(
        useChatgptComposerControllerParam2669.source,
      ),
    useChatgptComposerControllerValue7403 =
      useChatgptComposerControllerHelper222(
        useChatgptComposerControllerParam2669.theme,
      ) ??
      useChatgptComposerControllerValue7402 ??
      useChatgptComposerControllerHelper220(
        useChatgptComposerControllerHelper222(
          useChatgptComposerControllerParam2669.cite_url,
        ) ??
          useChatgptComposerControllerHelper222(
            useChatgptComposerControllerParam2669.cite,
          ),
      ),
    useChatgptComposerControllerValue7404 =
      useChatgptComposerControllerHelper219(
        useChatgptComposerControllerHelper222(
          useChatgptComposerControllerParam2669.cite_url,
        ) ??
          useChatgptComposerControllerHelper222(
    ...
    useChatgptComposerControllerValue7405 =
      useChatgptComposerControllerHelper221(
        useChatgptComposerControllerParam2669.rating,
        useChatgptComposerControllerParam2669.num_reviews,
      );
  return (
    <div
      key={`${useChatgptComposerControllerValue7403 ?? "review"}-${String(useChatgptComposerControllerParam2670)}`}
      className="rounded-md border border-token-border-light p-2"
    >
      {useChatgptComposerControllerValue7403 == null ? null : (
        <div className="font-medium text-token-text-primary">
          {useChatgptComposerControllerValue7403}
        </div>
      )}
      {useChatgptComposerControllerHelper222(
        useChatgptComposerControllerParam2669.summary,
      ) == null ? null : (
        <div className="mt-1 text-token-text-secondary">
          {useChatgptComposerControllerParam2669.summary}
        </div>
      )}
      {useChatgptComposerControllerValue7405 == null &&
      useChatgptComposerControllerValue7402 == null ? null : (
        <div className="mt-1 flex flex-wrap gap-2 text-token-text-secondary">
          {useChatgptComposerControllerValue7405 == null ? null : (
            <span>{useChatgptComposerControllerValue7405}</span>
          )}
          {useChatgptComposerControllerValue7402 ==
          null ? null : useChatgptComposerControllerValue7404 == null ? (
            <span>{useChatgptComposerControllerValue7402}</span>
          ) : (
            <UseChatgptComposerControllerHelper216
              href={useChatgptComposerControllerValue7404}
            >
              {useChatgptComposerControllerValue7402}
            </UseChatgptComposerControllerHelper216>
          )}
...
function useChatgptComposerControllerHelper213(
  useChatgptComposerControllerParam1920,
) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const AppInitialGft = appInitialGft;
  const UseChatgptComposerControllerHelper215 =
    useChatgptComposerControllerHelper215;
  let { reference } = useChatgptComposerControllerParam1920,
    useChatgptComposerControllerValue6065 = _appInitialMI(reference);
  let useChatgptComposerControllerValue6066 =
      useChatgptComposerControllerValue6065,
    useChatgptComposerControllerValue6067,
    useChatgptComposerControllerValue6068;
  useChatgptComposerControllerValue6068 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    let useChatgptComposerControllerValue7300 = appInitialHI(reference);
    if (
      useChatgptComposerControllerValue6066 == null &&
      useChatgptComposerControllerValue7300.length === 0
    ) {
      let useChatgptComposerControllerValue14692;
      useChatgptComposerControllerValue14692 = (
        <UseChatgptComposerControllerHelper68 reference={reference} />
      );
      useChatgptComposerControllerValue6068 =
        useChatgptComposerControllerValue14692;
    ...
    let useChatgptComposerControllerValue7301 = (
      <AppInitialGft
    ...
    let useChatgptComposerControllerValue7302;
    useChatgptComposerControllerValue7302 =
      useChatgptComposerControllerValue6066 == null ? null : (
        <div className="text-token-text-secondary">
          {useChatgptComposerControllerValue6066}
        </div>
      );
    useChatgptComposerControllerValue6067 = (
      <UseChatgptComposerControllerHelper215
        title={useChatgptComposerControllerValue7301}
      >
        {useChatgptComposerControllerValue7302}
        {useChatgptComposerControllerValue7300.length === 0 ? null : (
          <div className="mt-2 flex flex-wrap gap-2">
            {useChatgptComposerControllerValue7300.slice(0, 3).map(by)}
          </div>
        )}
      </UseChatgptComposerControllerHelper215>
    );
  }
  return useChatgptComposerControllerValue6068 ===
    Symbol.for("react.early_return_sentinel")
    ? useChatgptComposerControllerValue6067
    : useChatgptComposerControllerValue6068;
}
function by(
  useChatgptComposerControllerParam8477,
  useChatgptComposerControllerParam8478,
) {
  const UseChatgptComposerControllerHelper216 =
    useChatgptComposerControllerHelper216;
  let useChatgptComposerControllerValue14540 =
      useChatgptComposerControllerHelper219(
        useChatgptComposerControllerHelper222(
          useChatgptComposerControllerParam8477.url,
        ),
      ),
    useChatgptComposerControllerValue14541 =
      useChatgptComposerControllerHelper222(
        useChatgptComposerControllerParam8477.title,
      ) ??
      useChatgptComposerControllerHelper220(
        useChatgptComposerControllerHelper222(
          useChatgptComposerControllerParam8477.url,
  ...
  return useChatgptComposerControllerValue14540 == null ||
    useChatgptComposerControllerValue14541 == null ? null : (
    <UseChatgptComposerControllerHelper216
      key={`${useChatgptComposerControllerValue14540}-${String(useChatgptComposerControllerParam8478)}`}
      href={useChatgptComposerControllerValue14540}
    >
      {useChatgptComposerControllerValue14541}
    </UseChatgptComposerControllerHelper216>
  );
}
function useChatgptComposerControllerHelper214(
  useChatgptComposerControllerParam3229,
) {
  const UseChatgptComposerControllerHelper215 =
    useChatgptComposerControllerHelper215;
  let { reference } = useChatgptComposerControllerParam3229,
    useChatgptComposerControllerValue8576 =
      useChatgptComposerControllerHelper222(reference.label);
  let useChatgptComposerControllerValue8577 =
      useChatgptComposerControllerValue8576,
    useChatgptComposerControllerValue8578 =
      useChatgptComposerControllerHelper222(reference.query);
  let useChatgptComposerControllerValue8579 =
      useChatgptComposerControllerValue8578,
    useChatgptComposerControllerValue8580 =
      useChatgptComposerControllerValue8577 ?? _AppInitialOI(reference);
  let useChatgptComposerControllerValue8581 =
    useChatgptComposerControllerValue8580;
  if (
    useChatgptComposerControllerValue8581 == null &&
    useChatgptComposerControllerValue8579 == null
  )
    return null;
  let useChatgptComposerControllerValue8582 =
    useChatgptComposerControllerValue8579 == null ||
    useChatgptComposerControllerValue8579 ===
      useChatgptComposerControllerValue8581 ? null : (
      <div className="text-token-text-secondary">
        {useChatgptComposerControllerValue8579}
      </div>
  ...
  return (
    <UseChatgptComposerControllerHelper215
      title={useChatgptComposerControllerValue8581}
    >
      {useChatgptComposerControllerValue8582}
    </UseChatgptComposerControllerHelper215>
  );
}
function useChatgptComposerControllerHelper215(
  useChatgptComposerControllerParam3541,
) {
  let { children, title } = useChatgptComposerControllerParam3541,
    useChatgptComposerControllerValue9182 = (
      <div className="font-medium text-token-text-primary">{title}</div>
    );
  let useChatgptComposerControllerValue9183 = (
  ...
  return (
    ...
    >
      {useChatgptComposerControllerValue9182}
      {useChatgptComposerControllerValue9183}
    </div>
  );
}
function useChatgptComposerControllerHelper216(
  useChatgptComposerControllerParam4061,
) {
  const UseChatgptComposerControllerHelper65 =
    useChatgptComposerControllerHelper65;
  let { children, href, ...rest } = useChatgptComposerControllerParam4061;
  return (
    <UseChatgptComposerControllerHelper65
      {...rest}
...
function useChatgptComposerControllerHelper217(
  useChatgptComposerControllerParam10494,
) {
  return typeof useChatgptComposerControllerParam10494.type == "string" &&
    useChatgptComposerControllerParam10494.type.length > 0
    ? useChatgptComposerControllerParam10494.type
    : null;
}
function useChatgptComposerControllerHelper218(
  useChatgptComposerControllerParam11359,
) {
  return useChatgptComposerControllerHelper219(
    useChatgptComposerControllerHelper222(
      useChatgptComposerControllerParam11359.url,
    ),
  );
}
function useChatgptComposerControllerHelper219(
  useChatgptComposerControllerParam11185,
) {
  return useChatgptComposerControllerParam11185 == null
    ? null
    : (_appInitialIL(useChatgptComposerControllerParam11185) ?? null);
}
function useChatgptComposerControllerHelper220(
  useChatgptComposerControllerParam9592,
) {
  if (useChatgptComposerControllerParam9592 == null) return null;
  try {
    return (
      new URL(useChatgptComposerControllerParam9592).hostname ||
      useChatgptComposerControllerParam9592
    );
  } catch {
    return useChatgptComposerControllerParam9592;
  }
}
function useChatgptComposerControllerHelper221(
  useChatgptComposerControllerParam9476,
  useChatgptComposerControllerParam9477,
) {
  return useChatgptComposerControllerParam9476 == null
    ? null
    : useChatgptComposerControllerParam9477 == null
      ? useChatgptComposerControllerValue276.format(
          useChatgptComposerControllerParam9476,
        )
      : `${useChatgptComposerControllerValue276.format(useChatgptComposerControllerParam9476)} (${useChatgptComposerControllerValue277.format(useChatgptComposerControllerParam9477)})`;
}
function useChatgptComposerControllerHelper222(
  useChatgptComposerControllerParam10770,
) {
  return typeof useChatgptComposerControllerParam10770 == "string" &&
    useChatgptComposerControllerParam10770.trim().length > 0
    ? useChatgptComposerControllerParam10770
    : null;
}
var useChatgptComposerControllerValue274,
  useChatgptComposerControllerValue275,
  useChatgptComposerControllerValue276,
  useChatgptComposerControllerValue277,
  useChatgptComposerControllerValue278 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue274 = appInitialIvt();
    appInitialHft();
    AppInitialOL();
    _appInitialYI();
    useChatgptComposerControllerValue85();
    useChatgptComposerControllerValue122();
    useChatgptComposerControllerValue125();
    useChatgptComposerControllerValue88();
    useChatgptComposerControllerValue275 = appInitialJvt();
    useChatgptComposerControllerValue276 = new Intl.NumberFormat(undefined, {
      maximumFractionDigits: 1,
      minimumFractionDigits: 1,
    });
    useChatgptComposerControllerValue277 = new Intl.NumberFormat(undefined);
  });
function useChatgptComposerControllerHelper223(
  useChatgptComposerControllerParam5055,
) {
  ...
  let { reference } = useChatgptComposerControllerParam5055;
  switch (reference.type) {
    case "sports_schedule": {
      let useChatgptComposerControllerValue14826;
      return <UseChatgptComposerControllerHelper224 reference={reference} />;
    }
    case "sports_standings": {
      let useChatgptComposerControllerValue14827;
...
function useChatgptComposerControllerHelper224(
  useChatgptComposerControllerParam2087,
) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const UseChatgptComposerControllerValue6273 =
    useChatgptComposerControllerValue6273;
  let { reference } = useChatgptComposerControllerParam2087,
    useChatgptComposerControllerValue6272 = appInitialJft(),
    useChatgptComposerControllerValue6273,
    useChatgptComposerControllerValue6274,
    useChatgptComposerControllerValue6275,
    useChatgptComposerControllerValue6276,
    useChatgptComposerControllerValue6277;
  useChatgptComposerControllerValue6277 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    let useChatgptComposerControllerValue10006 = Array.isArray(reference.games)
      ? reference.games
      : [];
    if (useChatgptComposerControllerValue10006.length === 0) {
      let useChatgptComposerControllerValue14693;
      useChatgptComposerControllerValue14693 = (
        <UseChatgptComposerControllerHelper68 reference={reference} />
      );
      useChatgptComposerControllerValue6277 =
        useChatgptComposerControllerValue14693;
    ...
    useChatgptComposerControllerValue6273 =
      useChatgptComposerControllerHelper64;
    useChatgptComposerControllerValue6276 =
      useChatgptComposerControllerValue6272.formatMessage({
        id: "chatgpt.contentReferences.sportsSchedule.title",
        defaultMessage: "Schedule",
        description: "Title for a sports schedule content reference card",
      });
    useChatgptComposerControllerValue6274 = "flex flex-col gap-2";
    useChatgptComposerControllerValue6275 =
      useChatgptComposerControllerValue10006
        .slice(0, 5)
  ...
  if (
    ...
    return useChatgptComposerControllerValue6277;
  let useChatgptComposerControllerValue6278 = (
    <div className={useChatgptComposerControllerValue6274}>
      {useChatgptComposerControllerValue6275}
    </div>
  );
  return (
    <UseChatgptComposerControllerValue6273
      title={useChatgptComposerControllerValue6276}
    >
      {useChatgptComposerControllerValue6278}
    </UseChatgptComposerControllerValue6273>
  );
}
function useChatgptComposerControllerHelper225(
  useChatgptComposerControllerParam5513,
  useChatgptComposerControllerParam5514,
) {
  return (
    <div
      key={String(useChatgptComposerControllerParam5514)}
      className="rounded-md border border-token-border-light p-2"
    >
...
function useChatgptComposerControllerHelper226(
  useChatgptComposerControllerParam4898,
) {
  const UseChatgptComposerControllerHelper68 =
    useChatgptComposerControllerHelper68;
  const UseChatgptComposerControllerHelper227 =
    useChatgptComposerControllerHelper227;
  let { reference } = useChatgptComposerControllerParam4898,
    useChatgptComposerControllerValue11029 =
      useChatgptComposerControllerValue286.safeParse(reference);
  let useChatgptComposerControllerValue11030 =
    useChatgptComposerControllerValue11029;
  if (
    !useChatgptComposerControllerValue11030.success ||
    useChatgptComposerControllerValue11030.data.conferences.length === 0
  ) {
    let useChatgptComposerControllerValue15041;
    return <UseChatgptComposerControllerHelper68 reference={reference} />;
  }
  return (
    <UseChatgptComposerControllerHelper227
      standingsRef={useChatgptComposerControllerValue11030.data}
    />
  );
}
function useChatgptComposerControllerHelper227(
  useChatgptComposerControllerParam1230,
) {
  let { standingsRef } = useChatgptComposerControllerParam1230,
    [
      useChatgptComposerControllerValue4751,
      useChatgptComposerControllerValue4752,
    ] = useChatgptComposerControllerValue280.useState(0),
    useChatgptComposerControllerValue4753 =
      standingsRef.conferences[useChatgptComposerControllerValue4751] ??
      standingsRef.conferences[0];
  if (useChatgptComposerControllerValue4753 == null) return null;
  let useChatgptComposerControllerValue4754 =
    standingsRef.league?.id != null &&
    useChatgptComposerControllerValue282.includes(standingsRef.league.id);
  let useChatgptComposerControllerValue4755 =
      useChatgptComposerControllerValue4754,
    useChatgptComposerControllerValue4756 =
            ...
            return (
              <button
                ...
                className={appInitialWft(
                  useChatgptComposerControllerValue4751 === index
                ...
                type="button"
                onClick={() => {
                  return useChatgptComposerControllerValue4752(index);
                }}
              >
                {item.name}
              </button>
  ...
  let useChatgptComposerControllerValue4757;
  {
    let useChatgptComposerControllerValue10503;
    useChatgptComposerControllerValue10503 = (
      useChatgptComposerControllerParam5850,
      useChatgptComposerControllerParam5851,
    ) => {
      const UseChatgptComposerControllerHelper228 =
        useChatgptComposerControllerHelper228;
      return useChatgptComposerControllerParam5850.name == null ? (
        <UseChatgptComposerControllerHelper228
          key={String(useChatgptComposerControllerParam5851)}
          division={useChatgptComposerControllerParam5850}
          useAlias={useChatgptComposerControllerValue4755}
        />
      ) : (
        <div key={useChatgptComposerControllerParam5850.name} className="mt-3">
          {
            <UseChatgptComposerControllerHelper228
              division={useChatgptComposerControllerParam5850}
              teamsColumnHeader={useChatgptComposerControllerParam5850.name}
            />
          }
        </div>
      );
    };
    useChatgptComposerControllerValue4757 =
      useChatgptComposerControllerValue4753.divisions.map(
        useChatgptComposerControllerValue10503,
      );
  }
  let useChatgptComposerControllerValue4758 = (
    <div className="mt-3">{useChatgptComposerControllerValue4757}</div>
  );
  return (
    <div data-testid="sports-standings-widget">
      {useChatgptComposerControllerValue4756}
      {useChatgptComposerControllerValue4758}
    </div>
  );
}
function useChatgptComposerControllerHelper228(
  useChatgptComposerControllerParam738,
) {
  const AppInitialGft = appInitialGft;
  let { division, teamsColumnHeader, useAlias } =
      useChatgptComposerControllerParam738,
    useChatgptComposerControllerValue3538,
    useChatgptComposerControllerValue3539,
    useChatgptComposerControllerValue3540,
    useChatgptComposerControllerValue3541;
  {
    let useChatgptComposerControllerValue4351 = division.headers.map(
      useChatgptComposerControllerHelper230,
    );
    useChatgptComposerControllerValue3541 = "not-prose overflow-x-auto";
    useChatgptComposerControllerValue3539 = "w-full border-collapse text-sm";
    let useChatgptComposerControllerValue4352 = teamsColumnHeader ?? (
      <AppInitialGft defaultMessage="Team" description="Title for team" />
    );
    let useChatgptComposerControllerValue4353 = (
      <th
        className="border-b border-token-border-default py-2 ps-0 pe-4 text-start text-sm font-normal text-token-text-primary"
        scope="col"
      >
        {useChatgptComposerControllerValue4352}
      </th>
    );
    let useChatgptComposerControllerValue4354;
    useChatgptComposerControllerValue4354 = division.headers.map(
      useChatgptComposerControllerHelper229,
    );
    useChatgptComposerControllerValue3540 = (
      <thead>
        <tr>
          {useChatgptComposerControllerValue4353}
          {useChatgptComposerControllerValue4354}
        </tr>
      </thead>
    );
    useChatgptComposerControllerValue3538 = division.teams.map(
      (item, index) => {
        ...
        return (
          <tr key={team.name}>
            ...
            {useChatgptComposerControllerValue4351.map((_item) => {
  ...
  let useChatgptComposerControllerValue3542 = (
    <tbody>{useChatgptComposerControllerValue3538}</tbody>
  );
  let useChatgptComposerControllerValue3543 = (
    <table className={useChatgptComposerControllerValue3539}>
      {useChatgptComposerControllerValue3540}
      {useChatgptComposerControllerValue3542}
    </table>
  );
  return (
    <div className={useChatgptComposerControllerValue3541}>
      {useChatgptComposerControllerValue3543}
    </div>
  );
}
function useChatgptComposerControllerHelper229(event) {
  const UseChatgptComposerControllerHelper233 =
    useChatgptComposerControllerHelper233;
  return (
    <th
...
function useChatgptComposerControllerHelper230(event) {
  return event.key;
}
function useChatgptComposerControllerHelper231(
  useChatgptComposerControllerParam3820,
) {
  let { team } = useChatgptComposerControllerParam3820,
    useChatgptComposerControllerValue9639 =
      useChatgptComposerControllerHelper31();
  if (
    team.logo == null ||
    useChatgptComposerControllerValue9639?.shouldBlockExternalEgress === true
  ) {
    let useChatgptComposerControllerValue13314;
    return (
      <span
        aria-hidden="true"
...
function useChatgptComposerControllerHelper232(
  useChatgptComposerControllerParam3120,
) {
  let { team, useAlias } = useChatgptComposerControllerParam3120;
  if (!useAlias || team.alias == null) {
    let useChatgptComposerControllerValue13674;
    return <span className="text-base whitespace-nowrap">{team.name}</span>;
  }
  let useChatgptComposerControllerValue8274 = (
    <span className="hidden text-base whitespace-nowrap sm:inline">
      {team.name}
    </span>
  );
  let useChatgptComposerControllerValue8275 = (
    <span className="text-base whitespace-nowrap sm:hidden">{team.alias}</span>
  );
  return (
    <>
      {useChatgptComposerControllerValue8274}
      {useChatgptComposerControllerValue8275}
    </>
  );
}
function useChatgptComposerControllerHelper233(
  useChatgptComposerControllerParam6798,
) {
  let { data } = useChatgptComposerControllerParam6798;
  if (data == null) return null;
  let useChatgptComposerControllerValue13174 =
    data.type === "text" ? data.text : data.alt;
  return useChatgptComposerControllerValue13174 == null ? null : (
    <>{useChatgptComposerControllerValue13174}</>
  );
}
function useChatgptComposerControllerHelper234(
  useChatgptComposerControllerParam8726,
) {
  let useChatgptComposerControllerValue14755 =
      useChatgptComposerControllerHelper78(
        useChatgptComposerControllerParam8726,
      ),
    useChatgptComposerControllerValue14756 =
      useChatgptComposerControllerHelper235(
        useChatgptComposerControllerHelper78(
          useChatgptComposerControllerValue14755?.first_team_info,
        ),
      ),
    useChatgptComposerControllerValue14757 =
      useChatgptComposerControllerHelper235(
        useChatgptComposerControllerHelper78(
          useChatgptComposerControllerValue14755?.second_team_info,
        ),
      );
  return useChatgptComposerControllerValue14756 == null ||
    useChatgptComposerControllerValue14757 == null
    ? (useChatgptComposerControllerHelper76(
        useChatgptComposerControllerValue14755?.date,
      ) ?? "")
    : `${useChatgptComposerControllerValue14756} / ${useChatgptComposerControllerValue14757}`;
}
function useChatgptComposerControllerHelper235(
  useChatgptComposerControllerParam10862,
) {
  let useChatgptComposerControllerValue15870 =
    useChatgptComposerControllerHelper78(
      useChatgptComposerControllerParam10862?.team,
    );
  return (
    useChatgptComposerControllerHelper76(
      useChatgptComposerControllerValue15870?.name,
    ) ??
    useChatgptComposerControllerHelper76(
      useChatgptComposerControllerValue15870?.alias,
    )
  );
}
var useChatgptComposerControllerValue279,
  useChatgptComposerControllerValue280,
  useChatgptComposerControllerValue281,
  useChatgptComposerControllerValue282,
  useChatgptComposerControllerValue283,
  $y,
  useChatgptComposerControllerValue284,
  useChatgptComposerControllerValue285,
  useChatgptComposerControllerValue286,
  useChatgptComposerControllerValue287 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue279 = appInitialIvt();
    appInitialTft();
    useChatgptComposerControllerValue280 = rolldownRuntimeS(appInitialLvt(), 1);
    appInitialHft();
    __appInitialCT();
    useChatgptComposerControllerValue43();
    useChatgptComposerControllerValue81();
    useChatgptComposerControllerValue88();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue281 = appInitialJvt();
    useChatgptComposerControllerValue282 = ["ipl"];
    useChatgptComposerControllerValue283 = appInitialXT({
    ...
    useChatgptComposerControllerValue284 = appInitialXT({
      data: _appInitialFT(useChatgptComposerControllerValue283),
      team: $y,
    }).passthrough();
    useChatgptComposerControllerValue285 = appInitialXT({
      headers: _appInitialFT(useChatgptComposerControllerValue283),
      name: appInitialCT().trim().min(1).nullable().optional(),
      teams: _appInitialFT(useChatgptComposerControllerValue284),
    }).passthrough();
    useChatgptComposerControllerValue286 = appInitialXT({
      conferences: _appInitialFT(
        appInitialXT({
          divisions: _appInitialFT(useChatgptComposerControllerValue285),
          name: appInitialCT().trim().min(1).nullable().optional(),
        }).passthrough(),
      ),
      league: appInitialXT({
...
function useChatgptComposerControllerHelper236(
  useChatgptComposerControllerParam1156,
) {
  const UseChatgptComposerControllerHelper64 =
    useChatgptComposerControllerHelper64;
  const UseChatgptComposerControllerHelper74 =
    useChatgptComposerControllerHelper74;
  let { reference } = useChatgptComposerControllerParam1156,
    useChatgptComposerControllerValue4540 = appInitialJft(),
    useChatgptComposerControllerValue4541;
  {
    let useChatgptComposerControllerValue4784 =
        useChatgptComposerControllerHelper78(reference.stock),
      useChatgptComposerControllerValue4785 =
        useChatgptComposerControllerHelper78(
          useChatgptComposerControllerValue4784?.asset,
        ),
      useChatgptComposerControllerValue4786 =
        useChatgptComposerControllerHelper78(
          useChatgptComposerControllerValue4784?.price,
        ),
      useChatgptComposerControllerValue4787 =
        useChatgptComposerControllerHelper76(reference.ticker) ??
        useChatgptComposerControllerHelper76(
          useChatgptComposerControllerValue4785?.ticker,
        ),
      useChatgptComposerControllerValue4788 =
        useChatgptComposerControllerHelper76(
          useChatgptComposerControllerValue4785?.name,
        ),
      useChatgptComposerControllerValue4789 = $d(
        useChatgptComposerControllerValue4786?.price,
      ),
      useChatgptComposerControllerValue4790 = $d(
        useChatgptComposerControllerValue4786?.change,
      ),
      useChatgptComposerControllerValue4791 = $d(
        useChatgptComposerControllerValue4786?.change_percent,
      ),
      useChatgptComposerControllerValue4792 = AppInitialSI(reference),
      useChatgptComposerControllerValue4793 =
        useChatgptComposerControllerValue4788 == null &&
        useChatgptComposerControllerValue4787 == null
          ? useChatgptComposerControllerValue4540.formatMessage({
          ...
          : [
              ...
              .filter(Boolean)
              .join(" "),
      useChatgptComposerControllerValue4794 =
        useChatgptComposerControllerValue4789 == null
          ? null
          : useChatgptComposerControllerHelper75(
              useChatgptComposerControllerValue4789,
              {
                maximumFractionDigits: 2,
                minimumFractionDigits: 2,
              },
            ),
      useChatgptComposerControllerValue4795 =
        useChatgptComposerControllerValue4790 == null
          ? null
          : useChatgptComposerControllerHelper237(
              useChatgptComposerControllerValue4790,
            ),
      useChatgptComposerControllerValue4796 =
        useChatgptComposerControllerValue4791 == null
          ? null
          : `(${useChatgptComposerControllerHelper237(useChatgptComposerControllerValue4791 * 100)}%)`;
    let useChatgptComposerControllerValue4797 =
        useChatgptComposerControllerValue4796,
      useChatgptComposerControllerValue4798 =
        useChatgptComposerControllerValue4794 == null ? null : (
          <div className="text-2xl font-semibold">
            {useChatgptComposerControllerValue4794}
          </div>
        );
    let useChatgptComposerControllerValue4799 =
      useChatgptComposerControllerValue4790 == null &&
      useChatgptComposerControllerValue4791 == null ? null : (
        <div
          className={
            (useChatgptComposerControllerValue4790 ??
              useChatgptComposerControllerValue4791 ??
              0) < 0
              ? "text-red-500"
        ...
        >
          ...
          {useChatgptComposerControllerValue4790 != null &&
          useChatgptComposerControllerValue4791 != null
            ? useChatgptComposerControllerValue290
            : null}
          {useChatgptComposerControllerValue4797}
        </div>
      );
    let useChatgptComposerControllerValue4800;
    useChatgptComposerControllerValue4800 = (
      <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
        {useChatgptComposerControllerValue4798}
        {useChatgptComposerControllerValue4799}
      </div>
    );
    useChatgptComposerControllerValue4541 = (
      <UseChatgptComposerControllerHelper64
        title={useChatgptComposerControllerValue4793}
      >
        {useChatgptComposerControllerValue4800}
        {useChatgptComposerControllerValue4792 == null ? null : (
          <div className="mt-2">
            {
              <UseChatgptComposerControllerHelper74
                href={useChatgptComposerControllerValue4792}
              >
                {useChatgptComposerControllerHelper77(
                  useChatgptComposerControllerValue4792,
                )}
              </UseChatgptComposerControllerHelper74>
            }
          </div>
  ...
  return useChatgptComposerControllerValue4541;
}
function useChatgptComposerControllerHelper237(
  useChatgptComposerControllerParam9209,
) {
  let useChatgptComposerControllerValue15163 =
    useChatgptComposerControllerHelper75(
      Math.abs(useChatgptComposerControllerParam9209),
      {
        maximumFractionDigits: 2,
        minimumFractionDigits: 2,
      },
    );
  return `${useChatgptComposerControllerParam9209 < 0 ? "-" : "+"}${useChatgptComposerControllerValue15163}`;
}
var useChatgptComposerControllerValue288,
  useChatgptComposerControllerValue289,
  useChatgptComposerControllerValue290,
  useChatgptComposerControllerValue291 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue288 = appInitialIvt();
    appInitialHft();
    _appInitialYI();
    useChatgptComposerControllerValue81();
    useChatgptComposerControllerValue91();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue289 = appInitialJvt();
    useChatgptComposerControllerValue290 = " ";
  });
function useChatgptComposerControllerHelper238(
  useChatgptComposerControllerParam4587,
) {
  const AppInitialQL = appInitialQL;
  let { reference } = useChatgptComposerControllerParam4587,
    useChatgptComposerControllerValue10635 =
      useChatgptComposerControllerHelper239(reference);
  let useChatgptComposerControllerValue10636 =
    useChatgptComposerControllerValue10635;
  if (
    useChatgptComposerControllerValue10636 == null &&
    reference.type === "hidden"
  )
    return null;
  let useChatgptComposerControllerValue10637 =
    useChatgptComposerControllerValue10636 ?? _AppInitialNI(reference);
  let useChatgptComposerControllerValue10638 =
    useChatgptComposerControllerValue10637;
  if (useChatgptComposerControllerValue10638 == null) return null;
  return (
    <AppInitialQL icon={appInitialCct} labelClassName="whitespace-nowrap">
      {useChatgptComposerControllerValue10638}
    </AppInitialQL>
  );
}
function useChatgptComposerControllerHelper239(
  useChatgptComposerControllerParam6943,
) {
  let useChatgptComposerControllerValue13295 =
    useChatgptComposerControllerHelper76(
      useChatgptComposerControllerParam6943.utc_time,
    );
  if (useChatgptComposerControllerValue13295 == null) return null;
  let useChatgptComposerControllerValue13296 = new Date(
    useChatgptComposerControllerValue13295,
  );
  return Number.isNaN(useChatgptComposerControllerValue13296.getTime())
    ? null
    : new Intl.DateTimeFormat(undefined, {
        ...
        new Date(
          useChatgptComposerControllerValue13296.getTime() +
...
function useChatgptComposerControllerHelper240(
  useChatgptComposerControllerParam6762,
) {
  let useChatgptComposerControllerValue13130 =
    useChatgptComposerControllerHelper76(
      useChatgptComposerControllerParam6762.utc_offset,
    );
  if (useChatgptComposerControllerValue13130 == null) return 0;
  let useChatgptComposerControllerValue13131 = /^([+-])(\d{2}):?(\d{2})?$/.exec(
    useChatgptComposerControllerValue13130,
  );
  if (useChatgptComposerControllerValue13131 == null) return 0;
  let [
      ,
      useChatgptComposerControllerValue13132,
      useChatgptComposerControllerValue13133,
      useChatgptComposerControllerValue13134,
    ] = useChatgptComposerControllerValue13131,
    useChatgptComposerControllerValue13135 = Number(
      useChatgptComposerControllerValue13133,
    ),
    useChatgptComposerControllerValue13136 = Number(
      useChatgptComposerControllerValue13134 ?? "0",
    );
  return !Number.isFinite(useChatgptComposerControllerValue13135) ||
    !Number.isFinite(useChatgptComposerControllerValue13136)
    ? 0
    : (useChatgptComposerControllerValue13132 === "-" ? -1 : 1) *
        (useChatgptComposerControllerValue13135 * 60 +
          useChatgptComposerControllerValue13136) *
        6e4;
}
var useChatgptComposerControllerValue292,
  useChatgptComposerControllerValue293,
  useChatgptComposerControllerValue294 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue292 = appInitialIvt();
    appInitialJL();
    appInitialWct();
    _appInitialYI();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue293 = appInitialJvt();
  });
function useChatgptComposerControllerHelper241(
  useChatgptComposerControllerParam3028,
) {
  const UseChatgptComposerControllerHelper70 =
    useChatgptComposerControllerHelper70;
  let { reference } = useChatgptComposerControllerParam3028,
    useChatgptComposerControllerValue8122 =
      useChatgptComposerControllerHelper76(reference.description) ??
      _AppInitialOI(reference);
  let useChatgptComposerControllerValue8123 =
    useChatgptComposerControllerValue8122;
  if (useChatgptComposerControllerValue8123 == null) {
    let useChatgptComposerControllerValue15042;
    return <UseChatgptComposerControllerHelper70 reference={reference} />;
  }
  let useChatgptComposerControllerValue8124 = E_(reference);
  let useChatgptComposerControllerValue8125 =
    useChatgptComposerControllerValue8124;
  if (useChatgptComposerControllerValue8125 == null) {
    let useChatgptComposerControllerValue13724;
    return (
      <span className="font-semibold text-token-text-primary">
        {useChatgptComposerControllerValue8123}
      </span>
    );
  }
  return (
    <O_
      ...
      href={useChatgptComposerControllerValue8125}
    >
      {useChatgptComposerControllerValue8123}
    </O_>
  );
...
var _b,
  useChatgptComposerControllerValue295,
  useChatgptComposerControllerValue296 = rolldownRuntimeN(() => {
    _b = appInitialIvt();
    _appInitialYI();
    D_();
    useChatgptComposerControllerValue88();
    j_();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue295 = appInitialJvt();
  });
function useChatgptComposerControllerHelper242(
  useChatgptComposerControllerParam2234,
) {
  const UseChatgptComposerControllerValue6499 =
    useChatgptComposerControllerValue6499;
  const UseChatgptComposerControllerValue6500 =
    useChatgptComposerControllerValue6500;
  let { reference } = useChatgptComposerControllerParam2234,
    useChatgptComposerControllerValue6497 = _AppInitialOI(reference);
  let useChatgptComposerControllerValue6498 =
      useChatgptComposerControllerValue6497,
    useChatgptComposerControllerValue6499,
    useChatgptComposerControllerValue6500,
    useChatgptComposerControllerValue6501,
    useChatgptComposerControllerValue6502,
    useChatgptComposerControllerValue6503,
    useChatgptComposerControllerValue6504;
  useChatgptComposerControllerValue6503 = Symbol.for(
    "react.early_return_sentinel",
  );
  bb0: {
    if (
      ((useChatgptComposerControllerValue6504 = AppInitialSI(reference)),
      useChatgptComposerControllerValue6498 == null &&
        useChatgptComposerControllerValue6504 == null)
    ) {
      useChatgptComposerControllerValue6503 = null;
      break bb0;
    }
    useChatgptComposerControllerValue6500 =
      useChatgptComposerControllerHelper64;
    useChatgptComposerControllerValue6499 =
      useChatgptComposerControllerHelper73;
    useChatgptComposerControllerValue6501 = "aspect-video";
    useChatgptComposerControllerValue6502 =
      useChatgptComposerControllerHelper77(
        useChatgptComposerControllerValue6504,
      );
  ...
  if (
    ...
    return useChatgptComposerControllerValue6503;
  let useChatgptComposerControllerValue6505 =
    useChatgptComposerControllerHelper76(reference.thumbnail_url);
  let useChatgptComposerControllerValue6506 =
      useChatgptComposerControllerValue6498 ??
      useChatgptComposerControllerValue6504 ??
      "",
    useChatgptComposerControllerValue6507 = (
      <UseChatgptComposerControllerValue6499
        imageAspectClassName={useChatgptComposerControllerValue6501}
        subtitle={useChatgptComposerControllerValue6502}
        thumbnailUrl={useChatgptComposerControllerValue6505}
        title={useChatgptComposerControllerValue6506}
        url={useChatgptComposerControllerValue6504}
      />
    );
  return (
    <UseChatgptComposerControllerValue6500>
...
var useChatgptComposerControllerValue297,
  useChatgptComposerControllerValue298,
  useChatgptComposerControllerValue299 = rolldownRuntimeN(() => {
    useChatgptComposerControllerValue297 = appInitialIvt();
    _appInitialYI();
    useChatgptComposerControllerValue81();
    useChatgptComposerControllerValue91();
    useChatgptComposerControllerValue92();
    useChatgptComposerControllerValue298 = appInitialJvt();
  });
...
function useChatgptComposerControllerHelper243(
  useChatgptComposerControllerParam328,
) {
  ...
  if (
    ...
    useChatgptComposerControllerValue302.has(contentReferenceType)
  )
    return null;
  switch (contentReferenceType) {
    case "image_group":
    case "image_v2": {
      let useChatgptComposerControllerValue12286 = turnContext?.conversationId,
        useChatgptComposerControllerValue12287;
      return (
        <UseChatgptComposerControllerHelper107
          contentReferenceIndex={contentReferenceIndex}
          conversationId={useChatgptComposerControllerValue12286}
          reference={reference}
        />
      );
    }
    case "products":
    case "product_group": {
      let useChatgptComposerControllerValue14828;
      return <UseChatgptComposerControllerHelper119 reference={reference} />;
    }
    case "product":
    case "product_entity":
    ...
    case "product_rationale":
    case "product_show_more_header": {
      let useChatgptComposerControllerValue14829;
      return <UseChatgptComposerControllerHelper208 reference={reference} />;
    }
    case "map":
    case "businesses_map": {
      let useChatgptComposerControllerValue14830;
    ...
    case "sources_footnote": {
      let useChatgptComposerControllerValue13792;
      return (
        <UseChatgptComposerControllerHelper123
          isTerminalInline={isTerminalInline}
          reference={reference}
    ...
    case "file": {
      let useChatgptComposerControllerValue13725;
      return (
        <M_
          contentReferenceIndex={contentReferenceIndex}
          reference={reference}
    ...
    case "image_inline": {
      let useChatgptComposerControllerValue13793;
      return (
        <UseChatgptComposerControllerHelper67
          isTerminalInline={isTerminalInline}
          reference={reference}
    ...
    case "navigation":
    case "file_navlist": {
      let useChatgptComposerControllerValue14765;
      return <UseChatgptComposerControllerHelper79 reference={reference} />;
    }
    case "sports_standings":
    case "sports_schedule": {
      let useChatgptComposerControllerValue14766;
    ...
    case null:
      return null;
    default: {
      let useChatgptComposerControllerValue13794;
      return (
        <UseChatgptComposerControllerHelper66
          isTerminalInline={isTerminalInline}
          reference={reference}
