...
// Stage-3 wave-15: Helper124–178 client-defined widget / chart mountain drained.
// Thin boundary barrel — letter/helper exports re-exported from composer modules.
// AppScope atoms + __esm inits remain bindable/open facades elsewhere. No producer barrel.

// Side-effect: register markdown peer inits + client_defined_widget peer.
