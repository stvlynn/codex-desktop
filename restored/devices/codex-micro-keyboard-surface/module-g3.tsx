...
export function codexMicroKeyboardSurfaceN(alpha: unknown) {
  let { ariaLabel, pulse = null } = alpha,
...
export function codexMicroKeyboardSurfaceT(timber: unknown) {
  ...
  let violet = (
    <CodexMicroKeyboardSurfaceHelper1
      {...{
        className: "size-[72%]",
        joystick,
      }}
  ...
  return <div className={umbra}>{violet}</div>;
}
