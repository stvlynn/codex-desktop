...
/** split companion stub */
const codexMicroKeyboardSurfaceD: any = undefined;
/** split companion stub */
const codexMicroKeyboardSurfaceF: any = undefined;
/** split companion stub */
const codexMicroKeyboardSurfaceU: any = undefined;

export {
  CodexMicroKeyboardSurfaceC as codexMicroKeyboardSurfaceC,
  codexMicroKeyboardSurfaceD,
  codexMicroKeyboardSurfaceF,
  CodexMicroKeyboardSurfaceL as codexMicroKeyboardSurfaceL,
