  ...
  quartz = esmInit(() => {
    ...
    pearl = identity({
      agentKeys: {
        ...
        description:
          "Label for choosing which tasks Codex Micro agent keys open",
      },
      customChats: {
        id: "settings.codexMicro.agentKeys.customChats",
        defaultMessage: "Custom assignments",
        description:
          "Option for assigning Codex Micro agent keys to individual tasks or actions",
      },
      customChatsDescription: {
        id: "settings.codexMicro.agentKeys.customChatsDescription",
        defaultMessage:
          "Choose a chat, shortcut, keycap, or skill for each key",
      ...
      connectionFailed: {
        ...
        description:
          "Codex Micro status when the app cannot connect to a detected device",
      },
      connectionFailedDescription: {
        id: "settings.codexMicro.connection.connectionFailedDescriptionByDevice",
        defaultMessage:
          "Codex found your {deviceName} but couldn't connect. Codex is reconnecting automatically. If the problem continues, reconnect it and check whether a keyboard remapper or security tool is blocking access.",
        description:
          "Troubleshooting guidance shown when Codex cannot connect to a detected Codex Micro or Creator Micro",
      },
      connectionProblem: {
      ...
      connectionProblemDescription: {
        ...
        defaultMessage:
          "Codex couldn't communicate with your {deviceName}. Codex is reconnecting automatically. If the problem continues, reconnect it and try again.",
        description:
          "Fallback troubleshooting guidance for a Codex Micro or Creator Micro connection error",
      },
      discoveryFailed: {
      ...
      discoveryFailedDescription: {
        ...
        defaultMessage:
          "Codex couldn't check for your {deviceName}. Codex will try again automatically. If the problem continues, reconnect the device or restart Codex.",
        description:
          "Troubleshooting guidance shown when Codex Micro or Creator Micro device discovery fails",
      },
      transportUnavailable: {
        id: "settings.codexMicro.connection.transportUnavailable",
        defaultMessage: "Connection interrupted",
        description:
          "Codex Micro status when an active device connection becomes unusable",
      },
      transportUnavailableDescription: {
        id: "settings.codexMicro.connection.transportUnavailableDescriptionByDevice",
        defaultMessage:
          "Codex lost communication with your {deviceName} and is reconnecting automatically. If your computer still shows the device and the problem continues, a keyboard remapper or security tool may be blocking access. Check that tool's device rules, reconnect {deviceName}, or contact IT if it is managed.",
        description:
          "Troubleshooting guidance shown when the Codex Micro or Creator Micro transport becomes unusable",
      },
      inputMonitoring: {
      ...
      microphoneKey: {
        ...
        description:
          "Label for choosing how the Codex Micro microphone key works",
      },
      microphoneKeyDescription: {
        ...
        description:
          "Description for the Codex Micro microphone-key mode setting",
      },
      microphoneKeyPushToTalk: {
        id: "settings.codexMicro.microphoneKey.pushToTalk",
        defaultMessage: "Push to talk",
        description:
          "Option that uses the Codex Micro microphone key for dictation",
      },
      ...
      microphoneKeyVoiceChat: {
        ...
        description:
          "Option that uses the Codex Micro microphone key for Voice Chat",
      },
      microphoneKeyVoiceChatDescription: {
        id: "settings.codexMicro.microphoneKey.voiceChatDescription",
        defaultMessage:
          "Tap to start a Voice Chat or toggle your microphone, then hold to end",
      ...
      microphoneKeyStartVoiceChat: {
        ...
        description:
          "Codex Micro microphone key action for starting a Voice Chat",
      },
      keyboardLayout: {
        id: "settings.codexMicro.keyboardLayout.titleByDevice",
        defaultMessage: "{deviceName} Layout",
        description:
          "Heading for the Codex Micro or Creator Micro hardware layout preview",
      },
      knob: {
      ...
      knobComposerNavigation: {
        ...
        description:
          "Option for navigating composer controls with the Codex Micro knob",
      },
      knobComposerNavigationDescription: {
        ...
        description:
          "Explanation of the Codex Micro composer navigation knob mode",
      },
      knobComposerNavigationTurnRight: {
        ...
        description:
          "Action performed when turning the Codex Micro knob clockwise in composer navigation mode",
      },
      knobComposerNavigationTurnLeft: {
        ...
        description:
          "Action performed when turning the Codex Micro knob counterclockwise in composer navigation mode",
      },
      knobComposerNavigationClick: {
        ...
        description:
          "Action performed when clicking the Codex Micro knob in composer navigation mode",
      },
      knobReasoning: {
        id: "settings.codexMicro.knob.reasoning",
        defaultMessage: "Reasoning only",
        description:
          "Option for controlling reasoning effort with the Codex Micro knob",
      },
      ...
      knobReasoningTurnRight: {
        ...
        description:
          "Action performed when turning the Codex Micro knob clockwise in reasoning-only mode",
      },
      knobReasoningTurnLeft: {
        id: "settings.codexMicro.knob.reasoningTurnLeft",
        defaultMessage: "Increase reasoning effort",
        description:
          "Action performed when turning the Codex Micro knob counterclockwise in reasoning-only mode",
      },
      knobReasoningClick: {
        id: "settings.codexMicro.knob.reasoningClick",
        defaultMessage: "Open the slider or advanced options",
        description:
          "Action performed when clicking the Codex Micro knob in reasoning-only mode",
      },
      knobConversationScroll: {
        id: "settings.codexMicro.knob.conversationScroll",
        defaultMessage: "Conversation scrolling",
        description:
          "Option for scrolling the active conversation with the Codex Micro knob",
      },
      knobConversationScrollDescription: {
        ...
        description:
          "Explanation of the Codex Micro conversation-scrolling knob mode",
      },
      knobConversationScrollTurnRight: {
        ...
        description:
          "Action performed when turning the Codex Micro knob clockwise in conversation-scrolling mode",
      },
      knobConversationScrollTurnLeft: {
        ...
        description:
          "Action performed when turning the Codex Micro knob counterclockwise in conversation-scrolling mode",
      },
      knobConversationScrollClick: {
        id: "settings.codexMicro.knob.conversationScrollClick",
        defaultMessage: "Jump to the latest message",
        description:
          "Action performed when clicking the Codex Micro knob in conversation-scrolling mode",
      },
      lightingBrightness: {
      ...
      lightingBrightnessDescription: {
        ...
        description:
          "Description for the Codex Micro or Creator Micro lighting brightness setting",
      },
      lightingAutoOff: {
      ...
      lightingAutoOffDescription: {
        ...
        defaultMessage:
          "Turns lighting off after inactivity and back on when you use {deviceName} or an agent key changes color or state",
        description:
          "Description for the Codex Micro or Creator Micro lighting auto-dim setting",
      },
      lightingAutoOffOff: {
      ...
      pinnedChats: {
        ...
        description:
          "Option for mapping Codex Micro agent keys to pinned tasks",
      },
      ...
      priorityChats: {
        ...
        description:
          "Option for mapping Codex Micro agent keys to priority tasks",
      },
      priorityChatsDescription: {
        ...
        description:
          "Explanation of the Codex Micro priority tasks agent source",
      },
      recentChats: {
        id: "settings.codexMicro.agentKeys.recentChats",
        defaultMessage: "Most recent chats",
        description:
          "Option for mapping Codex Micro agent keys to the most recently updated tasks",
      },
      recentChatsDescription: {
        ...
        description:
          "Explanation of the Codex Micro most recent tasks agent source",
      },
    });
  });
function river(yellow) {
  let { data = [], isLoading } = recentConversationsMetaQueryKey(),
    { remoteConnections } = getEnabledRemoteConnectionState(),
    zinc = AppInitialBB(remoteConnections) ?? [],
    { data: _data } = CodexPluginActionResult(
      composerConnectorauthReconnectMessages,
    ),
  ...
  let cedar = basalt,
    ...
    { data: __data, isFetching } = useQuery({
      queryKey: ["codex-micro-custom-thread-search", ember, daisy],
      queryFn: async () =>
        (
          await Promise.allSettled(
            ember.map(async (item) =>
              (
                await canonicalizeWorkspacePathKey("search-threads-for-host", {
                  hostId: item,
                  query: daisy,
                  limit: willow,
                })
...
function umbra({
  ...
  let mint = AppInitialFM({
    ...
    nova =
      query.length === 0
        ? [...mint]
            .sort((prism, quill) => quill.updatedAt - prism.updatedAt)
            .slice(0, limit)
        : AppInitialPM({
            asyncResults: asyncResults?.map(({ result }) => result) ?? [],
            loadedChatSearchResults: mint,
            limit,
            query,
          }),
    olive = new Map(
      conversationsMeta.map((item) => [item.id, item.hostId ?? "local"]),
    );
  for (let { hostId, result } of asyncResults ?? [])
    olive.set(result.threadId, hostId);
  return nova.flatMap((item) =>
    item.kind === "chatgpt"
      ? []
      : [
          {
