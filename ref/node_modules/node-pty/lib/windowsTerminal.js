...
var WindowsTerminal = /** @class */ (function (_super) {
    ...
    function WindowsTerminal(file, args, opt) {
        ...
        _this._deferreds = [];
        // Create new termal.
        _this._agent = new windowsPtyAgent_1.WindowsPtyAgent(file, args, parsedEnv, cwd, _this._cols, _this._rows, false, opt.useConpty, opt.useConptyDll, opt.conptyInheritCursor, opt.getConsoleProcessList);
    ...
    WindowsTerminal.prototype.kill = function (signal) {
        var _this = this;
        if (!this._isReady) {
            this._deferNoArgs(function () { return _this.kill(signal); });
            return;
        }
        if (signal) {
