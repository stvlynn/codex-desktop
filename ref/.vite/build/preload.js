...
var s = `codex_desktop:chunked-message-ack`,
  ...
  d = `codex_desktop:get-build-flavor`,
  f = `codex_desktop:get-uses-owl-app-shell`,
  p = `codex_desktop:get-system-theme-variant`,
  m = `codex_desktop:get-initial-sidebar-bootstrap`,
...
var S = performance.timeOrigin,
  ...
  E = e.ipcRenderer.sendSync(u),
  D = e.ipcRenderer.sendSync(d),
  O = e.ipcRenderer.sendSync(f) === !0,
  k = e.ipcRenderer.sendSync(`codex_desktop:get-shared-object-snapshot`) ?? {},
  A = e.ipcRenderer.sendSync(p),
...
var R = new Map(),
  ...
  B = {
    ...
    sendMessageFromView: async (t) => {
      (t.type === `shared-object-set` && L(t.key, t.value),
    ...
    subscribeToWorkerMessages: (t, n) => {
      ...
      return (
        ...
        () => {
          ...
          R.delete(t);
          let i = z.get(t);
          (i && e.ipcRenderer.removeListener(x(t), i), z.delete(t));
        }
      );
    },
    ...
    getInitialSidebarBootstrap: () => (
      I === void 0 && (I = e.ipcRenderer.sendSync(m)),
      I
    ),
...
(e.ipcRenderer.on(T, (t, n) => {
  ...
  let i = r.message,
    a = i;
  (a.type === `shared-object-updated` && L(a.key, a.value),
  ...
  e.contextBridge.exposeInMainWorld(`electronBridge`, B),
  typeof window < `u` &&
