...
function Re(e) {
  let t = (0, ze.c)(17),
    { onFrame: n, onResize: i, playing: a, reducedMotion: o } = e,
    s = a === void 0 ? !0 : a,
    c = (0, W.useRef)(null),
    l = (0, W.useEffectEvent)(n),
    u = (0, W.useEffectEvent)(i),
    d = r(),
    f = o ?? d,
    p = s && !f,
    m = !1;
...
function We(e) {
  ...
  (t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (e) => {
      ...
      (t[3] = u))
    : (u = t[3]),
    S(`codex-micro-joystick-event`, u));
  let d;
...
function tn({ playing: e = !0, reducedMotion: t, level: n, onExit: r }) {
  ...
  (S(`codex-micro-joystick-event`, ({ event: e }) => {
    let t = i.current;
    t != null && Rt(t, e);
  }),
    (0, Q.useEffect)(() => {
...
function on(e) {
  ...
  t[0] === p.value
    ? (g = t[1])
    : ((g = h(p.value)), (t[0] = p.value), (t[1] = g));
  let v = g,
    y = c(m, r),
    ee = _(re),
    { status: b } = _(o),
    te = ee?.composerId === v,
    S = !i && !l && (b === `connected` || (te && b !== `not-detected`)),
    C = u && b === `connected`,
    w;
  t[2] === f
    ? (w = t[3])
  ...
  let T = w,
    ...
    D;
  if (
    (t[4] !== S || t[5] !== v || t[6] !== n || t[7] !== f
      ? ((E = () => {
          if (S)
            return ne(v, n, () => {
              f.get(re)?.composerId === v && ie(f);
            });
        }),
        (D = [S, v, n, f]),
        (t[4] = S),
...
//# sourceMappingURL=codex-micro-mini-game-composer-BoiUM7yg.js.map
