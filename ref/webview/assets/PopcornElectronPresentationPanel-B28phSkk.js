...
import { o as ee, s as te } from "./workbook-C49Dgk1_.js";
import {
  $ as ne,
  A as h,
  C as re,
...
import { n as ge, t as _e } from "./PopcornPageNumberNavigation-BVCUNh2j.js";
import { n as ve, t as N } from "./modifiers.esm-D44vPoX2.js";
import {
  $ as ye,
  A as P,
  B as be,
  ...
  y as pt,
  yt as mt,
} from "./popcorn-electron-surface-style-Bei_9l8_.js";
function ht() {
  return (
    (gt ??= Promise.all([
      A(),
...
function fn(e) {
  let t = on({
    ...
    n = F(e.camera, e.viewportX, e.viewportY);
...
function yr({
  ...
  let L = (0, X.useRef)(null),
    ...
    Qe = (0, X.useMemo)(
      () => (k?.target ? ir(k.target, z.slideRect) : null),
      [k?.target, z.slideRect],
    ),
    et = (0, X.useMemo)(
      () => (k?.target ? ar(k.target, z.slideRect) : null),
      [k?.target, z.slideRect],
    ),
    tt = Qe ?? et,
    nt = (0, X.useMemo)(
      () => (!D || !N ? null : ur(N.start, N.current)),
      [D, N],
    ),
    V = (0, X.useMemo)(() => {
      if (!nt || !N) return null;
      let e = er({ snapshot: g, frame: nt, anchorPoint: N.current });
      ...
      () =>
        ...
        (!D || !c
          ...
          : lt
            ...
            : null),
      [Qe, D, lt, c, V, B, Ke, g.selectedSlideIdx, z.slideRect],
    ),
    {
      annotations: dt,
  ...
  let W = (0, X.useCallback)(() => {
    ...
    K = (0, X.useCallback)(() => {
      ((L.current = null), (Te.current = []), we([]));
    }, []),
    q = (0, X.useCallback)(() => {
      ((M.current = !1), A(null), P(null), W());
    }, [W]),
    St = (0, X.useCallback)(() => {
      let e = me.current;
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !O ||
          !u ||
          ((L.current = B), (Te.current = [...Te.current, e]), we(Te.current));
      },
      [B, O, u],
    ),
    wt = (0, X.useCallback)(
    ...
    Dt = () => {
      k?.mode === `edit` &&
        (ht(k.annotationId), j((e) => (e === k.annotationId ? null : e)), q());
    };
  ((0, X.useEffect)(() => {
    (D || (k?.mode !== `edit` && A(null)),
      (!D || !c) && (P(null), (ve.current = null)));
  }, [D, k?.mode, c]),
    (0, X.useEffect)(() => {
      if (O && u) {
        (A(null),
      ...
      let t = f !== Oe.current;
      (G(), Te.current.length > 0 && !t && K());
    }, [G, K, e, f, O, u]),
    (0, X.useEffect)(() => {
      if (f === Oe.current) return;
      Oe.current = f;
      let e = Te.current;
      if (e.length === 0) {
        K();
    ...
    (0, X.useEffect)(() => {
      k &&
        k.target.slideId !== B &&
        (j(null), P(null), (ve.current = null), A(null));
    }, [k, B]),
    (0, X.useEffect)(
      () => () => {
        G();
    ...
    (0, X.useEffect)(() => {
      L.current == null || L.current === B || K();
    }, [K, B]),
    (0, X.useEffect)(() => {
      let e = _.current,
        t = se.current,
        n = O && u ? `crosshair` : D && c && !k ? $e : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      if ((Ot(n), O && u)) {
        ...
        (Dr(t, y),
          ...
          Re({ color: ye, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      if (D && !c && me.current && !St()) {
      ...
      if (D && c) {
        ...
        if ((r != null && i === `replace` && A(null), !n)) {
          (r != null && i !== `replace` && St(), (ve.current = null), P(null));
          return;
        }
      ...
      let o = g.primarySelectedElementId
        ...
        l = g.selectedElementIds.length === 1 && o ? lr([o], n, R.k) : null,
        d = l ? null : fr(s, n, R.k),
        f = !l && !d && !!o?.canRotate && pr(s, n, R.k),
        p = l
          ? l.endpoint === `from`
            ? `connector-from`
            : `connector-to`
    ...
    At = (t) => {
      ...
      if (D && c) {
        ...
        (e.setHoveredElementId(i),
          (t.currentTarget.style.cursor = me.current ? `` : $e));
        return;
      }
      if (b.current === `text`) {
        n && U.pointerMove(n);
      ...
      let l = sr(g.selectedSlideElementTargets, n, R.k);
    ...
    jt = (t, n) => {
      if (O && u) {
        if (y.current != null && y.current !== t.pointerId) return;
        Ot(Cr(t, _.current, R, g, He));
        let e = Se.current;
        (Or(t, y), (De.current = null), Re(null), n && Ct(e));
        return;
      }
      if (D && c) {
        if (y.current != null && y.current !== t.pointerId) return;
        (Ot(Cr(t, _.current, R, g, He)), Or(t, y));
        let r = ve.current;
        if (((ve.current = null), P(null), !n || !r)) return;
        let i = Cr(t, _.current, R, g, He);
        if (!i) return;
        let a = ur(r.start, i),
      ...
      let r = b.current;
      if (!r) return;
      if ((Ot(Cr(t, _.current, R, g, He)), Or(t, y), r === `text`)) {
        ((b.current = null), U.pointerUp());
        return;
      }
      if (r === `marquee`) {
        ((b.current = null),
    ...
    Mt = (t) => {
      ...
      if (!a) return;
      let n = wr(t.clientX, t.clientY, _.current, R, g, He);
      n &&
...
function Kr({
  ...
  let [me, he] = (0, Q.useState)(() =>
    ...
    Ve = (0, Q.useRef)(be),
    He = (0, Q.useRef)(F),
    Ue = o(m(s, { activationConstraint: { distance: 4 } })),
    We = (0, Q.useMemo)(() => [ve], []),
    z = n === `left`,
    Ge = n === `bottom`,
    B = g === `codex`,
    ...
    Je = re ?? B,
    Ye = De && (z || Ke || qe),
    Xe = !_ && (ae || w.notesText.trim().length > 0),
    Ze = Xe && Ne && M > 0,
    Qe = (0, Q.useMemo)(
      () => ({
        left: Ye ? Qr : 0,
  ...
  let et = (0, Q.useMemo)(
    ...
    rt = w.slideIds[w.selectedSlideIdx] ?? null,
    V =
      w.fitScale ??
      (w.slideRect && w.zoom > 0 ? w.slideRect.scale / w.zoom : null),
    it = V ? rn(V) : null,
    at = w.slideRect?.scale ?? rn(V ? V * w.zoom : w.zoom),
  ...
  ((0, Q.useEffect)(() => {
    ...
    (e &&
      ...
      H(w.selectedSlideIdx, { force: !0 }),
      e &&
        Ve.current[e] != null &&
        H(w.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [H, w.presentationVersion, w.selectedSlideIdx, w.slideIds]),
    (0, Q.useEffect)(() => {
    ...
    }, [H, w.presentationVersion, w.slideCount]));
  let xt = (0, Q.useCallback)(
    ...
    U = (0, Q.useCallback)((e) => {
      Ce(typeof e.active.id == `string` ? e.active.id : null);
    }, []),
    W = (0, Q.useCallback)(() => {
      (Se(w.slideIds), Ce(null));
    }, [w.slideIds]),
    G = (0, Q.useCallback)(
      (e) => {
        Ce(null);
    ...
    J = (0, Q.useCallback)(
      ...
      [I, bt, _t, F, We, W, G, U, yt, ae, vt, ne, rt, gt, Ue, nt, et, N],
    );
  return (0, $.jsx)(`div`, {
    className: p(
      ...
      children: [
        (0, $.jsx)(ie, {
          ...
          centeredContent: lt
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: p(`flex items-center`, B ? `gap-1` : `gap-2`),
            children: [
              v?.annotation && ue
                ? (0, $.jsx)(Te, {
                    active: de,
      ...
      (mi = (0, Q.memo)(function ({
        ...
        return (0, $.jsx)(B, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: h,
            style: {
              transform: r.Translate.toString(re),
...
function _i({
  ...
  let y = Le({ initialCrdtState: o, externalCrdtUpdates: t }),
    b = (0, Si.useRef)(s),
    x = (0, Si.useRef)(null),
    S = j(
      void 0,
    ...
    S
      ? (0, Ci.jsxs)(`section`, {
          ...
          children: [
            ...
            (0, Ci.jsx)(nt, { artifactLabel: `Presentation`, restoreState: w }),
          ],
        })
      : null
  );
...
var Si, Ci;
e(() => {
  (te(), a(), (Si = t(i())), gi(), Yt(), re(), z(), Xe(), (Ci = u()));
})();
export { _i as PopcornElectronPresentationPanel };
//# sourceMappingURL=PopcornElectronPresentationPanel-B28phSkk.js.map
