const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./auto-track-C2WS6wxc.js",
      "./rolldown-runtime-BG2f4sTM.js",
      "./esm-BkXFCz6T.js",
      "./app-initial-C-fROkKo.js",
      "./app-initial-Czet5G9g.css",
      "./middleware-Br1NemKK.js",
      "./middleware-2Su2Qp7P.js",
      "./query-string-IX2M6DS-.js",
      "./gracefulDecodeURIComponent-DUAwlHZu.js",
      "./routing-middleware-B8BjNZUQ.js",
      "./ajs-destination-BCUeq1l3.js",
      "./load-script-Cltl04TI.js",
      "./metric-helpers-CshXbF1V.js",
      "./is-plan-event-enabled-BUDpDO9_.js",
      "./legacy-video-plugins-BgbR1n5U.js",
      "./schema-filter-Dbw8php-.js",
      "./remote-middleware-CaiwI1u_.js",
    ]),
) => i.map((i) => d[i]);
              ...
              return o(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return (
                      (t = r.sent()),
                      [2, (n = t.link).call.apply(n, s([this], e, !1))]
                    );
                }
              });
            });
              ...
              return o(this, function (r) {
                switch (r.label) {
                  ...
                  case 1:
                    return (
                      (t = r.sent()),
                      [2, (n = t.form).call.apply(n, s([this], e, !1))]
                    );
                }
              });
            });
                  ...
                  case 0:
                    return this.options.useQueryString === !1
                      ...
                      : [
                          4,
                          i(
                            () => import(`./query-string-IX2M6DS-.js`),
                  ...
                  switch (o.label) {
                    ...
                    case 3:
                      return (
                        (r = d),
                        r
                          ? ((f = n[e.name]), [4, r(a(a({}, e.settings), f))])
                          : [3, 5]
                      );
                    case 4:
                      ((p = o.sent()),
        ...
        switch (w.label) {
            ...
            return (
              ...
              Vn(t) || l.length > 0
                ? [
                    ...
                    i(
                      () =>
                        import(`./ajs-destination-BCUeq1l3.js`).then(
                          function (r) {
                            return r.ajsDestinations(
                              e,
                              t,
                              n.integrations,
                              a,
            ...
            return (
              ...
              t.legacyVideoPluginsEnabled
                ? [
                    ...
                    i(
                      () =>
                        import(`./legacy-video-plugins-BgbR1n5U.js`).then(
                          function (e) {
                            return e.loadLegacyVideoPlugins(n);
                          },
                        ),
          ...
          case 8:
            return a.plan?.track
              ? [
                  ...
                  i(
                    () =>
                      import(`./schema-filter-Dbw8php-.js`).then(function (e) {
          ...
          case 11:
            return (
              ...
              [
                4,
                Nn(t, n.integrations, y, a, p, f).catch(function (e) {
                  return (
          ...
          case 12:
            return (
              ...
              x
                ? [3, 14]
                : ((te = (S = b).push),
                  [4, ln(n, y[`Segment.io`], t.integrations)])
            );
          case 13:
            (te.apply(S, [w.sent()]), (w.label = 14));
          case 14:
            return [4, n.register.apply(n, s(s([], b, !1), d, !1))];
          case 15:
            return ((C = w.sent()), [4, Nt(n, u)]);
          case 16:
            return (
              w.sent(),
              Object.entries(t.enabledMiddleware ?? {}).some(function (e) {
                ...
                ? [
                    ...
                    i(
                      () =>
                        import(`./remote-middleware-CaiwI1u_.js`).then(
                          function (e) {
                            var i = e.remoteMiddlewares;
                            return r(ne, void 0, void 0, function () {
                              var e, r;
                              return o(this, function (o) {
                                switch (o.label) {
                                  case 0:
                                    return [4, i(C, t, a.obfuscate)];
                                  case 1:
                                    return (
                                      (e = o.sent()),
                                      (r = e.map(function (e) {
                                        return n.addSourceMiddleware(e);
                                      })),
                                      [2, Promise.all(r)]
                                    );
                                }
    ...
    (c(),
      ...
      (Yn = (function (e) {
        ...
        return (
          ...
          (n.load = function (e, t) {
            return (t === void 0 && (t = {}), new n().load(e, t));
          }),
          (n.standalone = function (e, t) {
            return n.load({ writeKey: e }, t).then(function (e) {
              return e[0];
            });
          }),
          n
...
//# sourceMappingURL=pkg-H9k3jTTq.js.map
