...
import { h as r, x as i } from "./chunk-5PVQY5BW-Dg9V_wGW.js";
import { q as a } from "./runtime.worker-_LqsnMiG.js";
import { D as o, b as s, c, s as l } from "./chunk-ICPOFSXX-3NpaOJSf.js";
import "./chunk-U2HBQHQK-CM1HhHWn.js";
import "./chunk-BSJP7CBP-BlaZACv4.js";
import "./chunk-ZZ45TVLE-CLSPDLuY.js";
import { t as u } from "./graphlib-DoalxkyI.js";
import "./chunk-55IACEB6-BfB9iU8T.js";
import "./chunk-EDXVE4YY-Dd6nfaAc.js";
import "./chunk-X2U36JSP-CoOl3j8b.js";
import "./chunk-5FUZZQ4R-RV6z1AqM.js";
import "./chunk-ENJZ2VHE-BvVRvERF.js";
import "./chunk-336JU56O-sO6E-BzZ.js";
import { t as d } from "./dagre-Cd90YTUa.js";
import { i as f, n as p, t as m } from "./chunk-OYMX7WX6-DA-2Ibo8.js";
var h = t(
    (e) =>
      e
        .append(`circle`)
  ...
  E = t(function (n, c, u) {
    ...
    if (
      ...
      let t = n.append(`g`).attr(`class`, `stateLabel`),
        { x: i, y: a } = r.calcLabelPosition(c.points),
        o = l.getRows(u.title),
        d = 0,
        f = [],
        p = 0,
      ...
      for (let n = 0; n <= o.length; n++) {
        ...
        ((p = Math.max(p, s.width)),
          ...
          e.info(s.x, i, a + d),
          d === 0 &&
            ((d = r.node().getBBox().height), e.info(`Title height`, d, a)),
          f.push(r));
      }
      let h = d * o.length;
      if (o.length > 1) {
      ...
      (t
        .insert(`rect`, `:first-child`)
        .attr(`class`, `box`)
        .attr(`x`, i - p / 2 - s().state.padding / 2)
...
export { P as diagram };
//# sourceMappingURL=stateDiagram-FHFEXIEX-CmB5As5B.js.map
