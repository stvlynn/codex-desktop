...
import { n as De, t as Oe } from "./play-outline-DP2VGTN0.js";
import { n as ke, t as Ae } from "./flask-XOjEQMSz.js";
import { n as je, t as Me } from "./star-zhAPZW1a.js";
var Ne,
  Pe,
  Fe = e(() => {
...
function Qe(e) {
  ...
  t[5] === p
    ? (g = t[6])
    : ((g = fe(p).toString(16).padStart(6, `0`)), (t[5] = p), (t[6] = g));
  let _ = `#${g}`,
    v = p === `off`,
    y = l?.selected ? `opacity-40` : `opacity-25`,
    b = l?.selected ? `opacity-55` : `opacity-40`;
  (v && ((y = `opacity-0`), (b = `opacity-0`)),
    r && ((y = `opacity-45`), (b = `opacity-65`)));
  let x = o == null ? h : void 0,
    S = r && `translate-y-px scale-[0.985]`,
    C;
  t[7] === S
    ? (C = t[8])
    : ((C = H(
      ...
      (t[7] = S),
      (t[8] = C));
  let w = o == null ? `img` : void 0,
    T;
  t[9] !== _ || t[10] !== y || t[11] !== r || t[12] !== i || t[13] !== b
    ? ((T =
        i == null
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
  ...
  return (
    t[43] !== k || t[44] !== z
      ? ((B = (0, Z.jsx)(a, { delayOpen: !0, tooltipContent: z, children: k })),
        (t[43] = k),
        (t[44] = z),
        (t[45] = B))
      : (B = t[45]),
...
//# sourceMappingURL=codex-micro-keyboard-surface-Bhpd7qkO.js.map
