...
import {
  ...
  s as ne,
  v as re,
} from "./chunk-ABZYJK2D-CR4XLwon.js";
import { a as ie, i as ae, r as oe, t as se } from "./src-aUHGwSbR.js";
import { t as ce } from "./dist-BNkeg5V9.js";
import { g as le, u as ue } from "./chunk-S3R3BYOJ-CHIqNfyA.js";
var de = n((e, t) => {
    (function (n, r) {
        ...
        draw: C(function (e, t, n, i) {
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = yt(e[n], t) + 1;
              ((t += r), (D += r * (a.barHeight + a.barGap)), (E[n] = r));
            }
          } else {
            D += w.length * (a.barHeight + a.barGap);
            ...
            if (
              (d
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? w.length * (a.barHeight + a.barGap) + a.barHeight * 2
                    : s;
                })
          ...
          function re(e, t, n, r, o, s, c, l) {
            ...
            let f = i.db.getDateFormat(),
              p = [],
              m = null,
              h = (0, P.default)(u);
            for (; h.valueOf() <= d; )
              (i.db.isInvalidDate(h, f, c, l)
                ? m
                  ? (m.end = h)
                  : (m = { start: h, end: h })
                : (m &&= (p.push(m), null)),
            ...
            O.append(`g`)
              ...
              .attr(`height`, o - t - a.gridLineStartPadding)
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-CC069QJE.js.map
