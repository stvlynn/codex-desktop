...
function U() {
  ...
  e[0] !== l || e[1] !== n || e[2] !== t
    ? ((d = async () => {
        (await A(t, g.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await A(t, g.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await A(t, g.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          l(`/`));
      }),
      (e[0] = l),
      (e[1] = n),
...
function W(e) {
  ...
  let K;
  t[58] !== F || t[59] !== G
    ? ((K = (0, X.jsxs)(ie, { transition: N, children: [F, G] })),
      (t[58] = F),
      (t[59] = G),
      (t[60] = K))
    : (K = t[60]);
...
function pe(e) {
        ...
        return n === `intro`
          ...
          : n === `cloud`
            ? (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(O, { className: `size-8` }),
                  (0, X.jsxs)(`div`, {
                    className: `flex w-full items-center justify-between gap-4`,
                    children: [
                      (0, X.jsx)(z, { className: `size-4` }),
                      (0, X.jsxs)(`div`, {
  ...
  t[2] !== a || t[3] !== i
    ...
    : (c = t[4]);
  let u;
  t[5] === s ? (u = t[6]) : ((u = s()), (t[5] = s), (t[6] = u));
  let d;
  return (
    t[7] !== c || t[8] !== u
      ? ((d = (0, X.jsx)(`div`, { style: c, "aria-hidden": !0, children: u })),
        (t[7] = c),
        (t[8] = u),
        (t[9] = d))
      : (d = t[9]),
...
//# sourceMappingURL=first-run-CmpS1-m3.js.map
