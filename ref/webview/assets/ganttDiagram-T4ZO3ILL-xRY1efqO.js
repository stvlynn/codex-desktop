...
import { a as S, i as C, r as w, t as T } from "./src-aUHGwSbR.js";
...
import { g as ce, u as le } from "./chunk-5PVQY5BW-CGFDLcnR.js";
var ue = n((e, t) => {
    (function (n, r) {
    ...
    (Tt = {
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, i) {
          ...
          s === `sandbox` && (f = w(`#i` + t));
          let p = w(
              s === `sandbox` ? f.nodes()[0].contentDocument.body : `body`,
            ),
            m = s === `sandbox` ? f.nodes()[0].contentDocument : document,
            x = m.getElementById(t);
          ((Q = x.parentElement.offsetWidth),
            Q === void 0 && (Q = 1200),
            a.useWidth !== void 0 && (Q = a.useWidth));
          let T = i.db.getTasks(),
            E = [];
          ...
          if (
            ...
            for (let n of Object.keys(e)) {
              let r = wt(e[n], t) + 1;
              ((t += r), (A += r * (a.barHeight + a.barGap)), (k[n] = r));
            }
          } else {
            A += T.length * (a.barHeight + a.barGap);
          ...
          let j = p.select(`[id="${t}"]`),
            M = l()
              ...
              .rangeRound([0, Q - a.leftPadding - a.rightPadding]);
          function ee(e, t) {
            let n = e.startTime,
              r = t.startTime,
              i = 0;
          ...
          function te(e, t, n) {
            let r = a.barHeight,
              ...
              u = v()
                ...
                .range([`#00B9FA`, `#F95002`])
                .interpolate(c);
            (re(o, s, l, t, n, e, i.db.getExcludes(), i.db.getIncludes()),
              se(l, s, t, n),
              ne(e, o, s, l, r, u, t, n),
              ce(o, s, l, r, u),
              le(l, s, t, n));
            ...
            if (
              (d
                ...
                .attr(`y`, function (e, t) {
                  return (
                    (t = e.order),
                    e.vert ? a.gridLineStartPadding : t * n + r
                  );
                })
                ...
                .attr(`height`, function (e) {
                  return e.vert
                    ? T.length * (a.barHeight + a.barGap) + a.barHeight * 2
                    : s;
                })
                ...
                .attr(`class`, function (e) {
                  ...
                  for (let [t, r] of E.entries())
                    e.type === r && (n = t % a.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    ...
                    return M(e.startTime) + o;
                  let r = this.getBBox().width;
                  return r > n - t
                    ? n + r + 1.5 * a.leftPadding > l
                      ? t + o - 5
                      : n + o + 5
                    : (n - t) / 2 + t + o;
                })
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? a.gridLineStartPadding +
                        T.length * (a.barHeight + a.barGap) +
                        60
                    : ((t = e.order),
                      t * n + a.barHeight / 2 + (a.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, s)
                .attr(`class`, function (e) {
                  let t = M(e.startTime),
                  ...
                  let o = 0;
                  for (let [t, n] of E.entries())
                    e.type === n && (o = t % a.numberSectionStyles);
                  let c = ``;
                  return (
                    e.active &&
          ...
          function re(e, n, r, o, s, c, l, u) {
            ...
            let p = i.db.getDateFormat(),
              m = [],
              h = null,
              g = (0, F.default)(d);
            for (; g.valueOf() <= f; )
              (i.db.isInvalidDate(g, p, l, u)
                ? h
                  ? (h.end = g)
                  : (h = { start: g, end: g })
                : (h &&= (m.push(h), null)),
            ...
            j.append(`g`)
              ...
              .attr(`height`, s - n - a.gridLineStartPadding)
          ...
          function se(e, t, n, r) {
            let o = i.db.getDateFormat(),
              s = i.db.getAxisFormat(),
              c;
            c = s || (o === `D` ? `%d` : (a.axisFormat ?? `%Y-%m-%d`));
            let l = C(M)
                .tickSize(-r + t + a.gridLineStartPadding)
                .tickFormat(u(c)),
              f =
            ...
            if (f !== null) {
              ...
              if (isNaN(e) || e <= 0)
                ...
                if (c > $)
                  D.warn(
                    `The tick interval "${e}${t}" would generate ${c} ticks, which exceeds the maximum allowed (${$}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                  );
                else
                  switch (t) {
                    case `millisecond`:
            ...
            j.append(`g`)
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e[0] === n)
                    return (
                      `sectionTitle sectionTitle` + (t % a.numberSectionStyles)
                    );
                return `sectionTitle`;
              });
          }
...
//# sourceMappingURL=ganttDiagram-T4ZO3ILL-xRY1efqO.js.map
