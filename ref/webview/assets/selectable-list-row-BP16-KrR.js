...
function s(e) {
  ...
  let k = a(O),
    ...
    N;
  t[2] !== j || t[3] !== M
    ? ((N = i(`relative flex min-w-0 gap-2`, j, M)),
      (t[2] = j),
      (t[3] = M),
      (t[4] = N))
    : (N = t[4]);
  ...
  t[8] === F
    ? (I = t[9])
    : ((I = i(`flex min-w-0 flex-1 flex-col`, F)), (t[8] = F), (t[9] = I));
  let L = T === `compact` ? `items-start` : `items-baseline`,
    R;
  t[10] === L
    ? (R = t[11])
    : ((R = i(`flex min-w-0 gap-3`, L)), (t[10] = L), (t[11] = R));
  let z;
  t[12] === S
    ? (z = t[13])
    : ((z = (0, l.jsx)(`span`, {
  ...
  if (
    ...
    bb0: if (
      ...
      let e;
      t[60] !== n || t[61] !== r || t[62] !== o || t[63] !== D || t[64] !== h
        ? ((e = (0, l.jsx)(`button`, {
            type: `button`,
...
//# sourceMappingURL=selectable-list-row-BP16-KrR.js.map
